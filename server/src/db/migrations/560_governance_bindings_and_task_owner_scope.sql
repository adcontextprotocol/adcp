-- Migration 560: authoritative seller-side governance-agent bindings. Each principal/account
-- has one atomic row addressable by either seller account_id or the complete
-- canonical natural identity. Credentials are intentionally never stored.
