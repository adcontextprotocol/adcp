...
function createSession(): SessionState {
  ...
  return {
    ...
    complyExtensions: {
      ...
      forcedCreateMediaBuyArms: new Map(),
      forcedGetProductsArms: new Map(),
      pendingSubmittedTasks: new Map(),
    },
    createdAt: now,
    lastAccessedAt: now,
  };
...
function deserializeSession(data: Record<string, unknown>): SessionState {
  ...
  return {
    ...
    complyExtensions: {
      ...
      forcedCreateMediaBuyArms: asMap(hydratedComply.forcedCreateMediaBuyArms, fresh.complyExtensions.forcedCreateMediaBuyArms),
      forcedGetProductsArms: asMap(hydratedComply.forcedGetProductsArms, fresh.complyExtensions.forcedGetProductsArms),
      pendingSubmittedTasks: asMap(hydratedComply.pendingSubmittedTasks, fresh.complyExtensions.pendingSubmittedTasks),
