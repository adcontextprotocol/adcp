...
describe('tenant routing smoke', () => {
  ...
  it('serves proposal-profile capabilities and SDK-shaped 3.2 refinement over HTTP', async () => {
    ...
    try {
      ...
      expect(capabilitiesResponse.result?.structuredContent?.adcp_version).toBe('3.2-beta.11');
      ...
      expect(requested.result?.structuredContent?.adcp_version).toBe('3.2-beta.11');
      ...
      expect(counteroffer?.adcp_version).toBe('3.2-beta.11');
      ...
      expect(refinement?.adcp_version).toBe('3.2-beta.11');
  ...
  it('keeps get_products callable while discovering the native AdCP 3.2 lifecycle', async () => {
    ...
    try {
      ...
      expect(aliasReplay.result?.structuredContent?.adcp_version).toBe('3.2-beta.11');
