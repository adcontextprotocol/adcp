...
registry.registerPath({
  ...
  responses: {
    ...
    400: {
      description: 'A human credential did not select an organization explicitly.',
    ...
    409: {
      description:
        'The API key has a WorkOS organization scope, but the existing organization has not been provisioned locally. Reconcile it; do not create a duplicate.',
      content: { 'application/json': { schema: ErrorSchema } },
    },
  },
});
...
registry.registerPath({
  ...
  responses: {
    ...
    400: {
      description:
        'Missing or invalid `url`, or missing/invalid `type`.',
      content: { 'application/json': { schema: ErrorSchema } },
    },
    401: {
      description: 'Authentication required',
    ...
    403: {
      description:
        'A human credential omitted `?org=`, the caller is not a member of the selected organization, or the selector conflicts with the API key scope.',
      content: { 'application/json': { schema: ErrorSchema } },
    },
    404: {
      description:
