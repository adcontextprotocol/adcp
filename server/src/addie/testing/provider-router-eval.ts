...
export const SYNTHETIC_ROUTER_CORPUS: ReadonlyArray<RouterEvalCase> = Object.freeze([
  ...
  { id: 'multi-intent', context: dm('Explain the schema and then validate my implementation.'), expected: { action: 'respond', toolSets: ['schema_reference', 'agent_testing'], confidence: 'high', requiresDepth: true } },
  ...
  { id: 'mention-protocol', context: { message: 'Addie, explain the creative identifier requirement.', source: 'mention' }, expected: { action: 'respond', toolSets: ['knowledge', 'schema_reference'], confidence: 'high', requiresDepth: false } },
