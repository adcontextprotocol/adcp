...
export const SYNTHETIC_ROUTER_CORPUS: ReadonlyArray<RouterEvalCase> = Object.freeze([
  ...
  { id: 'community-discussions', context: dm('Search recent Slack discussions about community meetup formats.'), expected: { action: 'respond', toolSets: ['community_discussions'], confidence: 'high', requiresDepth: false } },
  { id: 'industry-research', context: dm('Search recent industry news and curated resources about community meetup formats.'), expected: { action: 'respond', toolSets: ['industry_research'], confidence: 'high', requiresDepth: false } },
  { id: 'community-research-combined', context: dm('Search recent Slack discussions and industry resources about community meetup formats.'), expected: { action: 'respond', toolSets: ['community_discussions', 'industry_research'], confidence: 'high', requiresDepth: false } },
  ...
  { id: 'member-personal-profile', context: dm('Please show me my member profile.'), expected: { action: 'respond', toolSets: ['member_personal_profile'], confidence: 'high', requiresDepth: false } },
  { id: 'member-company-profile', context: dm('Show our company directory listing and brand logo.'), expected: { action: 'respond', toolSets: ['member_company_profile'], confidence: 'high', requiresDepth: false } },
  { id: 'member-personal-and-company-profile', context: dm('Update my personal bio and our company directory listing.'), expected: { action: 'respond', toolSets: ['member_personal_profile', 'member_company_profile'], confidence: 'high', requiresDepth: false } },
  ...
  { id: 'adcp-task-operation', context: dm('Create a media buy for my approved campaign.'), expected: { action: 'respond', toolSets: ['adcp_task_operations'], confidence: 'high', requiresDepth: false } },
  { id: 'adcp-agent-management', context: dm('List the AdCP agents saved for my organization.'), expected: { action: 'respond', toolSets: ['adcp_agent_management'], confidence: 'high', requiresDepth: false } },
  { id: 'adcp-task-and-agent-management', context: dm('Register synthetic-seller.invalid as my seller agent, then inspect its AdCP capabilities.'), expected: { action: 'respond', toolSets: ['adcp_agent_management', 'adcp_task_operations'], confidence: 'high', requiresDepth: true } },
  { id: 'sponsored-intelligence', context: dm('Connect me with Scope3\'s Sponsored Intelligence agent.'), expected: { action: 'respond', toolSets: ['sponsored_intelligence_discovery'], confidence: 'high', requiresDepth: false } },
  { id: 'sponsored-intelligence-session', context: dm('Check the status of my active Sponsored Intelligence conversation.'), expected: { action: 'respond', toolSets: ['sponsored_intelligence_session'], confidence: 'high', requiresDepth: false } },
  ...
  { id: 'publishing-submission', context: dm('Publish the article in this Google Doc for editorial review.'), expected: { action: 'respond', toolSets: ['publishing_submission'], confidence: 'high', requiresDepth: false } },
  { id: 'publishing-submission-and-assets', context: dm('Submit this Google Doc for editorial review, then attach the supplied cover image after it is published.'), expected: { action: 'respond', toolSets: ['publishing_submission', 'publishing_assets'], confidence: 'high', requiresDepth: true } },
  ...
  { id: 'publishing-cover-regeneration', context: dm('Regenerate the cover illustration for my published post.'), expected: { action: 'respond', toolSets: ['publishing_assets'], confidence: 'high', requiresDepth: false } },
  ...
  { id: 'admin-conversation-review', context: { ...dm('List flagged conversations awaiting review.'), isAAOAdmin: true }, expected: { action: 'respond', toolSets: ['admin_conversation_review'], confidence: 'high', requiresDepth: false } },
  { id: 'admin-followup-tasks', context: { ...dm('List overdue community tasks.'), isAAOAdmin: true }, expected: { action: 'respond', toolSets: ['admin_followup_tasks'], confidence: 'high', requiresDepth: false } },
  { id: 'admin-review-and-followup', context: { ...dm('List flagged conversations, then log a synthetic follow-up for the reviewed item.'), isAAOAdmin: true }, expected: { action: 'respond', toolSets: ['admin_conversation_review', 'admin_followup_tasks'], confidence: 'high', requiresDepth: false } },
  ...
  { id: 'governance-open', context: dm('Who should decide how signal-provider fees are allocated?'), expected: { action: 'respond', toolSets: ['knowledge', 'community_discussions'], confidence: 'suggest', requiresDepth: true } },
  ...
  { id: 'committee-co-leaders', context: dm('Add a co-leader to the committee I lead.'), expected: { action: 'respond', toolSets: ['committee_co_leaders'], confidence: 'high', requiresDepth: false } },
  { id: 'committee-event-planning', context: dm('Create a webinar for the committee I lead.'), expected: { action: 'respond', toolSets: ['committee_event_planning'], confidence: 'high', requiresDepth: false } },
  { id: 'committee-event-registrations', context: dm('Check whether Sample Person is registered before inviting them to my committee event.'), expected: { action: 'respond', toolSets: ['committee_event_registrations'], confidence: 'high', requiresDepth: false } },
  { id: 'committee-full-leadership', context: dm('Add the named co-leader, create the supplied committee webinar, and invite the named registered participants.'), expected: { action: 'respond', toolSets: ['committee_full_leadership'], confidence: 'high', requiresDepth: true } },
  ...
  { id: 'outreach-reporting', context: { ...dm('Show recent outreach performance and message history.'), isAAOAdmin: true }, expected: { action: 'respond', toolSets: ['outreach_reporting'], confidence: 'high', requiresDepth: false } },
  { id: 'outreach-contact-management', context: { ...dm('Look up Sample Person and prepare targeted outreach.'), isAAOAdmin: true }, expected: { action: 'respond', toolSets: ['outreach_contact_management'], confidence: 'high', requiresDepth: false } },
  { id: 'outreach-reporting-and-contact', context: { ...dm('Show the recent outreach history, then send a synthetic follow-up to the named eligible person.'), isAAOAdmin: true }, expected: { action: 'respond', toolSets: ['outreach_reporting', 'outreach_contact_management'], confidence: 'high', requiresDepth: true } },
  ...
  { id: 'admin-member', context: { ...dm('Show my member profile.'), isAAOAdmin: true }, expected: { action: 'respond', toolSets: ['member_personal_profile'], confidence: 'high', requiresDepth: false } },
