...
export const SYNTHETIC_ROUTER_CORPUS: ReadonlyArray<RouterEvalCase> = Object.freeze([
  ...
  { id: 'publisher-property-diagnosis', context: dm('My adagents.json is valid but my agent still cannot see publisher properties. Diagnose the whole setup.'), expected: { action: 'respond', toolSets: ['agent_registry', 'property_catalog'], confidence: 'high', requiresDepth: true } },
