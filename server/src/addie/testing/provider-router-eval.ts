...
export const SYNTHETIC_ROUTER_CORPUS: ReadonlyArray<RouterEvalCase> = Object.freeze([
  ...
  { id: 'multi-intent', context: dm('Inspect the schema fields and then validate my implementation against them.'), expected: { action: 'respond', toolSets: ['schema_reference', 'agent_testing'], confidence: 'high', requiresDepth: true } },
