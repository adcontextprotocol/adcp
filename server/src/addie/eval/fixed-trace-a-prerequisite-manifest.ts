 ...
 *
 * This module exports data only. B accepts only this primitive string and
 * parses it into fresh JSON data, so proxies, accessors, exotic prototypes,
 * cycles, and coercion hooks are rejected without being inspected. A's
 * executable protocol independently derives and validates every leaf.
 */
export const FIXED_TRACE_A_PREREQUISITE_MANIFEST_JSON = `{"version":"addie-fixed-trace-A-prerequisite-manifest-v2","sourceCommit":"5094c5c0242ea10c2fd8452a21c0ea1bf33a68a3","corpus":{"suiteVersion":"addie-fixed-traces-v32","suiteSha256":"5f7f0a6d653a4757991728a1d9de8aee69b40d580dafb65e98941c1f9e3fea83"},"partitionManifestSha256":"99a0727723fd84bcc4c7f40852a0e2392b578964bb4e7b0954739946451e4b96","experimentalDesignFingerprint":"d4f54eae99a90426ba43c5a4a26a7196102bc524537cdec56d32f0df8d9fb153","measurement":{"version":"addie-fixed-trace-measurement-manifest-v1","sha256":"c465bc7b5b69f3bf6e8151a5b4ff57d10d630d3f8ddc64c1cce4d504ad80fb5a"},"finalPrerequisites":{"randomization":{"scheduleDigest":null,"episodeClusterManifestDigest":null},"pricingWindow":{"id":null,"effectiveFrom":null,"effectiveBefore":null,"digest":null},"calibration":{"status":"unavailable","allowedRelationshipToScoredDevelopment":"separate_or_cross_fitted_only","digest":null},"custody":{"status":"unavailable","custodianIdentity":null,"packDigest":null,"signature":null,"collisionAuditDigest":null},"providerExposure":{"status":"unavailable","digest":null}}}` as const;
