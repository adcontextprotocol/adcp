...
\`\`\`
npx @adcp/sdk@14.0.0-beta.28 test-mcp get_products '{"adcp_version":"3.2-beta.10","buying_mode":"brief","brief":"<your campaign brief>"}'
\`\`\`
