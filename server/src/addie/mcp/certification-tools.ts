...
\`\`\`
npx @adcp/sdk@14.0.0-beta.29 test-mcp get_products '{"adcp_version":"3.2-beta.11","buying_mode":"brief","brief":"<your campaign brief>"}'
\`\`\`
