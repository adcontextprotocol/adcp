    ...
    input_schema: {
      ...
      properties: {
        ...
        status_filter: {
          ...
          oneOf: [
            { type: 'string', enum: ['pending_creatives', 'active', 'paused', 'completed', 'rejected', 'canceled'] },
            { type: 'array', items: { type: 'string', enum: ['pending_creatives', 'active', 'paused', 'completed', 'rejected', 'canceled'] } },
          ],
        },
        include_snapshot: {
          type: 'boolean',
