// Generated from free-email-domains@1.9.16 domains.json (MIT license).
// Kept local so npm install does not depend on that package's networked postinstall.
const freeEmailDomains: string[] = [
  "0-mail.com",
  "00ul98wada3tul.capcut1.name.ng",
  "01022.hk",
  "01130.hk",
  "027168.com",
  "062e.com",
  ...
  "appzily.com",
  "aprte.com",
  "aq11.tempdukviet.click",
  "aq55.tempdukviet.click",
  "aquas.live",
  "arabia.com",
  "arabtop.net",
  "arapps.me",
