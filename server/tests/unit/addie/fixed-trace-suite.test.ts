...
describe('fixed cross-provider trace suite', () => {
  ...
  it('leaves the established live evaluator suite unchanged pending planner integration', () => {
  ...
  it('is a synthetic foundation corpus covering every required risk category', () => {
    ...
    const serialized = JSON.stringify(FIXED_TRACE_CORPUS);
    expect([...serialized.matchAll(/[A-Z0-9._%+-]+@([A-Z0-9.-]+\.[A-Z]{2,})/gi)]
