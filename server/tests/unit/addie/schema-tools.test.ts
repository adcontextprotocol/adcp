...
describe('schema handler version resolution', () => {
  const publicSelectors: Array<{
    ...
    { selector: '3.2-beta', canonical: '3.2-beta', artifact: '3.2.0-beta.7' },
    { selector: '3.2 beta', canonical: '3.2-beta', artifact: '3.2.0-beta.7' },
    { selector: '3.2', canonical: '3.2-beta', artifact: '3.2.0-beta.7' },
    { selector: '3.2.0-beta.7', canonical: '3.2-beta', artifact: '3.2.0-beta.7' },
