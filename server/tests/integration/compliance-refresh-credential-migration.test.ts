...
const correction = readFileSync(new URL('../../src/db/migrations/599_compliance_refresh_authenticated_credential.sql', import.meta.url), 'utf8');
...
// This is the pre-599 claim shape: it deliberately knows nothing about the new
