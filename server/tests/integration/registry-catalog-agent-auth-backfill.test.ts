/**
 * Backfill correctness tests for migration 437.
 *
...
describe('catalog_agent_authorizations backfill (migration 437)', () => {
  let pool: Pool;
  ...
  describe('source-value pre-flight (assertion in migration 437)', () => {
