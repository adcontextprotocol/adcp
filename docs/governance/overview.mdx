...
| **[Content Standards](./content-standards/index)** | Brand safety & suitability | Privacy-preserving content evaluation, calibration, validation |
...
|------|-------|-----------------|
| Brand Safety & Suitability | Safe, appropriate ad contexts | Property Governance, Content filtering, adagents.json |
| Brand Manifest & Standards Library | Machine-readable brand policies | [Brand Manifest](/docs/creative/brand-manifest), Content Standards |
...
flowchart TB
    ...
    subgraph governance["Governance Agents"]
        subgraph consent["Consent Agent"]
            consent_features["consent_qual<br/>tcf_version<br/>coppa_cert"]
        end
        subgraph scope3["Scope3 Agent"]
            scope3_features["carbon_score<br/>climate_risk<br/>green_host"]
        end
        subgraph brand["Brand Safety Agent"]
            brand_features["content_cat<br/>brand_risk<br/>sentiment"]
        end
    end
...
<CardGroup cols={2}>
  ...
  <Card title="Content Standards" icon="shield-check" href="/docs/governance/content-standards/index">
    Privacy-preserving brand safety through calibration-based content evaluation and validation.
  </Card>
</CardGroup>
