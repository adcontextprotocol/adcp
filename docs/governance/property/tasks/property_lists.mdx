...
<Note>
For detailed definitions of what "compliant in a country" and "supports a channel" mean, see [Filter Semantics](/docs/governance/property/specification#filter-semantics) in the Protocol Specification.
</Note>
