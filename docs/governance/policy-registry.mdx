...
For example, the EU AI Act Article 50 has `effective_date: "2026-08-01"`. A brand referencing this policy before August 2026 sees informational findings about AI disclosure compliance. After August 2026, violations are rejected.
...
| Domain | Description |
|--------|-------------|
| `campaign` | Campaign governance agents evaluate this policy during `validate_plan_action` |
