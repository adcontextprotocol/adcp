...
| `tobacco_nicotine` | tobacco, nicotine, vaping | Tobacco and nicotine advertising restrictions -- most jurisdictions ban tobacco advertising outright |
| `political_advertising` | Global | Political advertising transparency and disclosure (EU DSA, US state-level AI disclosure laws) |
...
| `scope3_brand_safety` | All | Scope3 Common Sense brand safety framework -- content adjacency baseline donated to AgenticAdvertising.org |
