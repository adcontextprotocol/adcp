...
description: "delete_content_standards removes a content standards configuration by ID from an AdCP governance agent."
"og:title": "AdCP — delete_content_standards"
---
