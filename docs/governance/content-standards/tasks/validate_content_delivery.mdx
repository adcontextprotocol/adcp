...
Content artifacts are separate from delivery metrics. Use [`get_media_buy_artifacts`](/docs/governance/content-standards/tasks/get_media_buy_artifacts) to retrieve content for validation:
