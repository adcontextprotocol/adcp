...
sequenceDiagram
    ...
    Seller->>Verifier: validate_content_delivery (sampled records)
    Verifier-->>Seller: alignment report
    Verifier-->>Buyer: drift detection alerts
```
...
Before running campaigns, sellers calibrate their local models against the verification agent. This is a **dialogue-based process**:
