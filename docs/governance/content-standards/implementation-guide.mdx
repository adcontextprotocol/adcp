...
- Validate you can support the requested features via `list_content_features`
...
- Feature requirements (what signals matter to this buyer)
...
- [ ] Implement `list_content_features` to advertise your capabilities
- [ ] Build content evaluation against buyer rules
- [ ] Implement `calibrate_content` for alignment dialogue
- [ ] Implement `validate_content_delivery` for post-delivery audit
- [ ] Return `get_media_buy_artifacts` so buyers can retrieve content for their own validation
