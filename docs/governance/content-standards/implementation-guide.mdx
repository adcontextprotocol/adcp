...
```json
// Buyer sends examples for evaluation
{
  "standards_id": "nike_emea_brand_safety",
  "artifacts": [
    {
...
**5. Support post-delivery validation**

After delivery, support `validate_content_delivery` calls and `get_media_buy_artifacts` so buyers can audit where their ads appeared.
