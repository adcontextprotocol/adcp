...
Governance findings include confidence scores (0-1) and explanations that distinguish certain violations from ambiguous ones:
...
- **Low confidence (<0.6)**: Speculative. Flagged for human review rather than acted on autonomously.
