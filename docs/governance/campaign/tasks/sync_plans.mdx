  ...
  "plans": [
    {
      ...
      "categories": [
        ...
        { "category_id": "accessibility_compliance", "status": "active" }
      ],
      "resolved_policies": [
...
| `plans[].categories[].category_id` | string | Validation category identifier. Canonical categories include `budget_authority`, `strategic_alignment`, `bias_fairness`, `regulatory_compliance`, `seller_verification`, `brand_policy`, and `accessibility_compliance`. |
