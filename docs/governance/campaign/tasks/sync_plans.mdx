...
1. **Geo authorization** -- The governance agent rejects media buys targeting outside the authorized markets. A plan with `regions: ["US-MA"]` blocks buys that don't explicitly target Massachusetts.
