---
title: sync_plans
description: Push campaign plans with budget limits, channels, flight dates, and compliance policies to a governance agent.
...
| `plans[].mode` | enum | No | Governance enforcement mode for this plan: `enforce`, `advisory`, or `audit`. Defaults to `enforce`. See [governance modes](/docs/governance/campaign/specification#governance-modes). |
