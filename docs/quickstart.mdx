...
```javascript test=true JavaScript
import { ADCPMultiAgentClient } from '@adcp/client';

// Connect to the public test agent
...
// Get the agent and discover products
...
**To test this code**:
- **JavaScript**: Save to a file and run `node --input-type=module yourfile.js`
- **Python**: Save to a file and run `python yourfile.py`
- **CLI**: Copy and paste directly into terminal (requires Node.js for npx or Python for uvx)
