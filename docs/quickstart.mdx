...
**To test this code**: After installing the client library, save to a file and run:
- JavaScript: `node --input-type=module yourfile.js`
- Python: `python yourfile.py`
- cURL: Copy and paste directly into terminal
