...
if (result.products.length > 0) {
  console.log(`  Example: ${result.products[0].name}`);
  console.log(`  CPM: $${result.products[0].pricing.cpm}`);
}
```

**To test this code**: After installing `@adcp/client`, save this to a file and run with `node --input-type=module yourfile.js`
