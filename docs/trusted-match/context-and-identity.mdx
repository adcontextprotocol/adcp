...
The publisher sends a Context Match request to the TMP Router. The request contains the page context. It contains no user identity and no package list — the provider uses its synced package set for this placement.
