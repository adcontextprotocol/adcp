...
```json
{
  ...
  "offers": [
    {
      "package_id": "pkg-A",
      "brand": { "name": "Blue Bottle", "advertiser_domain": "bluebottle.example.com" },
      "summary": "Cold brew coffee carousel — featuring top-rated blends",
      "creative_manifest": {
        "format_id": "sponsored_carousel",
        "assets": {
          "items": {
            "type": "catalog-asset",
            "items": [
...
The creative manifest carries catalog items, text, images, and everything else needed for rendering. This reuses the existing [CreativeManifest](/schemas/core/creative-manifest) schema.
