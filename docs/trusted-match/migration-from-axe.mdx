...
| `axem` (macro data) | Creative manifest + `{TMPX}` | Structured assets move to the creative manifest; per-user exposure tracking uses the TMPX macro from Identity Match |
