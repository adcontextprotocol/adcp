...
```json
{
  ...
  "available_packages": [
    { "package_id": "pkg-sports-inter-01", "media_buy_id": "mb-gearup-q2", "format_ids": ["interstitial_fullscreen"] },
    { "package_id": "pkg-nutrition-inter-02", "media_buy_id": "mb-greenfuel-q2", "format_ids": ["interstitial_fullscreen"] },
    { "package_id": "pkg-telecom-inter-03", "media_buy_id": "mb-wavenet-q2", "format_ids": ["interstitial_fullscreen"] },
    { "package_id": "pkg-auto-inter-04", "media_buy_id": "mb-rideon-q2", "format_ids": ["interstitial_fullscreen"] }
  ]
}
```
...
```json
{
  ...
  "available_packages": [
    { "package_id": "pkg-grocery-native-01", "media_buy_id": "mb-freshmart-q2", "format_ids": ["native_card"] },
    { "package_id": "pkg-kitchenware-native-02", "media_buy_id": "mb-ironpan-q2", "format_ids": ["native_card"] },
    { "package_id": "pkg-meal-native-03", "media_buy_id": "mb-plateplan-q2", "format_ids": ["native_card"] }
  ]
}
```
...
```json
{
  ...
  "offers": [
    ...
    },
    {
      ...
      "brand": { "house": "IronPan Co.", "brand": "IronPan" },
...
```json
{
  ...
  "available_packages": [
    { "package_id": "pkg-gaming-reward-01", "media_buy_id": "mb-cloudplay-q2", "format_ids": ["rewarded_video_30s"] },
    { "package_id": "pkg-snack-reward-02", "media_buy_id": "mb-crunchbar-q2", "format_ids": ["rewarded_video_15s", "rewarded_video_30s"] }
  ]
}
```
