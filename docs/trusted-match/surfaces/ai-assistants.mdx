...
The `artifacts` reference a registered conversation turn. The buyer agent resolves topic classification and content metadata from its cached artifact registry. No user identity is present.
