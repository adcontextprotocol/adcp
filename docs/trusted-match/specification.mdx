...
| Field | Type | Required | Description |
|---|---|---|---|
| `topics` | List\<string\> | No | Content topic identifiers. Use IAB Content Taxonomy 3.0 IDs when `topic_taxonomy` is 7 (default), or human-readable strings for custom taxonomies. |
