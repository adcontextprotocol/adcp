...
<CardGroup cols={2}>
  <Card title="I want to buy on AI platforms" icon="cart-shopping" href="/docs/guides/monetizing-ai">
...
1. **Read the buyer's guide** — The [monetizing AI guide](/docs/guides/monetizing-ai) explains how this works for brands, agencies, and SMBs.
