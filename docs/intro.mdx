...
You're viewing the 3.0-rc.2 documentation. This release adds brand rights licensing, visual guidelines for generative creative, shows and episodes, AI media channel, and property governance integration. See [what's new in rc.2](/docs/reference/release-notes#version-300-rc2) and the [AdCP 3.0 overview](/docs/reference/whats-new-in-v3). For production use, switch to version 2.5 using the version selector above.
</Warning>
