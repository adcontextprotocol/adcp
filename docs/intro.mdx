...
Major improvements: Build-time schema versioning with semantic version paths, atomic response semantics for clearer error handling, discriminated union types for better TypeScript support, consolidated enum schemas for consistency, and comprehensive schema refactoring. [See what's new →](/docs/reference/release-notes)
</Info>
