...
<Warning>
**AdCP 3.0 Release Candidate 3**

You're viewing the 3.0-rc.3 documentation. Schemas may still change before the final 3.0 release. See [what's new in rc.3](/docs/reference/release-notes#version-300-rc3) and the [AdCP 3.0 overview](/docs/reference/whats-new-in-v3). For production use, switch to version 2.5 using the version selector above.
</Warning>
