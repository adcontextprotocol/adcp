...
<CardGroup cols={2}>
  <Card title="I want to buy AI media" icon="cart-shopping" href="/docs/guides/buying-ai-media">
...
5. **Connect with your team** — Share the [quickstart guide](/docs/quickstart) with your technical team to integrate client libraries.
