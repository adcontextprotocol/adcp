...
flowchart TB
    ...
    subgraph Technical["Technical Execution"]
        AXE["**Agent Execution Environment**<br/>Real-time decisioning for brand safety, fcaps, 1p data"]
    ...
    subgraph Governance["Governance (cross-cutting)"]
        GOV["**Governance Agents**<br/>Brand safety, consent, property lists, compliance"]
...
- **Brand Safety**: Content filtering and suitability scoring
- **Consent & Compliance**: Privacy regulations (COPPA, TCF, etc.)
