...
Developer experience and API refinement release featuring type safety improvements, batch creative previews (5-10x faster), schema versioning (`/schemas/v2.5/`), template formats with dynamic sizing, enhanced product filtering, and inline creative updates. [See what's new →](/docs/reference/release-notes)
</Info>
...
### 🤖 [**Agent Registry**](https://adcontextprotocol.org/registry)
Browse all available AdCP agents (creative, signals, and sales) with live health checks and capability discovery.

### 📋 [**AdAgents.json Manager**](https://adcontextprotocol.org/adagents)
