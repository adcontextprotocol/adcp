...
Developer experience and API refinement release with comprehensive type safety improvements, batch creative previews (5-10x faster), build-time schema versioning, atomic response semantics, and permission-based signal activation. [See what's new →](/docs/reference/release-notes)
</Info>
