...
New features: Simplified asset schemas, improved format specifications, and better creative manifest documentation. [See what's new →](./reference/changelog#version-210)
:::
