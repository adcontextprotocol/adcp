...
If authentication is provided, AdCP enforces HMAC-SHA256 signature-based authentication.
...
function generateUniqueSecret(operationId) {
  // Generate cryptographically secure random secret
  return crypto.randomBytes(32).toString('base64url');
}

const secret = generateUniqueSecret('nike_q1_2025');
```
...
```json
{
  "push_notification_config": {
    ...
    "authentication": {
      "schemes": ["HMAC-SHA256"],
      "credentials": "Xk7fB9mPq2vZwC8LtN3jR5sY1fKdHg6A4uW0eT9iOp"
    }
  }
}
```
