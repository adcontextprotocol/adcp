...
**Request Schema**: [`https://adcontextprotocol.org/schemas/v1/core/tasks-list-request.json`](https://adcontextprotocol.org/schemas/v1/core/tasks-list-request.json)
**Response Schema**: [`https://adcontextprotocol.org/schemas/v1/core/tasks-list-response.json`](https://adcontextprotocol.org/schemas/v1/core/tasks-list-response.json)
...
**Request Schema**: [`https://adcontextprotocol.org/schemas/v1/core/tasks-get-request.json`](https://adcontextprotocol.org/schemas/v1/core/tasks-get-request.json)
**Response Schema**: [`https://adcontextprotocol.org/schemas/v1/core/tasks-get-response.json`](https://adcontextprotocol.org/schemas/v1/core/tasks-get-response.json)
...
Configure webhooks at the protocol level when making async task calls. See **[Core Concepts: Protocol-Level Webhook Configuration](./core-concepts.mdx#protocol-level-webhook-configuration)** for complete setup examples.
...
**Webhook Payload Schema**: [`https://adcontextprotocol.org/schemas/v1/core/webhook-payload.json`](https://adcontextprotocol.org/schemas/v1/core/webhook-payload.json)
...
See **[Core Concepts: Webhook Reliability](./core-concepts.mdx#webhook-reliability)** for detailed implementation guidance including:
