...
- Purpose: carry per-call metadata. Initators can use it for the session hints, analytical purposes, tracking usage and etc.
...
Response (protocol envelope echoes initiator context):
