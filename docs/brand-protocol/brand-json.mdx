...
<Info>
`brand.json` is a file that **contains** a brand manifest. Most AdCP operations work with the [brand manifest](/docs/creative/brand-manifest) directly — you don't need to create a `brand.json` file unless you want to self-publish your brand identity at a well-known URL.
</Info>
