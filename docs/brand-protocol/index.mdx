...
description: "AI agents are already using your brand. brand.json tells them how to get it right — and what they must never do."
---
...
Everything in the public tier is already on your website. Assets you share only with agency partners live behind an authorized tier — you control who gets access.
...
<CardGroup cols={2}>
  <Card title="Why brand.json?" icon="question" href="/docs/brand-protocol/why-brand-json">
    The full case for brand.json — what happens when you don't have one.
  </Card>
