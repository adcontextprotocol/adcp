...
description: "Commerce media in AdCP: how retail media networks, sponsored product listings, and closed-loop attribution map to AdCP tasks, catalogs, and delivery reporting."
