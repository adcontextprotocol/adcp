...
description: How data providers, retailers, publishers, CDPs, identity companies, and agencies participate in the signals protocol
---
...
**Next steps**:
- [Data provider guide](/docs/signals/data-providers) — complete walkthrough of signal catalogs
...
**Next steps**:
- [Commerce media guide](/docs/guides/commerce-media) — maps retail concepts to AdCP
- [Data provider guide](/docs/signals/data-providers) — how to publish your signal catalog
...
- [Seller integration guide](/docs/guides/seller-integration) — building your sales agent
...
**Next steps**:
- [Data provider guide](/docs/signals/data-providers) — publish your signal catalog
...
**Next steps**:
- [Data provider guide](/docs/signals/data-providers) — catalog structure
...
- [Industry landscape](/docs/guides/industry-landscape) — how AdCP fits alongside other standards
...
<Card title="Start the signals specialist module" icon="play" href="https://agenticadvertising.org/addie">
