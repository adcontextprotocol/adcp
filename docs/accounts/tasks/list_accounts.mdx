...
| `governance_agents` | Governance agent endpoints registered on this account. Present when governance agents have been configured via [`register_governance`](/docs/accounts/tasks/register_governance). |
...
- [register_governance](/docs/accounts/tasks/register_governance) — Register governance agents against accounts
