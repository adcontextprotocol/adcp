...
**Request Schema**: [`/schemas/v1/account/list-accounts-request.json`](https://adcontextprotocol.org/schemas/v1/account/list-accounts-request.json)
**Response Schema**: [`/schemas/v1/account/list-accounts-response.json`](https://adcontextprotocol.org/schemas/v1/account/list-accounts-response.json)
