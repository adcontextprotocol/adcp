...
**Request Schema**: [`/schemas/v3/account/register-governance-request.json`](https://adcontextprotocol.org/schemas/v3/account/register-governance-request.json)
**Response Schema**: [`/schemas/v3/account/register-governance-response.json`](https://adcontextprotocol.org/schemas/v3/account/register-governance-response.json)
