...
**Request Schema**: [`/schemas/v1/account/get-account-financials-request.json`](https://adcontextprotocol.org/schemas/v1/account/get-account-financials-request.json)
**Response Schema**: [`/schemas/v1/account/get-account-financials-response.json`](https://adcontextprotocol.org/schemas/v1/account/get-account-financials-response.json)
