...
| Field | Description |
|-------|-------------|
| `account_id` | Vendor agent's identifier. Pass this to protocol tasks: `create_media_buy`, `get_signals`, `activate_signal`, `report_usage`, and other operations. |
...
- [sync_accounts](/docs/building/integration/sync_accounts) — Declare new accounts or update existing ones
