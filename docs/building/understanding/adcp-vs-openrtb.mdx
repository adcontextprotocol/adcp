...
description: How AdCP relates to OpenRTB and IAB standards. AdCP handles agent-level workflows; OpenRTB handles impression-level transactions. They are complementary.
...
| **Maturity** | Production (v2.6, v3.0) | Release candidate (v3.0-rc) |
