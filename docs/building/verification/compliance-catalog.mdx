...
| `premium-display-canonical-validation` | AdCP 3.2 `multi_state_display` canvas-matrix validation and `page_takeover` sibling resolution, component asset coverage, and shared-slot reference validation. Requires `validate_input` and controller seeding. |
