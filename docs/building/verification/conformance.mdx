...
| [`agent_configuration`](/compliance/latest/universal/agent-configuration.yaml) | Stable-principal connection configuration: experimental capability declaration, NO_AUTH rejection, and side-effect-free reusable-destination validation for [`sync_agent_configuration`](/docs/protocol/sync_agent_configuration) |
