...
| [`reporting_core_declaration`](/compliance/latest/universal/reporting-core-declaration.yaml) | The required `reporting.core` capability declaration and tier boundaries for [`get_reporting_status`](/docs/media-buy/task-reference/get_reporting_status), graded without requiring an optional test controller |
