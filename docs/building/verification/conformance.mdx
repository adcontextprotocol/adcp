...
| [`agent_configuration`](/compliance/latest/universal/agent-configuration.yaml) | Stable-principal connection configuration for [`sync_agent_configuration`](/docs/protocol/sync_agent_configuration) and [`get_agent_configuration`](/docs/protocol/get_agent_configuration): experimental capability declaration, NO_AUTH rejection, dry-run validation, applied lifecycle with readback, idempotent replay, and section clearing |
