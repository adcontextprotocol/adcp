...
description: "AdCP JSON schemas and SDKs for JavaScript and Python. Download schemas from GitHub or fetch at runtime. Includes setup for AI coding agents using Cursor, Windsurf, and Claude."
