...
and [`accept_proposal`](/docs/media-buy/task-reference/accept_proposal); the 3.x [`create_media_buy`](/docs/media-buy/task-reference/create_media_buy) compatibility facade remains
optional.
