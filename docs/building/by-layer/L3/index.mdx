...
- **[Async identity and convergence](/docs/building/by-layer/L3/async-identity-and-convergence)** — normative identity boundaries, cross-channel races, resumability, and single-winner publication.
