...
|---|---|---|:-:|:-:|:-:|:-:|
| **`@adcp/sdk`** (TypeScript) | `14.0.0-beta.12` | Exact `3.2.0-beta.6` support | ✅ | ✅ | ✅ | ✅ |
...
```bash
npx @adcp/sdk@14.0.0-beta.12 --help
npx @adcp/sdk@14.0.0-beta.12 --save-auth my-agent https://sales.example.com/mcp
npx @adcp/sdk@14.0.0-beta.12 my-agent list_products '{"adcp_version":"3.2-beta.6","account":{"account_id":"account_123"}}'
# or against the built-in public test agent:
npx @adcp/sdk@14.0.0-beta.12 test-mcp list_products '{"adcp_version":"3.2-beta.6"}'
```
