...
|---|---|---|:-:|:-:|:-:|:-:|
| **`@adcp/sdk`** (TypeScript) | `14.0.0-beta.28` | Exact `3.2.0-beta.10` support | ✅ | ✅ | ✅ | ✅ |
| **`adcp`** (Python) | `8.0.0b11` | Exact `3.2.0-beta.10` schemas and types; higher-level helpers remain partial | ✅ | ⚠️ | ⚠️ | ⚠️ |
...
<Warning>
**3.2 packages are prereleases.** TypeScript beta.28 and Python beta.11 support
the exact beta.10 protocol checkpoint.
