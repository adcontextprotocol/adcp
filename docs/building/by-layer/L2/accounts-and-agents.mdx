...
| `agent` | Agent-scoped account shared across declared brand/operator pairs | Agent sends any brand — seller maps the declarations to the standing agent-scoped account |
