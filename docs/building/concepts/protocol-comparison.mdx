...
```json
{
  ...
  "artifacts": [{
    ...
    "parts": [
      ...
      {
        "data": "{\"products\":[],\"suggestions\":[\"budget\",\"audience\"]}",
...
The AdCP v3.2 profile returns an AdCP Submitted result inside a completed A2A
...
```json
{
  "task": {
    ...
    "artifacts": [{
      ...
      "parts": [{
        "data": "{\"status\":\"submitted\",\"task_id\":\"adcp-task-456\"}",
        "mediaType": "application/json"
      }]
    }]
  }
...
- **MCP Guide**: See [MCP Guide](/docs/building/by-layer/L0/mcp-guide) for tool calls and transport sessions
