...
- **Verified** — AAO has tested the agent recently against those storyboards and issued a signed attestation ([AAO Verified badge](/docs/building/aao-verified)). Gated on active membership and a live heartbeat.
