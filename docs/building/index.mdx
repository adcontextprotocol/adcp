...
<CardGroup cols={3}>
  <Card title="Understanding AdCP" icon="lightbulb" href="/docs/building/understanding">
    Design principles, ecosystem overview, and protocol comparison. Start here if you're new to AdCP.
  </Card>
...
- **[How AdCP Works](/docs/building/understanding/how-it-works)** - Design principles and architecture
- **[The Ecosystem](/docs/building/understanding/ecosystem)** - Players, relationships, and the AdCP landscape
- **[Protocol Comparison](/docs/building/understanding/protocol-comparison)** - MCP vs A2A at a glance
- **[Ad Tech Primer](/docs/building/understanding/ad-tech-primer)** - Digital advertising fundamentals
...
- **[Data Models](/docs/building/integration/data-models)** - Core schemas and structures
- **[Schema Versioning](/docs/building/integration/schema-versioning)** - Version compatibility and migration
