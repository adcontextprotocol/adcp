...
description: "Use the AdCP CLI graders to verify RFC 9421 request-signing conformance, diagnose OAuth handshake failures against RFC 9728 and RFC 8414, and generate or verify Ed25519/P-256 signing keys."
keywords: ["grade", "evaluate", "OAuth", "request signing", "RFC 9421", "compliance", "diagnose-auth", "signing", "conformance", "auth setup"]
