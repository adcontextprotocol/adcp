...
[`accessibility-violation.json`](https://adcontextprotocol.org/schemas/latest/error-details/accessibility-violation.json)
shape.
...
- [`/schemas/latest/error-details/accessibility-violation.json`](https://adcontextprotocol.org/schemas/latest/error-details/accessibility-violation.json) (experimental `CREATIVE_REJECTED` details)
