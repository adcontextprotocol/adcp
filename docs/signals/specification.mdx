...
Signal agents MUST return errors using the [standard AdCP error schema](/docs/reference/error-codes).

Signal agents MUST use Signals Protocol error codes as defined in the [Error Codes Reference](/docs/reference/error-codes#signals-protocol).
