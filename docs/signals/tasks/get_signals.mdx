...
- `get_products` declares whether a product has package-level signal targeting and where to discover the selectable menu: inline `products[].signal_targeting_options`, `get_signals` via `signal_targeting_options_source: "get_signals"`, or both.
