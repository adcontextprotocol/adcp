...
**Request Schema**: [`https://adcontextprotocol.org/schemas/v1/signals/get-signals-request.json`](https://adcontextprotocol.org/schemas/v1/signals/get-signals-request.json)
**Response Schema**: [`https://adcontextprotocol.org/schemas/v1/signals/get-signals-response.json`](https://adcontextprotocol.org/schemas/v1/signals/get-signals-response.json)
