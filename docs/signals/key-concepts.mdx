---
title: Key concepts
description: "Signal types, discovery, activation, and the data flow from catalog to campaign targeting."
...
- [Signals ecosystem](/docs/guides/signals-ecosystem) — how each type of company participates
