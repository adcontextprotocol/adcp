...
- [Data provider guide](/docs/signals/data-providers) — how to publish a signal catalog
...
- [get_signals task reference](/docs/signals/tasks/get_signals) — discovery API details
- [activate_signal task reference](/docs/signals/tasks/activate_signal) — activation API details
