...
// Binary targeting
{
  "signal_id": { "data_provider_domain": "acme-data.com", "id": "likely_tesla_buyers" },
  "value_type": "binary",
  "value": true
}
...
{
  "signal_id": { "data_provider_domain": "acme-data.com", "id": "vehicle_ownership" },
  "value_type": "categorical",
  "values": ["tesla", "bmw"]
}
...
// Numeric targeting
{
  "signal_id": { "data_provider_domain": "acme-data.com", "id": "purchase_propensity" },
  "value_type": "numeric",
  "min_value": 0.7
}
```
