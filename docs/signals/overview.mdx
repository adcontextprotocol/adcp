...
| Audience or inventory availability | Required `coverage_percentage`, plus `coverage_forecast` when the seller can disclose scope and value-level availability |
