...
| `REFERENCE_NOT_FOUND` | Referenced SI offering, proposal, or other resource does not exist or is not accessible (generic fallback when no resource-specific code applies) |
