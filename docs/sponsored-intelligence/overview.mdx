...
const buy = await novamind.createMediaBuy({
  buyer_ref: "ridgeline-novamind-q2",
  account: { brand: { domain: "ridgelinegear.com" } },
  brand: { domain: "ridgelinegear.com" },
  ...
  packages: [
    {
      buyer_ref: "pkg_sponsored_responses",
...
<CardGroup cols={2}>
  ...
  <Card title="Monetizing AI" icon="bullseye" href="/docs/guides/monetizing-ai">
