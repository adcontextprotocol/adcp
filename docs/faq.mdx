...
<Accordion title="What is agentic advertising?">
Agentic advertising is advertising where AI agents handle the execution — discovering inventory, pushing brand data to platforms, placing buys, and optimizing toward goals — on behalf of advertisers. Instead of manually managing campaigns across dozens of platforms, you set the strategy, provide the ingredients (product catalogs, brand identity, content standards, conversion events), and approve what matters. Agents do the rest.

This isn't just automation. It's a shift in who does what. The buyer provides ingredients and goals. The platform closest to the user — the one with the conversation context — assembles the best outcome. The agent orchestrates across platforms through a single standard (AdCP) so you don't need custom integrations for each one.

[AgenticAdvertising.org](https://agenticadvertising.org) is the industry organization advancing open standards for this model.
</Accordion>

<Accordion title="Why should I care about agentic advertising?">
If you're a brand or agency: your consumers are spending time in AI assistants, AI search engines, and generative experiences. These platforms generate ads from your brand's data — products, brand voice, content standards — rather than serving pre-built creative. The quality of your data directly determines the quality of your ads. Agencies that adopt agent-based buying reach across all AI platforms through one integration. Brands that invest in data quality get better-performing ads because the AI has better ingredients.

If you're a platform: AI agents are allocating media budgets. If your platform speaks the standard, any buyer agent can discover your inventory and transact without a custom integration.

If you're a smaller business: partners (ad networks, platform integrations) can connect you to AI platforms through the standard. You provide your product feed and brand info; the partner handles the rest.

See the [buyer's guide to AI media](/docs/guides/buying-ai-media) for a practical introduction.
</Accordion>
