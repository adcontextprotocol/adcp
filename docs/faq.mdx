...
For a practical guide to buying ads on AI platforms, see the [monetizing AI guide](/docs/guides/monetizing-ai). For the technical protocol walkthrough, see the [Sponsored Intelligence overview](/docs/sponsored-intelligence/overview).
...
If your agency already supports AdCP, you can be live in days. If not, the [monetizing AI guide](/docs/guides/monetizing-ai#getting-started-by-role) walks through options for brands, agencies, and small businesses — including working with an AdCP-certified partner.
</Accordion>

</AccordionGroup>

<Card title="Read the buyer's guide" icon="book-open" href="/docs/guides/monetizing-ai">
