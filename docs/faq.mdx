...
For a full overview of what agentic advertising is, how it differs from programmatic, and how AdCP fits in, see [What is agentic advertising?](/docs/agentic-advertising). For a practical guide to buying ads on AI platforms, see the [buyer's guide to AI media](/docs/guides/buying-ai-media).
...
If your agency already supports AdCP, you can be live in days. If not, the [buyer's guide](/docs/guides/buying-ai-media) walks through options for brands, agencies, and small businesses — including working with an AdCP-certified partner.
</Accordion>

</AccordionGroup>

<Card title="Read the buyer's guide" icon="book-open" href="/docs/guides/buying-ai-media">
...
The Basics track has 3 modules, about 50 minutes total. Most learners finish in a few focused sessions. Practitioner tracks add 4 more modules (~105 minutes).
</Accordion>
...
Yes. That's the point. The Practitioner build project is designed so that anyone — including marketing executives with zero coding experience — can build a working buyer agent through conversation with an AI coding assistant.
</Accordion>
...
<Card title="Start the certification program" icon="play" href="https://agenticadvertising.org/addie">
...
<Card title="Get started with AdCP" icon="rocket" href="/docs/quickstart">
