...
AdCP is in the 3.0 release-candidate cycle (current: **3.0.0-rc.4**), with 3.0 GA targeted for April 2026. See [Release notes](/docs/reference/release-notes) for the per-RC change log. The protocol design is stable and suitable for pilot implementations; schemas may still receive minor refinements based on implementer feedback before GA.
...
| **Maturity** | Emerging framework across multiple sub-initiatives | 3.0 release candidate (3.0.0-rc.4), 3.0 GA targeted April 2026 |
