...
AAMP — [IAB Tech Lab's Agentic Advertising Management Protocols framework](https://iabtechlab.com/standards/) — is an emerging suite of agentic-advertising initiatives (including an Agent Registry and Agentic Audiences work streams). AdCP and AAMP overlap in ambition (both target AI agents in advertising) and differ in several ways today. As of April 2026:

| | AAMP | AdCP |
|---|---|---|
| **Maintainer** | IAB Tech Lab | AgenticAdvertising.org (open 501(c)(6), four equal voting classes) |
| **Maturity** | Emerging framework across multiple sub-initiatives | 3.0 release candidate, 3.0 GA targeted April 2026 |
