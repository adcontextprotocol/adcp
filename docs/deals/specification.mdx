...
1. **Use Natural Language**: Describe campaign objectives clearly in `deal_spec`
2. **Filter Appropriately**: Use filters to refine results, but don't over-constrain
3. **Check Pricing**: Verify pricing models match budget expectations
4. **Review Targeting**: Understand what targeting is pre-applied to the deal
