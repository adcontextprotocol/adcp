...
- Orchestrators MUST include `product_ids` when `buying_mode` is `"refine"` to iterate on known products with updated forecasts, pricing, and package configurations
