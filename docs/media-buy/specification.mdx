...
The Media Buy Protocol defines twelve tasks. See task reference pages for complete request/response schemas and examples.
...
**Schema**: [`media-buy/sync-catalogs-request.json`](https://adcontextprotocol.org/schemas/v2/media-buy/sync-catalogs-request.json) / [`media-buy/sync-catalogs-response.json`](https://adcontextprotocol.org/schemas/v2/media-buy/sync-catalogs-response.json)
...
**Schema**: [`media-buy/get-media-buys-request.json`](https://adcontextprotocol.org/schemas/v2/media-buy/get-media-buys-request.json) / [`media-buy/get-media-buys-response.json`](https://adcontextprotocol.org/schemas/v2/media-buy/get-media-buys-response.json)
