...
**Requirements:**
- Orchestrators MUST set `buying_mode` to either `"brief"` or `"wholesale"` for initial discovery
- Orchestrators MAY provide `product_ids` instead of `buying_mode` to refresh forecasts for known products
