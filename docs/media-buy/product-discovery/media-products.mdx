...
For a seller-optimized proposal, the publisher instead converts minimum and maximum percentage constraints into absolute package constraints and activates the proposal's cross-package optimization goals and aggregate pacing. In either mode, proposal execution simplifies a complex multi-package campaign to one acceptance call.
