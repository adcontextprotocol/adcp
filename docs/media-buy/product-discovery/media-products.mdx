...
- `social_placement_surfaces` (list[string], optional): Declared social-placement surfaces for social products: `feed`, `stories`, `reels`, `shorts`, `spotlight`, `explore`, `search`, and `marketplace`. Aggregate products and ad-network products may include multiple values. This is seller-declared discovery metadata, not independent verification of inventory quality or delivery context.
...
> **WG review draft (#5270):** the value set below is a proposal under working-group review and may change before it ships.
...
> **WG review draft (#5278):** the value set below is a proposal under working-group review and may change before it ships.
...
| `reels` | The full-screen vertical short-video surface (Reels-branded) |
| `shorts` | The full-screen vertical short-video surface (Shorts-branded) |
| `spotlight` | The full-screen vertical short-video surface (Spotlight-branded) |
...
| `marketplace` | The in-app commerce or buy-and-sell listings surface |
