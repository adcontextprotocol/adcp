...
- **Targeting and future support are absolute when present** — Send the complete
  ...
  targeting, price, forecast assumptions, terms, resolution, or overlay support
  produces a new configured `product_id`; otherwise the seller keeps the prior
  ID stable until expiration.
