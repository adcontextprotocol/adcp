...
2. **Use [`list_creative_formats`](/docs/creative/task-reference/list_creative_formats)** for v1 named-format details, and use product `format_options[]` directly for canonical-format declarations
