...
### 2. Discover Products  
Use [`get_products`](/docs/media-buy/task-reference/get_products) to find matching inventory based on your brief and promoted offering.
...
Publishers may return **proposals** alongside products—structured media plans with budget allocations. Refine proposals conversationally ("focus more on mobile") and execute them directly. See [Proposals](/docs/media-buy/product-discovery/media-products#proposals).
...
- **[Proposals](/docs/media-buy/product-discovery/media-products#proposals)** - Structured media plans with conversational refinement
