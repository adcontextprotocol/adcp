...
Use `buying_mode: "refine"` with structured `feedback` to iterate on products and proposals — omit items, request adjustments, and refresh forecasts before committing to a buy. See [Refinement](/docs/media-buy/product-discovery/refinement).
...
- [Refine](/docs/media-buy/product-discovery/refinement) specific products with structured feedback before committing
...
- **[Refinement](/docs/media-buy/product-discovery/refinement)** - Iterating on products and proposals with structured feedback
