...
2. **Use [`list_creative_formats`](/docs/creative/task-reference/list_creative_formats)** to get detailed format requirements
...
- **[`list_creative_formats`](/docs/creative/task-reference/list_creative_formats)**: ~1 second (database lookup)
