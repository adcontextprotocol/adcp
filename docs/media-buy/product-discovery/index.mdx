...
Use `buying_mode: "refine"` with the `refine` object to iterate on products and proposals — include, omit, or find similar products, and request adjustments to proposals before committing to a buy. See [Refinement](/docs/media-buy/product-discovery/refinement).
...
- [Refine](/docs/media-buy/product-discovery/refinement) specific products with the `refine` object before committing
...
- **[Refinement](/docs/media-buy/product-discovery/refinement)** - Iterating on products and proposals with the refine object
