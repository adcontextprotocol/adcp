...
- **`viewability`** — Minimum viewability floor with the measurement `standard` (`"mrc"` or `"groupm"`) and the vendor measuring it. When agreed on a confirmed package, creatives MUST include corresponding tracker assets.
