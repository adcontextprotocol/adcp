...
<!-- Using latest because revenue-share-option.json has not yet shipped in a released schema version. Update to /schemas/v3/ after release. -->
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/latest/pricing-options/revenue-share-option.json",
