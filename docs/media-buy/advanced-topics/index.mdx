...
- **[Trusted Match Protocol (TMP)](/docs/trusted-match)** - Real-time execution layer for package activation across web, mobile, CTV, AI assistants, and retail media. Replaces AXE.
- **[Agentic eXecution Engine (AXE)](/docs/media-buy/advanced-topics/agentic-execution-engine)** - Deprecated. See TMP.
