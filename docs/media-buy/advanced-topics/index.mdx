...
description: "AdCP advanced topics — targeting, pricing models, accounts and security, sandbox testing, and the Agentic eXecution Engine (AXE) for real-time decisioning."
...
- **[Targeting](/docs/media-buy/advanced-topics/targeting)** - Brief-based targeting with geographic overlays and real-time signals
- **[Agentic eXecution Engine (AXE)](/docs/media-buy/advanced-topics/agentic-execution-engine)** - Real-time execution layer for dynamic audience targeting, brand suitability, and frequency management
...
- **[Accounts & Security](/docs/media-buy/advanced-topics/accounts-and-security)** - Multi-tenant security model and access control
...
- **[Orchestrator Design](/docs/building/implementation/orchestrator-design)** - Technical architecture for AdCP orchestrators
...
- **[Sandbox Mode](/docs/media-buy/advanced-topics/sandbox)** - Run operations without real platform calls or spend
...
- **Review [Sandbox Mode](/docs/media-buy/advanced-topics/sandbox)** for development best practices
- **Explore [Orchestrator Design](/docs/building/implementation/orchestrator-design)** for architecture guidance