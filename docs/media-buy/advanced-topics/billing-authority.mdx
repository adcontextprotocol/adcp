...
[Reliable Reporting](/docs/media-buy/reporting-core-implementation-guide)
...
| Field | Meaning |
|---|---|
| `vendor` (required, [BrandRef](/docs/brand-protocol/brand-json)) | The party whose count of the billing metric governs invoicing. Same field shape covers seller's ad server, buyer's 3PAS, or a third-party vendor — the BrandRef domain disambiguates. |
...
- [Reliable Reporting: implementing `reporting.core`](/docs/media-buy/reporting-core-implementation-guide) — the operational delivery contract for the seller-produced feed
- [`sync_reporting_status`](/docs/media-buy/task-reference/sync_reporting_status) — buyer-to-seller consumption status, and why it is not a dispute channel
