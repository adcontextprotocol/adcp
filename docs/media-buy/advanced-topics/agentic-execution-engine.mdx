...
│                                                                         │
│  ┌──────────────┐         ┌──────────────┐         ┌──────────────┐    │
│  │ Buyer Agent  │         │  Orchestrator │         │ Signal Agent │    │
│  │              │         │   (Scope3)    │         │              │    │
│  │ • Campaigns  │────────▶│               │◀────────│ • Audiences  │    │
│  │ • Budgets    │         │ • Map to AXE  │         │ • Contextual │    │
│  │ • Targeting  │         │   segments    │         │ • Brand safe │    │
│  └──────────────┘         │ • Sync to RTD │         └──────────────┘    │
│                           └───────┬───────┘                             │
│                                   │                                     │
│                                   ▼                                     │
...
```
┌─────────────────────────────────────────────────────────────────────────┐
│                       REAL-TIME SERVING PHASE                           │
│                                                                         │
│  ┌──────────┐     ┌──────────┐     ┌──────────┐     ┌──────────┐       │
│  │   Page   │────▶│Ad Server │────▶│  Prebid  │────▶│   AXE    │       │
│  │          │     │          │     │          │     │          │       │
│  │ User     │     │ GAM/     │     │ OpenRTB  │     │ Segment  │       │
│  │ visits   │     │ Kevel    │     │ request  │     │ lookup   │       │
│  └──────────┘     └──────────┘     └──────────┘     └────┬─────┘       │
│                                                          │              │
│                        ┌─────────────────────────────────┘              │
│                        │                                                │
...
│              │  AXE Response    │                                       │
│              │                  │                                       │
│              │  axei: "seg_123" │  ◀── Include this segment             │
│              │  axex: "seg_456" │  ◀── Exclude (brand safety)           │
│              │  axem: "eyJ..."  │  ◀── Creative macro data              │
│              └────────┬─────────┘                                       │
│                       │                                                 │
│                       ▼                                                 │
│              ┌──────────────────┐                                       │
...
- **[Orchestrator Design](/docs/media-buy/advanced-topics/orchestrator-design)** - Building orchestration platforms
