...
```json
{
  ...
  "attribution_window": { "click_through_days": 28, "view_through_days": 1 },
  "priority": 1
}
```
...
| Window | Meaning |
|--------|---------|
| `click_through_days: 7` | Conversions within 7 days of a click |
| `click_through_days: 28` | Conversions within 28 days of a click |
| `view_through_days: 1` | Conversions within 1 day of viewing an ad |
| `view_through_days: 7` | Conversions within 7 days of viewing an ad |
