...
{/* Using latest because EventSurface and creator engagement event types are not in a released schema bundle yet. */}
```json
{
...
{/* Using latest because EventSurface is not in a released schema bundle yet. */}
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/latest/core/event-surface.json",
