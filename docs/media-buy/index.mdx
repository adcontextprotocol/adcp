...
- **[MCP (Model Context Protocol)](/docs/building/integration/mcp-guide)**: Direct integration with AI assistants like Claude
- **[A2A (Agent-to-Agent)](/docs/building/integration/a2a-guide)**: Complex agent workflows and collaboration

All protocols provide identical functionality - choose based on your integration needs. See [Protocol Comparison](/docs/building/understanding/protocol-comparison) for guidance.
...
### Discovery & Planning
- **[`get_adcp_capabilities`](/docs/protocol/get_adcp_capabilities)**: Discover agent capabilities, portfolio, and supported features (protocol-level)
- **[`get_products`](/docs/media-buy/task-reference/get_products)**: Discover advertising inventory using natural language briefs
- **[`list_creative_formats`](/docs/media-buy/task-reference/list_creative_formats)**: Understand creative requirements and specifications

### Campaign Execution
- **[`create_media_buy`](/docs/media-buy/task-reference/create_media_buy)**: Launch advertising campaigns with complete lifecycle management
- **[`update_media_buy`](/docs/media-buy/task-reference/update_media_buy)**: Modify budgets, targeting, and campaign settings

### Catalog Management
- **[`sync_catalogs`](/docs/media-buy/task-reference/sync_catalogs)**: Sync product feeds, inventory, stores, and vertical catalogs to seller accounts

### Creative Management
- **[`list_creatives`](/docs/creative/task-reference/list_creatives)**: Browse and filter creative asset libraries (creative protocol)
- **[`sync_creatives`](/docs/creative/task-reference/sync_creatives)**: Upload and synchronize creative assets across platforms

### Performance Optimization
- **[`get_media_buys`](/docs/media-buy/task-reference/get_media_buys)**: Check campaign state, creative approvals, missing formats, and optional near-real-time delivery snapshots
- **[`get_media_buy_delivery`](/docs/media-buy/task-reference/get_media_buy_delivery)**: Track performance metrics and campaign delivery
- **[`provide_performance_feedback`](/docs/media-buy/task-reference/provide_performance_feedback)**: Submit performance signals to enable publisher optimization

### Conversion Tracking
- **[`sync_event_sources`](/docs/media-buy/task-reference/sync_event_sources)**: Configure event sources on seller accounts for attribution
- **[`log_event`](/docs/media-buy/task-reference/log_event)**: Send conversion and marketing events for attribution and optimization
...
- **Content-Aware Products**: Products describe inventory along three axes — publisher properties (where), shows and episodes (what content), and placements (what position)
...
The buyer focuses on high-level campaign goals while giving publishers flexibility to optimize delivery. See [Accounts and Agents](/docs/building/integration/accounts-and-agents) for how buyers are identified.
...
### [Task Reference](/docs/media-buy/task-reference/) 🔗
...
### [Capability Discovery](/docs/media-buy/capability-discovery/) 🔍
...
### [Creatives](/docs/media-buy/creatives/) 🎨
Creative asset management including library management, asset lifecycle, and cross-platform synchronization. Works in conjunction with the [Creative Protocol](/docs/creative/) for building and managing creative content.

### [Conversion Tracking](/docs/media-buy/conversion-tracking/) 📊
...
### [Advanced Topics](/docs/media-buy/advanced-topics/) 🛠️
...
1. **Start with [Protocol Selection](/docs/building/understanding/protocol-comparison)** - Choose MCP or A2A based on your use case
2. **Call [`get_adcp_capabilities`](/docs/protocol/get_adcp_capabilities)** - Discover what the agent supports
3. **Learn [Capability Discovery](/docs/media-buy/capability-discovery/)** - Understand creative formats and property authorization
4. **Try [Product Discovery](/docs/media-buy/product-discovery/)** - See how natural language briefs work
5. **Reference [Task Reference](/docs/media-buy/task-reference/)** - Implement the core tasks

### **For Campaign Managers**
1. **Understand the [Media Buy Lifecycle](/docs/media-buy/media-buys/)** - Learn the complete workflow
2. **Review [Product Discovery](/docs/media-buy/product-discovery/)** - See how to find inventory with briefs
3. **Study [Policy Compliance](/docs/media-buy/media-buys/policy-compliance)** - Understand approval requirements
...
1. **Start with [Seller Integration](/docs/guides/seller-integration)** - End-to-end setup: adagents.json, get_products, create_media_buy
2. **Design your [Product Catalog](/docs/media-buy/product-discovery/media-products)** - Product model, pricing, delivery types, and forecasts
3. **Sell premium inventory** - Guaranteed delivery, [exclusivity](/docs/media-buy/product-discovery/media-products#exclusivity), [shows and episodes](/docs/media-buy/product-discovery/shows-and-episodes), and [proposals](/docs/media-buy/product-discovery/media-products#proposals) for reservations and sponsorships
4. **Set up [Authorization](/docs/governance/property/authorized-properties)** - adagents.json and property declarations
5. **Implement [Creative Formats](/docs/creative/formats)** - What your inventory accepts
6. **Expose [Delivery Reporting](/docs/media-buy/task-reference/get_media_buy_delivery)** - Performance data for buyer agents

### **For Technical Implementers**
1. **Choose your [Protocol](/docs/building/understanding/protocol-comparison)** - MCP vs A2A comparison
2. **Study [Task Reference](/docs/media-buy/task-reference/)** - Complete API documentation
3. **Review [Advanced Topics](/docs/media-buy/advanced-topics/)** - Security, testing, and architecture
4. **Explore [Creative Management](/docs/media-buy/creatives/)** - Asset lifecycle and synchronization
