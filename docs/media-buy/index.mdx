...
- **[`list_authorized_properties`](/docs/media-buy/task-reference/list_authorized_properties)**: Verify publisher authorization (deprecated - use `get_adcp_capabilities`)
