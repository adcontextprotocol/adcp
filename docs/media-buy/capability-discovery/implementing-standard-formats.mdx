...
The seller declares deliverability; it does not nominate a creative producer. Buyers can use the AAO registry to find creative agents whose self-declared canonical envelope satisfies the product declaration.
...
Resolve the publisher's `/.well-known/adagents.json` first. If the publisher has not adopted AdCP, use an explicitly identified AAO community mirror. Do not promote one sales agent's product declaration into a publisher fact.
...
- [Canonical formats](/docs/creative/canonical-formats)
- [Media products](/docs/media-buy/product-discovery/media-products)
- [Creative-agent capabilities](/docs/protocol/get_adcp_capabilities)
- [Deprecated `list_creative_formats`](/docs/creative/task-reference/list_creative_formats)
