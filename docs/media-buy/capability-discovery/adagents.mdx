...
```bash
# Using ajv-cli
ajv validate -s https://adcontextprotocol.org/schemas/v2/adagents.json -d your-adagents.json

# Using online validators
# Copy schema URL: https://adcontextprotocol.org/schemas/v2/adagents.json
```
