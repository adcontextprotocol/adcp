...
| `measurement_terms` | [MeasurementTerms](/docs/media-buy/advanced-topics/pricing-models#measurement-terms-and-performance-guarantees) | (Optional) Seller's default billing measurement and makegood terms. Buyers may propose different terms at `create_media_buy`. |
| `performance_guarantees` | [PerformanceGuarantee[]](/docs/media-buy/advanced-topics/pricing-models#measurement-terms-and-performance-guarantees) | (Optional) Seller's default performance guarantees (viewability, IVT, completion rate, brand safety, attention score). Buyers may propose different guarantees at `create_media_buy`. |
