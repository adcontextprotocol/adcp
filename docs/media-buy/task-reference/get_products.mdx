...
| `measurement_terms` | [MeasurementTerms](/docs/media-buy/advanced-topics/pricing-models#measurement-terms) | (Optional) Seller's default measurement and verification terms — billing measurement vendor, IVT threshold, viewability floor. Buyers may propose different terms at `create_media_buy`. See [Measurement Terms](/docs/media-buy/advanced-topics/pricing-models#measurement-terms). |
