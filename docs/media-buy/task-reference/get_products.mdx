---
title: get_products
description: Discover advertising inventory using natural language briefs or structured filters with AI matching.
...
See [Shows and episodes](/docs/media-buy/product-discovery/shows-and-episodes) for full documentation.
