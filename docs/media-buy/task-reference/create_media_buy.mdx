...
- **Input Required**: [`/schemas/v3/media-buy/create-media-buy-async-response-input-required.json`](https://adcontextprotocol.org/schemas/v3/media-buy/create-media-buy-async-response-input-required.json)
- **Failed**: [`/schemas/v3/media-buy/create-media-buy-async-response-failed.json`](https://adcontextprotocol.org/schemas/v3/media-buy/create-media-buy-async-response-failed.json)
- **Working**: [`/schemas/v3/media-buy/create-media-buy-async-response-working.json`](https://adcontextprotocol.org/schemas/v3/media-buy/create-media-buy-async-response-working.json)
- **Completed**: [`/schemas/v3/media-buy/create-media-buy-response.json`](https://adcontextprotocol.org/schemas/v3/media-buy/create-media-buy-response.json) (success variant)
...
When the operation is actively processing (typically < 120 seconds), the webhook may use `statusUpdate` with optional `parts.data`. The TextPart provides progress information:

| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `buyer_ref` | string | No | Buyer's reference identifier (optional, but recommended for tracking) |
...
**Note**: `parts.data` is optional for `working` status. If provided, it should include `buyer_ref` for operation identification. The TextPart provides human-readable progress information.
...
| `working` | `statusUpdate` | Optional: `buyer_ref` | None (but `buyer_ref` recommended) |
