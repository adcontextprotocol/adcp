...
| `warnings` | Structured non-blocking observations. The buy was still created. A continuing condition also appears on `get_media_buys`; see [Insights, Warnings, and Recommendations](/docs/media-buy/media-buys/insights). |
