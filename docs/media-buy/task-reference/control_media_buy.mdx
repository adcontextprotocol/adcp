...
{/* Using latest because control_media_buy is not yet released. Update after the 3.2 release. */}
**Request schema:** [`/schemas/latest/media-buy/control-media-buy-request.json`](https://adcontextprotocol.org/schemas/latest/media-buy/control-media-buy-request.json)
