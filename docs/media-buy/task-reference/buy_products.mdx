...
{/* Using latest because buy_products is not yet released. Update after the 3.2 release. */}
**Request schema:** [`/schemas/latest/media-buy/buy-products-request.json`](https://adcontextprotocol.org/schemas/latest/media-buy/buy-products-request.json)
