...
**Request Schema**: [`https://adcontextprotocol.org/schemas/v1/media-buy/list-creative-formats-request.json`](https://adcontextprotocol.org/schemas/v1/media-buy/list-creative-formats-request.json)
**Response Schema**: [`https://adcontextprotocol.org/schemas/v1/media-buy/list-creative-formats-response.json`](https://adcontextprotocol.org/schemas/v1/media-buy/list-creative-formats-response.json)
...
- **formats**: Full format definitions for formats this agent owns/supports
  ...
  - All other format fields as per [Format schema](https://adcontextprotocol.org/schemas/v1/core/format.json)
