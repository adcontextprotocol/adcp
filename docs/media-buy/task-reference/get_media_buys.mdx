...
| `audience_evidence_used` | Immutable copies of compact product audience-evidence rows that influenced selection or package construction. This preserves the planning basis without implying that the audience was targeted during execution. |
