...
**Response schema:** [`/schemas/latest/media-buy/refine-proposals-response.json`](https://adcontextprotocol.org/schemas/latest/media-buy/refine-proposals-response.json)
