...
description: "sync_creatives task — upload and manage creative assets on AdCP sales agents. Defined in the Creative Protocol specification."
"og:title": "AdCP — sync_creatives (media buy)"
---
