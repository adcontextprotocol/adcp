...
Use the creative agent to generate creatives from a brand manifest. See the [Generative Creatives guide](/docs/creative/generative-creatives) for complete workflow details.
...
- [Generative Creatives Guide](/docs/creative/generative-creatives) - Generate creatives from brand manifests
- [get_media_buy_delivery](/docs/media-buy/task-reference/get_media_buy_delivery) - Monitor creative performance
- [Creative Asset Specifications](/docs/creative/asset-specifications) - Technical requirements for assets
