...
- **Input Required**: [`/schemas/v3/media-buy/sync-creatives-async-response-input-required.json`](https://adcontextprotocol.org/schemas/v3/media-buy/sync-creatives-async-response-input-required.json)
- **Failed**: [`/schemas/v3/media-buy/sync-creatives-async-response-failed.json`](https://adcontextprotocol.org/schemas/v3/media-buy/sync-creatives-async-response-failed.json)
- **Working**: [`/schemas/v3/media-buy/sync-creatives-async-response-working.json`](https://adcontextprotocol.org/schemas/v3/media-buy/sync-creatives-async-response-working.json)
- **Completed**: [`/schemas/v3/media-buy/sync-creatives-response.json`](https://adcontextprotocol.org/schemas/v3/media-buy/sync-creatives-response.json) (success variant)

### Status: `input-required`

When human approval or input is needed (e.g., brand safety review, content approval), the webhook uses `statusUpdate` with `parts.data` containing:

| Field | Type | Required | Description |
|-------|------|----------|-------------|
| `creative_ids` | string[] | Yes | Array of creative IDs requiring approval or input |
  ...
  "statusUpdate": {
    ...
    "status": {
      ...
      "message": {
        ...
        "parts": [
          {
            "text": "Creatives require brand safety review before approval"
          },
          {
            "data": {
              "creative_ids": ["creative_video_001", "creative_display_002"],
