...
**See:** [Task Management - Async Operations](/docs/protocols/task-management) for webhook configuration.
...
| `CREATIVE_IN_ACTIVE_DELIVERY` | Creative is assigned to an active, non-paused package | Pause the package first, or create a new creative version        |
...
7. **Active delivery protection** - Creatives assigned to active, non-paused packages cannot be updated. Pause the package first or create a new creative with a different `creative_id`.
