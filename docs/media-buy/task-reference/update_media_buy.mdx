...
### Example 4: Upload New Creatives

You can upload new creative assets as part of an update, similar to create_media_buy:
  ...
  "packages": [
    {
      ...
      "creatives": [
        {
          "buyer_ref": "purina_winter_promo_30s",
          "format_id": {
...
#### Response
**Message**: "CTV package updated with 1 new creative. The new creative will begin serving immediately alongside existing creatives in the package rotation."
...
- Use `creative_ids` to reference existing library creatives, or `creatives` to upload new ones
