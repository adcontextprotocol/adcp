...
### Example 7: Upload New Creative

You can also upload and assign new creative assets in one step:
...
**Note**: Using `creatives` replaces all existing creative assignments with just the newly uploaded creative. To keep existing creatives, first upload using `sync_creatives`, then update using `creative_ids` with the complete list.
...
- Choose the right field for your use case:
  ...
  - `creatives`: Upload brand new creative assets during update
