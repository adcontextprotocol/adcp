...
| `budget_cap_timezone` | string \| null | No | Replace the shared IANA cap-day timezone override; `null` returns to the seller default. The new timezone begins at the next boundary under the previously effective timezone. |
