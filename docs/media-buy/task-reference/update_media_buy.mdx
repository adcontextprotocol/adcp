...
| `budget` | number | Updated hard package spend cap in the media-buy currency. In seller-optimized mode this is not a current allocation. |
| `min_spend_target` | number | Updated soft package minimum-spend target in the media-buy currency for seller-optimized allocation. |
