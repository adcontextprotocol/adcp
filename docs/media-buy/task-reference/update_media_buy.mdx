...
**Note**: Responses use discriminated unions. Terminal errors never carry `warnings`; warnings occur only on successful updates. See [Insights, Warnings, and Recommendations](/docs/media-buy/media-buys/insights).
