...
### Example 5: Update Creative Weights and Placement Targeting

Use `creative_assignments` to update weights or placement targeting without changing which creatives are assigned:
