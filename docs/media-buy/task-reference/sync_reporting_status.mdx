...
[billing authority](/docs/media-buy/advanced-topics/billing-authority), not
...
seller MUST reject `consumer` with [`UNSUPPORTED_FEATURE`](/docs/building/verification/compliance-catalog#error-code-unsupported-feature). Tracked in
