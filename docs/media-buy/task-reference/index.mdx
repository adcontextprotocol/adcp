...
|------|---------|---------------|-------|
| [`get_products`](/docs/media-buy/task-reference/get_products) | Discover inventory and refresh forecasts | ~60s | Discovery |
...
- [`get_products`](/docs/media-buy/task-reference/get_products) - Natural language product discovery and forecast refresh
...
3. **Refine Forecasts**: Re-call [`get_products`](/docs/media-buy/task-reference/get_products) with `product_ids` to iterate on budgets, dates, and targeting
