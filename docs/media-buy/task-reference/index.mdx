...
### Account Management
Before placing media buys, establish a commercial relationship with the seller. These tasks are shared across all vendor protocols and live in the Building with AdCP section:

- **[`sync_accounts`](/docs/building/integration/sync_accounts)** - Declare your advertiser portfolio and receive `account_id` values
- **[`list_accounts`](/docs/building/integration/list_accounts)** - Check account status and retrieve active `account_id` values
