...
- `get_products` `Product.format_options[]` - Product-specific canonical format specifications
...
- `list_*`: Enumerate collections with optional filtering (for example `list_creatives`)
