...
| [`get_forecast`](/docs/media-buy/task-reference/get_forecast) | Forecast delivery for a specific product configuration | ~60s | Discovery |
...
- [`get_forecast`](/docs/media-buy/task-reference/get_forecast) - Delivery forecast computation
...
- `get_*`: Retrieve current state or scoped datasets (for example `get_products`, `get_forecast`, `get_media_buys`, `get_media_buy_delivery`)
...
3. **Refine Forecasts**: Use [`get_forecast`](/docs/media-buy/task-reference/get_forecast) to iterate on budgets, dates, and targeting
4. **Understand Formats**: Check [`list_creative_formats`](/docs/media-buy/task-reference/list_creative_formats) for requirements
...
7. **Check Operational State**: Use [`get_media_buys`](/docs/media-buy/task-reference/get_media_buys) for status, approvals, and missing formats
8. **Monitor Performance**: Track reporting metrics with [`get_media_buy_delivery`](/docs/media-buy/task-reference/get_media_buy_delivery)
