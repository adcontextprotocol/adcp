...
| [`get_reporting_status`](/docs/media-buy/task-reference/get_reporting_status) | Check experimental managed-reporting health and repair missed delivery | ~1s | Reporting |
| [`sync_reporting_receipts`](/docs/media-buy/task-reference/sync_reporting_receipts) | Record managed-reporting consumer reconciliation | ~1s | Reporting |
