...
| [`list_authorized_properties`](/docs/media-buy/task-reference/list_authorized_properties) | See available publisher properties (deprecated) | ~1s | Capability |
...
- [`list_authorized_properties`](/docs/media-buy/task-reference/list_authorized_properties) - Available properties (deprecated - use [`get_adcp_capabilities`](/docs/protocol/get_adcp_capabilities))
...
- **[`list_authorized_properties`](/docs/media-buy/task-reference/list_authorized_properties)** - See available placements (deprecated)
...
4. **Create Campaign**: Use [`create_media_buy`](/docs/media-buy/task-reference/create_media_buy) with selected products
5. **Upload Creatives**: Use [`sync_creatives`](/docs/media-buy/task-reference/sync_creatives) for asset management
6. **Monitor Performance**: Track results with [`get_media_buy_delivery`](/docs/media-buy/task-reference/get_media_buy_delivery)
