...
| [`sync_reporting_status`](/docs/media-buy/task-reference/sync_reporting_status) | Tell a seller whether expected reporting was received, omitted, missing, or unreadable | ~1s | Reporting |
...
- **[`sync_reporting_status`](/docs/media-buy/task-reference/sync_reporting_status)** - Close the loop with the buyer's received, missing, or unreadable status
