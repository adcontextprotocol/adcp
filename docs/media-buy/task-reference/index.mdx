...
- **[`sync_accounts`](/docs/commerce/tasks/sync_accounts)** - Declare your advertiser portfolio and receive `account_id` values
- **[`list_accounts`](/docs/commerce/tasks/list_accounts)** - Check account status and retrieve active `account_id` values
