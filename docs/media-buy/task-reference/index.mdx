...
| [`get_reporting_status`](/docs/media-buy/task-reference/get_reporting_status) | Check Reliable Reporting health and repair missed ledger changes | ~1s | Reporting |
| [`sync_reporting_status`](/docs/media-buy/task-reference/sync_reporting_status) | Tell a seller whether expected reporting was received, omitted, missing, unreadable, or contradictory | ~1s | Reporting |
| [`sync_reporting_receipts`](/docs/media-buy/task-reference/sync_reporting_receipts) | Record Reliable Reporting revision and adjustment reconciliation | ~1s | Reporting |
...
- [`get_reporting_status`](/docs/media-buy/task-reference/get_reporting_status) - Managed-reporting health and revision resolution
- [`sync_reporting_status`](/docs/media-buy/task-reference/sync_reporting_status) - Authenticated buyer status for each expected reporting period
- [`sync_reporting_receipts`](/docs/media-buy/task-reference/sync_reporting_receipts) - Authenticated reporting reconciliation receipts
...
- **[`get_reporting_status`](/docs/media-buy/task-reference/get_reporting_status)** - Check durable reporting obligations, revisions, and materializations
- **[`sync_reporting_status`](/docs/media-buy/task-reference/sync_reporting_status)** - Close the loop with the buyer's received, missing, unreadable, or contradictory status
- **[`sync_reporting_receipts`](/docs/media-buy/task-reference/sync_reporting_receipts)** - Record independently verified consumer totals and evidence
...
- [`sync_reporting_receipts`](/docs/media-buy/task-reference/sync_reporting_receipts): Reconcile consumer-observed reporting evidence into the seller's durable ledger
- [`sync_reporting_status`](/docs/media-buy/task-reference/sync_reporting_status): Record what the authenticated buyer could actually consume without turning Core status into billing reconciliation
