...
| [`log_event`](/docs/media-buy/task-reference/log_event) | Send conversion events for attribution | ~1s | Conversion Tracking |
...
- [`log_event`](/docs/media-buy/task-reference/log_event) - Conversion event ingestion
...
### Conversion Tracking
Configure event sources and send conversion events for attribution.

- **[`sync_event_sources`](/docs/media-buy/task-reference/sync_event_sources)** - Configure event sources on seller accounts
- **[`log_event`](/docs/media-buy/task-reference/log_event)** - Send conversion and marketing events
