...
| [`refine_proposals`](/docs/media-buy/task-reference/refine_proposals) | Create immutable proposal revisions | ~60s | Planning |
...
- **[`request_proposals`](/docs/media-buy/task-reference/request_proposals)**, **[`refine_proposals`](/docs/media-buy/task-reference/refine_proposals)**, and **[`decline_proposals`](/docs/media-buy/task-reference/decline_proposals)** - Explicit proposal lifecycle operations; requested and refined proposals are executable snapshots
...
- `request_*`, `refine_*`, and `decline_*`: Explicit lifecycle transitions over immutable resources; executable proposals flow directly into [`create_media_buy`](/docs/media-buy/task-reference/create_media_buy)
