...
**Request Schema**: [`https://adcontextprotocol.org/schemas/v1/media-buy/get-media-buy-delivery-request.json`](https://adcontextprotocol.org/schemas/v1/media-buy/get-media-buy-delivery-request.json)
**Response Schema**: [`https://adcontextprotocol.org/schemas/v1/media-buy/get-media-buy-delivery-response.json`](https://adcontextprotocol.org/schemas/v1/media-buy/get-media-buy-delivery-response.json)
