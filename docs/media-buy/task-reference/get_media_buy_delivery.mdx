...
description: Retrieve delivery metrics, dimensional breakdowns, and performance data for active campaigns.
...
const result = await testAgent.getMediaBuyDelivery({
  buyer_refs: ['acme_q1_campaign_2024', 'acme_q1_retargeting_2024']
});
