...
RC.3 adds its hardening. Sellers implementing that extension advertise
`consumer_status_task`; it becomes required Core only in the next eligible minor
after the notice window. Sellers declare `media_buy.reporting_delivery` in
