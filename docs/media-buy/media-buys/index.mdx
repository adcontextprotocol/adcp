...
- **AI-driven advisories** through performance feedback loops
...
2. **Analyze performance** across packages and targeting
   - Use dimensional reporting for granular advisories
...
- **[Advisories, Warnings, and Recommendations](/docs/media-buy/media-buys/advisories)** - Immediate success advisories, durable seller interpretations, and change invalidations
