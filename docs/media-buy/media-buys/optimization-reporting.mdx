...
- **Frequency management** — tune `frequency_cap` (suppress_minutes cooldown or max_impressions/per/window cap) based on delivery patterns
...
|-----------|----------------|------------|-----------------|
| Geography | `by_geo` | `geo_level`, `geo_code`, `geo_name` | `supports_geo_breakdown` |
