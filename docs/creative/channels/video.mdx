...
- MUST make `VAST_VERSION_MISMATCH` details conform to [`error-details/vast-version-mismatch.json`](https://adcontextprotocol.org/schemas/latest/error-details/vast-version-mismatch.json).
