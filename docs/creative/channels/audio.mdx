...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/latest/core/product-format-declaration.json",
...
See [Canonical formats](/docs/creative/canonical-formats), [Radio](/docs/creative/channels/radio), [Broadcast](/docs/creative/channels/broadcast), and [`list_transformers`](/docs/creative/task-reference/list_transformers).
