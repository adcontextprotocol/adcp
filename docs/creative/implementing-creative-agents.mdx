...
3. **Return pricing in `build_creative` responses** — `pricing_option_id`, `vendor_cost`, `currency`, and optionally `consumption` details
...
See the [Pricing section of the specification](/docs/creative/specification#pricing) for the full pricing flow and requirements.
