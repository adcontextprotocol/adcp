...
Keep capability IDs stable. They are scoped to your agent and passed as `target_capability_id`; they are not format identities and never appear on products or manifests.
