...
After the campaign delivers, the buyer reports usage via [`report_usage`](/docs/accounts/tasks/report_usage). The `pricing_option_id` and `creative_id` flow through for reconciliation:
