...
| `variant_id` | string | Variant | Agent-assigned, agent-unique AdCP served-execution identifier from [`get_creative_delivery`](/docs/creative/task-reference/get_creative_delivery). |
