...
| `requests` | array | Batch | Array of 1-50 preview requests. Each item accepts a canonical `creative_manifest`, `target_capability_id`, inputs, quality, output format, item limit, and template ID. |
