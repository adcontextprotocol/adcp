...
**Key features:**
- **Advanced filtering**: Search by format, status, tags, dates, assignments, concepts, and variables
...
- **Concept-aware**: Filter by creative concept (groups of related creatives across sizes/formats)
...
The `filters` object supports format, status, tag, date, concept, variable, and assignment filtering. All filters are optional and composable.
