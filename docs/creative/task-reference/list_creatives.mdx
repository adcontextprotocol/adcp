...
| `include_performance` | boolean | No | Include aggregated historical performance metrics — impressions, clicks, CTR, conversions (default: false) |
| `include_sub_assets` | boolean | No | Include individual assets within multi-asset creatives like carousels and native ads (default: false) |
...
| `formats` | string[] | Filter by format type (e.g., `"video"`, `"display"`) |
...
| `has_performance_data` | boolean | Filter for creatives with performance data * |
