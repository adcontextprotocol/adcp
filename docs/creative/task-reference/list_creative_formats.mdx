...
**Request Schema**: [`https://adcontextprotocol.org/schemas/v2/creative/list-creative-formats-request.json`](https://adcontextprotocol.org/schemas/v2/creative/list-creative-formats-request.json)
**Response Schema**: [`https://adcontextprotocol.org/schemas/v2/creative/list-creative-formats-response.json`](https://adcontextprotocol.org/schemas/v2/creative/list-creative-formats-response.json)
...
- **formats**: Array of complete format definitions
  - See [Format schema](https://adcontextprotocol.org/schemas/v2/core/format.json) for full specification
