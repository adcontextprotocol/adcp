...
| `ooh_metrics` | Classic (static) OOH data — object with `panels`, `posting_period_start`/`posting_period_end`, `estimated_impressions`, `estimation_basis`, `postings` (posting records with photo evidence) |
