...
| `brand_manifest` | object \| string | No | Brand identity and guidelines. Inline [Brand Manifest](/schemas/v2/core/brand-manifest.json) object or URL to a hosted manifest. Provides brand-level context (colors, logos, tone). |
| `creative_brief` | object \| string | No | Campaign-level creative brief. Inline [Creative Brief](/schemas/v2/core/creative-brief.json) object or URL to a hosted brief. Provides objective, audience, messaging, and reference assets. |
