...
| `creative_brief` | object \| string | No | Campaign-level creative brief. Inline [Creative Brief](https://adcontextprotocol.org/schemas/v1/core/creative-brief.json) object or URL to a hosted brief. Provides objective, audience, messaging, and reference assets. |
