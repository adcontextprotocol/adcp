...
- **After the campaign** — pass a `variant_id` from `get_creative_delivery` to replay exactly what was served for a specific context.

See [Previewing generative creative](/docs/creative/task-reference/preview_creative#previewing-generative-creative) for examples and expectations.
