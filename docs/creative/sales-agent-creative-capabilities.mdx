...
Creative review status is communicated through the creative's status in [`list_creatives`](/docs/creative/task-reference/list_creatives) or in the media buy response. The protocol does not prescribe specific review states, but common patterns include:

- **Pending review** — the creative has been received but not yet approved
- **Approved** — the creative passed review and is eligible to serve
- **Rejected** — the creative failed review, with a reason provided in the response

Agents that perform automated or manual review SHOULD communicate review status promptly. Buyers SHOULD check creative status after syncing or submitting a media buy with new creatives, especially for publishers with strict creative policies.
