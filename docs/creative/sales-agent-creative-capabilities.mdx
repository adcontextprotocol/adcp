...
Creative review status is communicated through the creative's status in `list_creatives` or in the media buy response. The protocol does not prescribe specific review states, but common patterns include:
