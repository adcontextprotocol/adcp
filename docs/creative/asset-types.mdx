...
- `vast_version`: Exact VAST specification version supplied by this asset (2.0, 3.0, 4.0, 4.1, 4.2, 4.3, 4.4). Product format options use plural `vast_versions` for their accepted set.
