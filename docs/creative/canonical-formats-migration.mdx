...
AdCP 3.2 is canonical-first end to end. New implementations use portable format declarations rather than agent-owned named formats.
...
2. When starting from a publisher, read its `adagents.json.formats[]` or the AAO mirror.
