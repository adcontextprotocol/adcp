...
When a manifest was resolved from a pre-binding source with equivalent trafficking representations, it carries `delivery_variant_selection`. That object preserves the source creative ID, revision, and selected source `variant_id`; it is not a rotation or served-variant instruction. See [Creative delivery variants](/docs/creative/delivery-variants).
...
- [Asset types](/docs/creative/asset-types)
- [Creative delivery variants](/docs/creative/delivery-variants)
- [`build_creative`](/docs/creative/task-reference/build_creative)
- [`sync_creatives`](/docs/creative/task-reference/sync_creatives)
