...
**If you're building a sales agent focused purely on media buying**, you can provide a minimal manifest. The brand manifest is required as the namespace for campaigns, but you don't need extensive brand details unless you're using policy checks, creative generation, or optimization features.
...
- Campaign namespace and grouping by brand
- Basic identity for reporting and tracking
