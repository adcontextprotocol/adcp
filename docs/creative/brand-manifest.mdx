...
```json
{
  ...
  "logos": [
    {
      "url": "https://cdn.acmecorp.com/logo-dark.png",
    ...
    {
      "url": "https://cdn.acmecorp.com/logo-light.png",
...
```typescript
{
  ...
  tags?: string[];       // Semantic tags for logo variant selection
  usage?: string;        // Human-readable description of when to use this variant
  width?: number;        // Logo width in pixels
  height?: number;       // Logo height in pixels
}
```

#### Standardized Logo Tags

Use these standardized tags to help creative agents select appropriate logo variants:
...
**Orientation:**
- `square` - Square or circular lockup
    ...
    "logos": [
      {
        ...
        "tags": ["transparent-bg", "square", "primary"],
...
### 2. Use Standardized Tags for Logos

Use standardized tags to help creative agents select appropriate logo variants:
