...
> **Canonical formats in 3.2**: new products declare formats inline via `format_options` (an array of `ProductFormatDeclaration`s narrowing one of 12 canonical formats). This page documents the named-format compatibility model. Fields named exactly `format_ids` are deprecated in 3.2 and removed in 4.0; singular `format_id`, named-format definitions, and `list_creative_formats` follow separate schedules. See [canonical-formats](/docs/creative/canonical-formats) and the [migration guide](/docs/creative/canonical-formats-migration).
...
- [list_creative_formats Task](/docs/creative/task-reference/list_creative_formats) - API reference for format discovery
