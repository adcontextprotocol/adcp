---
title: Portfolios
description: Comprehensive creative collections containing both source assets and assembled creatives - portable across seller agents
---

Portfolios are **comprehensive creative collections** that contain both source assets (images, videos, copy) and assembled creatives (the built ads). Unlike platforms that hide assembled creatives (Google PMax) or only store static assets (traditional libraries), AdCP portfolios give buyers **full visibility and portability** - you see both the ingredients AND the dishes, and can take them anywhere.
