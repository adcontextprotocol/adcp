...
<Info>
**AdCP 3.2:** canonical declarations are the current Creative Protocol model. Named format IDs and `list_creative_formats` are deprecated compatibility surfaces.
</Info>
