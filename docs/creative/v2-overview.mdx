...
|---|---|---|
| **Spec maturity** | `params.status` on the canonical (`/schemas/formats/canonical/<name>.json`) | "Has the v2 working group stabilized this format definition?" Values: `stable` / `preview` / `deprecated`. |
