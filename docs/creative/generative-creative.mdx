...
Because this entry includes `preview`, the enclosing capability response also lists `native_launch_generator` in `creative.preview.supported_capability_ids` and declares whether the preview is `authoritative` or `representative`. Generative output from a standalone creative agent is normally representative.
...
- [`list_transformers`](/docs/creative/task-reference/list_transformers)
- [Canonical formats](/docs/creative/canonical-formats)
- [Multi-agent orchestration](/docs/creative/multi-agent-orchestration)
