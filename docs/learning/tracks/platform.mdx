...
- **Campaign governance architecture** — implement three-party validation: register governance agents via `register_governance`, call `check_governance` before executing, handle all statuses
