...
Your buyer agent runs against the public test agent (`test-mcp`). Use the `adcp` CLI to execute tool calls and verify your agent handles the complete buying workflow:
