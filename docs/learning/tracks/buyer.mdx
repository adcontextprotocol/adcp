...
AdCP `3.2-beta.6` wire bundle. Pin `@adcp/sdk@14.0.0-beta.11`, verify the
...
npx @adcp/sdk@14.0.0-beta.11 test-mcp get_products '{"adcp_version":"3.2-beta.6","idempotency_key":"550e8400-e29b-41d4-a716-446655442065","buying_mode":"brief","brief":"your campaign brief"}'
```
