...
description: Orchestrate multi-agent buying workflows. Brand identity protocols, creative workflows, sponsored intelligence, and a build project.
---
...
<Card title="Start C4 with Addie" icon="play" href="https://agenticadvertising.org/addie">
...
- [S4: Governance](/docs/learning/specialist/governance) — brand safety, compliance, content standards
