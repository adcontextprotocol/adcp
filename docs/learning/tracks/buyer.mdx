...
AdCP `3.2-rc.1` wire bundle. Pin `@adcp/sdk@14.0.0-rc.36` and send `3.2-rc.1`
as the wire pin: RC.36 embeds `3.2.0-rc.2`, so it validates against that
bundle and its `adcpVersion` option will not accept `3.2-rc.1`. Verify the
...
# The CLI passes adcp_version through, so "3.2-rc.1" reaches the seller even
# though @adcp/sdk@14.0.0-rc.36 embeds 3.2.0-rc.2 for its own validation.
npx @adcp/sdk@14.0.0-rc.36 test-mcp get_products '{"adcp_version":"3.2-rc.1","idempotency_key":"550e8400-e29b-41d4-a716-446655442065","buying_mode":"brief","brief":"your campaign brief"}'
```
