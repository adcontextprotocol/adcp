...
<CardGroup cols={2}>
  ...
  <Card title="Canonical formats" icon="palette" href="/docs/creative/canonical-formats">
...
<CardGroup cols={2}>
  ...
  <Card title="Reporting Core obligation lifecycle" icon="clock-rotate-left" href="/docs/media-buy/reporting-core-implementation-guide#lifecycle-at-a-glance">
    See exactly when obligations exist and how `expected_at` is derived.
  </Card>
  <Card title="get_reporting_status task" icon="list-check" href="/docs/media-buy/task-reference/get_reporting_status">
    Project obligations, immutable revisions, health, and retained reporting history.
  </Card>
  <Card title="Broadcast measurement windows" icon="chart-mixed" href="/docs/media-buy/media-buys/optimization-reporting#measurement-maturation-windows">
...
[Measurement maturation windows](/docs/media-buy/media-buys/optimization-reporting#measurement-maturation-windows).
...
[Reporting Core: Lifecycle at a glance](/docs/media-buy/reporting-core-implementation-guide#lifecycle-at-a-glance)
and [get_reporting_status: Reliability model](/docs/media-buy/task-reference/get_reporting_status#reliability-model).
...
The storyboard exercises the complete buyer workflow — discovery, account sync, media buy, creatives, delivery — and validates every response. See [Validate Your Agent](/docs/building/verification/validate-your-agent) for setup and debugging.
