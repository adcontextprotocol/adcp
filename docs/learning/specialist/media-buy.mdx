...
<CardGroup cols={2}>
  ...
  <Card
    ...
    href="/docs/media-buy/reporting-core-implementation-guide"
  >
  ...
  <Card
    ...
    icon="list-check"
    href="/docs/media-buy/task-reference/get_reporting_status"
  >
...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="handshake"
    href="/docs/media-buy/product-discovery/proposal-negotiation"
  >
