...
- Explain the measurement-agent loop: make the orchestrator a buyer-controlled delivery and feedback gateway, negotiate pull/webhook/bucket inputs, authenticate provider output, and fan normalized assertions out to sellers without granting providers seller access
...
<CardGroup cols={2}>
  <Card
    ...
    href="/docs/media-buy/task-reference/get_products"
  >
  ...
  <Card
    ...
    icon="receipt"
    href="/docs/media-buy/task-reference/create_media_buy"
  >
  ...
  <Card
    ...
    icon="pen-to-square"
    href="/docs/media-buy/task-reference/update_media_buy"
  >
  ...
  <Card
    ...
    icon="list-check"
    href="/docs/media-buy/task-reference/get_media_buys"
  >
  ...
  <Card
    ...
    icon="chart-line"
    href="/docs/media-buy/task-reference/get_media_buy_delivery"
  >
...
<CardGroup cols={2}>
  <Card
    ...
    icon="scroll"
    href="/docs/media-buy/specification"
  >
  ...
  <Card
    ...
    icon="tag"
    href="/docs/media-buy/advanced-topics/pricing-models"
  >
  ...
  <Card
    ...
    icon="handshake"
    href="/docs/media-buy/advanced-topics/accountability"
  >
  ...
  <Card
    ...
    icon="layer-group"
    href="/docs/media-buy/media-buys/index"
  >
  ...
  <Card
    ...
    href="/docs/building/understanding/adcp-vs-openrtb"
  >
  ...
  <Card
    ...
    href="/docs/building/operating/orchestrator-design"
  >
  ...
  <Card
    ...
    icon="bullseye"
    href="/docs/media-buy/conversion-tracking/index"
  >
  ...
  <Card
    ...
    icon="comment-dots"
    href="/docs/media-buy/task-reference/provide_performance_feedback"
  >
  ...
  <Card
    ...
    href="/docs/trusted-match/context-and-identity"
  >
  ...
  <Card
    ...
    icon="diagram-project"
    href="/docs/trusted-match/router-architecture"
  >
...
5. **Campaign creation and optimization** — Create a media buy, monitor delivery, execute updates, and submit compact performance feedback with a named baseline. Interpret `accepted`, `applied`, and `not_applied` without overstating causality. Verify `update_media_buy` fails without `account` and succeeds with it.
...
9. **Multi-agent orchestration and execution** — Manage campaigns across multiple sellers. Trace a cross-publisher suppression scenario: a viewer sees an ad on publisher A, then visits publisher B within the 2-hour recency window — what does Identity Match return and why? Configure frequency parameters (5/week, 2-hour minimum recency) and predict delivery impact. Explain why Context Match and Identity Match are structurally separated. Then configure an orchestrator-hosted measurement gateway: choose pull, webhook, or bucket delivery; grant only the needed orchestrator tasks; ingest provider feedback; and map one cross-seller result into seller-local submissions.
