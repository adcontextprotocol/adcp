...
description: Protocol specialist capstone in creative workflows — asset production, format compliance, cross-platform adaptation, and creative governance.
---

# Specialist capstone — Creative (E2)

<Info>
**Members only** — Requires Practitioner credential. ~30 minutes with Addie. Combines hands-on lab and adaptive exam.
</Info>

This capstone tests your mastery of the creative protocol. You'll work with sandbox agents to discover format requirements, produce and adapt creative assets, sync them to publishers, and verify compliance. Addie evaluates both your hands-on work and your conceptual understanding.
...
|-----------|--------|---------------------|
| Protocol mastery | 30% | Correct use of creative tasks and format schemas |
| Cross-platform adaptation | 25% | Can you adapt assets across channels without losing quality? |
| Format compliance | 20% | Do your creatives meet publisher specifications? |
| Problem solving | 15% | How do you handle format conflicts and edge cases? |
| Communication | 10% | Can you explain creative decisions clearly? |

Passing threshold: 70%.

## Start this capstone

<Card title="Start E2 with Addie" icon="play" href="https://agenticadvertising.org/addie">
  "I'd like to start the creative specialist capstone."
</Card>
