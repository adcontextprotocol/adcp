...
description: "AdCP specialist module S2: Creative mastery. Format taxonomy across 19 channels, creative manifest spec, AI generation, compliance checks, and asset sync workflows."
...
<Card title="Start S2 with Addie" icon="play" href="https://agenticadvertising.org/addie">
