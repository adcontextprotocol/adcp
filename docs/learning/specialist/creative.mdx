...
description: Specialist deep dive in creative workflows — format taxonomy across 19 channels, manifest specification, AI generation, compliance, and feature evaluation.
