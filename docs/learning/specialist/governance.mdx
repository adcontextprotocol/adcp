...
| `inventory-lists` | stable | Property and collection list governance — curated inventory groupings |
...
| `measurement-verification` | preview | Third-party measurement and verification (3.1 — parked under governance) |

Note: `property-governance` + `collection-governance` merged into `inventory-lists` in 3.0.
