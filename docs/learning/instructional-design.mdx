...
Modules B4, C4, and D4 use a five-phase approach built on the same tools developers use in practice — [skill files](/docs/building/by-layer/L4/build-an-agent) to generate agents and [storyboards](/docs/building/verification/validate-your-agent) to validate them:
