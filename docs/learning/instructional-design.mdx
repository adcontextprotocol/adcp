...
description: Teaching methodology, assessment philosophy, and quality processes for the AdCP certification program.
---
...
**Socratic method.** Addie teaches through conversation, not lecture. Every response ends with a question or task. Learners build understanding by reasoning through problems, not by receiving answers.
...
- **Learner escalation** — learners who need human assistance can contact certification@agenticadvertising.org. Assessment disputes are handled through the [complaints process](/docs/learning/policies/complaints)
...
**Overqualified learners.** If a learner demonstrates mastery early, Addie moves directly to assessment rather than force-teaching known material.
