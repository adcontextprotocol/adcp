...
3. **Validate** (~10 min) — learner runs the matching storyboard from the CLI (`adcp storyboard run my-agent media_buy_seller`), shares results with Addie, and iterates on failures with their coding assistant
