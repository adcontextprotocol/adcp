...
`creative_id`, and a complete image creative fixture. This represents the
connected platform adding a creative while your buyer agent is idle; do not
call `sync_creatives` first.
