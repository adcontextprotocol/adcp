...
- 20 channels: display, social, search, CTV, linear TV, radio, podcast, DOOH, OOH, print, cinema, gaming, retail media, influencer, affiliate, product placement, AI media — and why linear TV and radio measure differently: broadcast impression data arrives on a panel schedule (C3/C7 windows, not real-time), which you'll work with concretely in S1
