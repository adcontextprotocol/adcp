...
Authenticate with a WorkOS API key (`Authorization: Bearer sk_…`) or an OAuth user JWT. Mint an API key under [agenticadvertising.org/dashboard/settings/api-keys](https://agenticadvertising.org/dashboard/settings/api-keys).
