...
It labels discovery data only — enforcement-grade verification still goes through the [supply-path verifier](/docs/governance/property/adagents#owner-sold-channel-carriage) or the authoritative files.
