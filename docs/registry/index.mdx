...
All sources produce the same resolution response structure. To get full [brand manifest](/docs/creative/brand-manifest) data (logos, colors, tone), use `/api/brands/enrich` or look up the brand's manifest in the registry.
