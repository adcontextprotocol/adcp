...
All sources produce the same brand identity structure. To get full brand manifest data (logos, colors, tone), use `/api/brands/enrich` or look up the brand's manifest in the registry.
