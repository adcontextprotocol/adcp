...
**Purpose**:
- **Protocol discovery** - Which AdCP major versions? Which domain protocols?
- **Media-buy capabilities** - Features, AXE integrations, geo targeting granularity
- **Future protocols** - Signals and other domain protocols

**Request Schema**: [`/schemas/v1/protocol/get-capabilities-request.json`](https://adcontextprotocol.org/schemas/v1/protocol/get-capabilities-request.json)
**Response Schema**: [`/schemas/v1/protocol/get-capabilities-response.json`](https://adcontextprotocol.org/schemas/v1/protocol/get-capabilities-response.json)

:::note
This is a protocol-level task that works across all AdCP domain protocols. Use it to discover capabilities for media-buy, signals, and future protocols in a single call.
:::
