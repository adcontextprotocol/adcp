...
Although its name resembles a read, [`get_creative_features`](/docs/governance/creative/get_creative_features) is also key-required: accepting an evaluation allocates provider work and may create consumption or cost records. Its task-specific replay window is at least 24 hours.
