...
**Agentic eXecution Engine (AXE)** — real-time execution layer for brand suitability, frequency capping, first-party data activation, and dynamic audience targeting. Connects via key-value pairs or RTB protocols. See [AXE documentation](/docs/media-buy/advanced-topics/agentic-execution-engine).
