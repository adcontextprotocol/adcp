...
```json
{
  ...
  "governance": {
    "property_features": [
      { "feature_id": "mfa_score", "type": "quantitative", "range": { "min": 0, "max": 100 }, "description": "Made For Advertising score (lower is better)", "methodology_url": "https://vendor.example.com/methodology/mfa" },
