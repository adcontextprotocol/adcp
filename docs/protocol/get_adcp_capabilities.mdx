...
**Key distinction:**
- **Product filters** (get_products): Filter by country coverage AND seller capabilities (like ZIP targeting support)
- **Targeting overlay** (create_media_buy): Apply fine-grained geography to restrict where ads actually deliver
