...
| `supported_identifier_types` | string[] | Supported identifier types for audience targeting (e.g., `['nielsen_dma', 'zip_code']`). Presence indicates support. |
| `supported_uid_types` | string[] | Supported UID types for audience targeting (e.g., `['maid']`). Presence indicates support. |
