...
| Field | Type | Description |
|-------|------|-------------|
| `experimental_features` | string[] | Experimental feature ids (e.g., `["brand.rights_lifecycle", "governance.campaign", "trusted_match"]`) |
...
```json
{
  "experimental_features": ["brand.rights_lifecycle", "trusted_match"]
}
```
