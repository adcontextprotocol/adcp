...
See [Accounts and Agents](/docs/building/integration/accounts-and-agents#trust-model) for full workflows and [seller billing patterns](/docs/building/integration/accounts-and-agents#seller-billing-patterns) for common combinations of auth model, billing support, and agent account.
