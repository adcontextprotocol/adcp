...
**Request Schema**: [`/schemas/latest/protocol/sync-agent-notification-configs-request.json`](https://adcontextprotocol.org/schemas/latest/protocol/sync-agent-notification-configs-request.json)
**Response Schema**: [`/schemas/latest/protocol/sync-agent-notification-configs-response.json`](https://adcontextprotocol.org/schemas/latest/protocol/sync-agent-notification-configs-response.json)
