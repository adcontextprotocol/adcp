...
The proposed campaign-governance update adds task-scoped service enforcement, opaque plan binding, intent-only conditions negotiation, authenticated caller binding, phase-correct media-buy identifiers, and governance-authoritative outcome accounting. The implementation and migration guide may merge during 3.2 development, before the first beta. See [#5944](https://github.com/adcontextprotocol/adcp/issues/5944) for the governing use case.
