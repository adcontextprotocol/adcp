...
- Attribution window metadata on delivery response: `click_through_days`, `view_through_days`, and attribution `model` (last_touch, first_touch, linear, time_decay, data_driven)
