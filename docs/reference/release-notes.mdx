...
**Status:** Published September 14, 2026 — maintenance patch. The stable wire negotiation value remains `"3.1"`.

This patch supplies the missing #7397 changelog coverage for the v3.1.22 emergency privacy/security correction and fixes compliance storyboard tool gates. See the [v3.1.23 release](https://github.com/adcontextprotocol/adcp/releases/tag/v3.1.23) for the full record.
...
The v3.1.22 corrections shipped immediately as an emergency security exception to the normal six-week notice process for breaking changes to experimental surfaces. This records the exception; it does not change the general [experimental notice contract](/docs/reference/experimental-status#contract-for-experimental-surfaces). Corrections to the release record are carried forward in current-source documentation and the next patch rather than by rewriting published v3.1.22 artifacts.
