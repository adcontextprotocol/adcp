...
Python `adcp==8.0.0b14`, and Go `adcp/v3@v3.2.1` all still embed RC.1; Python
and Go higher-level coverage remains role-dependent. Test RC.3
...
| A compliance operator | Test RC.3 from its signed assets; no SDK pairing covers RC.3 yet. `@adcp/sdk@14.0.0-rc.35`, Python `adcp==8.0.0b14`, and Go `adcp/v3@v3.2.1` all test RC.1. Retain exact package and wire versions end to end, and do not issue a 3.2 badge from a prerelease. |
