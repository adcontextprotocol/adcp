...
| `ai_media` | AI assistants, AI search, and generative AI platforms |
...
AI platform advertising — ads within AI assistants, AI search results, and generative AI experiences.
...
- Brand experience handoffs via Sponsored Intelligence protocol
...
**Note**: `ai_media` describes the BUYING CONTEXT (AI platform ad tools) where the user is interacting with an AI system, not traditional web or app surfaces.
...
- `ai_media` - Platform-managed inventory within AI ecosystems
...
- Add `ai_media` channel for AI platform advertising (AI assistants, AI search, generative AI experiences)
- 20 channels defined
