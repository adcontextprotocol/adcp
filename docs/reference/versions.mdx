...
|---|---|---|---|
| **Beta** | 3.2 (current prerelease: `beta.6`) | `"3.2-beta.6"` | Development and staging only. Use the signed beta.6 artifact directly; current TypeScript and Python SDK betas embed beta.5. Follow the [3.2 beta program](/docs/reference/3-2-beta). |
