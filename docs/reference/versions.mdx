...
|---|---|---|---|
| **Release candidate** | 3.2 (current prerelease: `rc.1`) | `"3.2-rc.1"` | Development and staging only. RC.1 is the current signed protocol checkpoint. TypeScript SDK RC.32, Python SDK beta.14, and Go SDK 3.2.1 embed it exactly. Follow the [3.2 prerelease program](/docs/reference/3-2-beta). |
| **Active** | 3.1 (current stable: 3.1.23) | `"3.1"` | Current production minor release. See [What's New in AdCP 3.1](/docs/reference/whats-new-in-3-1) for the feature set. |
...
| 3.1.22 | 2026-09-13 | Emergency privacy/security corrections changed the explicitly experimental TMP contract under the recorded notice exception; see the [v3.1.22 release note](/docs/reference/release-notes#version-3-1-22). |
| **3.1.23** | 2026-09-14 | **Latest stable patch.** Corrects the v3.1.22 release record and compliance storyboard tool gates; see the [v3.1.23 release note](/docs/reference/release-notes#version-3-1-23). |
...
### What's "current"?
For new production integrations, **3.1.23** is current; pin your integration to `"3.1"` (not `"3.1.23"`). Existing 3.0 integrations can remain pinned to `"3.0"` while they migrate. Use 3.2 only for prerelease testing with an exact advertised pin. See [Version negotiation](/docs/reference/versioning#version-negotiation).
