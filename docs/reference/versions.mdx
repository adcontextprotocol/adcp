...
|---|---|---|---|
| **Beta** | 3.2 (current prerelease: `beta.9`) | `"3.2-beta.9"` | Development and staging only. Beta.9 is the current protocol checkpoint; TypeScript SDK beta.13 and Python beta.9 remain on beta.6 pending refreshes. Follow the [3.2 beta program](/docs/reference/3-2-beta). |
