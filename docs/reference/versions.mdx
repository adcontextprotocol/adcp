...
|---|---|---|---|
| **Beta** | 3.2 (current prerelease: `beta.6`) | `"3.2-beta.6"` | Development and staging only. TypeScript SDK beta.8 embeds beta.6; Python beta.7 remains on beta.5. Follow the [3.2 beta program](/docs/reference/3-2-beta). |
...
| Version | Released | Notes |
|---|---|---|
| **3.2.0-beta.6** | 2026-08-23 | Current prerelease and TypeScript SDK-backed checkpoint. `@adcp/sdk@14.0.0-beta.8` embeds this exact bundle. Adds reporting negotiation and breakdown contracts, CTV experience profiles, premium display canonicals, and A2A request-signing method names. Use `"3.2-beta.6"` only when both peers explicitly advertise it. |
