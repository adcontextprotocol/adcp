...
|---|---|---|---|
| **Beta** | 3.2 (current prerelease: `beta.7`) | `"3.2-beta.7"` | Development and staging only. Beta.7 is the current protocol checkpoint; TypeScript SDK beta.8 remains on beta.6 and Python beta.7 remains on beta.5 pending refreshes. Follow the [3.2 beta program](/docs/reference/3-2-beta). |
