...
|---|---|---|---|
| **Beta** | 3.2 (current prerelease: `beta.8`) | `"3.2-beta.8"` | Development and staging only. Beta.8 is the current protocol checkpoint; TypeScript SDK beta.12 remains on beta.6 and Python beta.7 remains on beta.5 pending refreshes. Follow the [3.2 beta program](/docs/reference/3-2-beta). |
...
| Implementing or testing 3.2 without an SDK | Use the signed **3.2 beta.8** artifacts with raw-wire or code-generation workflows. Follow the [beta program](/docs/reference/3-2-beta). |
