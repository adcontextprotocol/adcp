...
AdCP v3 rc.1 replaces the singular `optimization_goal` object with an `optimization_goals` array. Each goal is a discriminated union on `kind`, supporting multi-goal packages with priority ordering.
...
**Related:** [Channels](/docs/reference/migration/channels) | [Pricing](/docs/reference/migration/pricing) | [Signals](/docs/reference/migration/signals) | [AdCP v3 overview](/docs/reference/whats-new-in-v3)
