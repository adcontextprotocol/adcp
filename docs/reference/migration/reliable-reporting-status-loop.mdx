...
6. Use `content_mismatch` only for contract facts the accepted configuration
   ...
   counts belongs to
   [billing authority](/docs/media-buy/advanced-topics/billing-authority)
...
[Billing Authority](/docs/media-buy/advanced-topics/billing-authority). Current
...
[`reporting_core_lifecycle_probe`](/docs/building/by-layer/L3/comply-test-controller#reporting_core_lifecycle_probe)
...
[known limitations](/docs/reference/known-limitations#conformance-and-testing).
