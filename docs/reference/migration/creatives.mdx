...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/v1/core/creative-assignment.json",
...
**Related:** [Channels](/docs/reference/migration/channels) | [Pricing](/docs/reference/migration/pricing) | [Geo targeting](/docs/reference/migration/geo-targeting) | [AdCP v3 overview](/docs/reference/whats-new-in-v3)
