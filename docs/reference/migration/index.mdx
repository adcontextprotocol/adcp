...
<Info>
**Preparing for 3.2?** Start with the [3.1 to 3.2 migration guide](/docs/reference/migration/3-1-to-3-2). For the signed RC.3 artifact, exact wire pins, the SDK checkpoint pairings, and feedback guidance, read the [3.2 prerelease program](/docs/reference/3-2-beta).
</Info>
