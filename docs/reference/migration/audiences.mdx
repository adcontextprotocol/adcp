...
**Related:** [Brand identity](/docs/reference/migration/brand-identity) | [Optimization goals](/docs/reference/migration/optimization-goals) | [AdCP 3.0 overview](/docs/reference/whats-new-in-v3)
