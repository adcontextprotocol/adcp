...
description: Step-by-step guide to migrating to first-class catalogs with sync_catalogs, format-level catalog requirements, and conversion event alignment
