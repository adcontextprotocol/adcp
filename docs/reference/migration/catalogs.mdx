...
- **Discovery mode** — send an empty catalogs array to see existing synced catalogs
...
| `feed_formats` | string[] | Accepted feed formats (e.g., `google_merchant`, `linkedin_jobs`) |
