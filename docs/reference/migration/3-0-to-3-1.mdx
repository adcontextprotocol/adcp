...
For the feature narrative, start with [What's New in AdCP 3.1](/docs/reference/whats-new-in-3-1). For the full release record, see [Release Notes](/docs/reference/release-notes#version-3-1-0).
...
- [Release Notes](/docs/reference/release-notes#version-3-1-0)
