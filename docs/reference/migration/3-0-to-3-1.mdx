...
Version 3.1.22 was an emergency security exception to the normal six-week experimental-change notice process. Its published package, tag, and versioned artifacts remain immutable; the missing #7397 changelog coverage is carried forward by an independent v3.1.23 patch changeset. See the [v3.1.22 release note](/docs/reference/release-notes#version-3-1-22) for the release record.
