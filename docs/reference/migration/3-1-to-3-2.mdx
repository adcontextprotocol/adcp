...
`@adcp/sdk@14.0.0-beta.11` embeds beta.6; Python `adcp==8.0.0b7` remains on
...
| 8 | Compliance operators | Test beta.6 from its signed assets or pair `@adcp/sdk@14.0.0-beta.11` with exact beta.6; pair Python `adcp==8.0.0b7` with exact beta.5; require an explicit beta.6 support statement before using any other SDK with the new checkpoint. |
