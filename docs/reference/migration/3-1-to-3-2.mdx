...
| SDK maintainer | Signed beta.11 bundle ingestion, generated-type/validator tests, exact support matrix entry, and protocol feedback destined for the release candidate. |
| Compliance operator | Matching beta.11 assets and SDK support end to end; no 3.2 badge from a beta checkpoint. |
