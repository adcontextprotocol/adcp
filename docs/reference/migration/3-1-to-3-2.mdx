...
`@adcp/sdk@14.0.0-beta.12` embeds beta.6; Python `adcp==8.0.0b7` remains on
...
| 2 | SDK and codegen maintainers | Generate from the signed `3.2.0-beta.6` protocol tarball, not `main` or `/schemas/latest/`. |
...
| 8 | Compliance operators | Test beta.6 from its signed assets or pair `@adcp/sdk@14.0.0-beta.12` with exact beta.6; pair Python `adcp==8.0.0b7` with exact beta.5; require an explicit beta.6 support statement before using any other SDK with the new checkpoint. |
