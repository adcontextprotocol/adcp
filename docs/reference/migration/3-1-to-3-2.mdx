...
`@adcp/sdk@14.0.0-beta.29` embeds beta.11 exactly; Python `adcp==8.0.0b11`
carries beta.10. Python higher-level helpers remain partial, and Go exact
...
| 8 | Compliance operators | Test beta.11 from its signed assets or pair `@adcp/sdk@14.0.0-beta.29` with exact beta.11; Python `adcp==8.0.0b11` remains paired with beta.10. Retain the exact package and wire versions. |
