...
<Card title="Brand identity" icon="arrow-right" href="/docs/brand-protocol/brand-json">
  Full reference for brand.json variants, the brand registry, and BrandRef resolution.
</Card>

---

**Related:** [Channels](/docs/reference/migration/channels) | [Catalogs](/docs/reference/migration/catalogs) | [Brand Protocol](/docs/brand-protocol) | [AdCP 3.0 overview](/docs/reference/whats-new-in-v3)
