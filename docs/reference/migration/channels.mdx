...
See the [Media Channel Taxonomy](/docs/reference/media-channel-taxonomy) for full definitions and design rationale.

---

**Related:** [Pricing](/docs/reference/migration/pricing) | [Geo targeting](/docs/reference/migration/geo-targeting) | [Creatives](/docs/reference/migration/creatives) | [Catalogs](/docs/reference/migration/catalogs) | [Attribution](/docs/reference/migration/attribution) | [AdCP v3 overview](/docs/reference/whats-new-in-v3)
