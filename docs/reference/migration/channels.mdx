...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/v1/protocol/get-adcp-capabilities-response.json",
  "adcp": {
    "major_versions": [3]
  },
...
**Related:** [Pricing](/docs/reference/migration/pricing) | [Geo targeting](/docs/reference/migration/geo-targeting) | [Creatives](/docs/reference/migration/creatives) | [AdCP v3 overview](/docs/reference/whats-new-in-v3)
