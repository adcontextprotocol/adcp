...
- [create_media_buy reference](/docs/media-buy/task-reference/create_media_buy) — canonical response examples
- [Media buy lifecycle](/docs/media-buy/media-buys/lifecycle) — the MediaBuyStatus state machine
- [Envelope task-status](/docs/building/implementation/task-lifecycle) — TaskStatus semantics
