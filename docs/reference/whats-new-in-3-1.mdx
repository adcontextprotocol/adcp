...
→ Spec: [Catalog change feed](https://github.com/adcontextprotocol/adcp/blob/main/specs/catalog-change-feed.md) · [`get_products` § Catalog versioning](/docs/media-buy/task-reference/get_products#catalog-versioning) · [`get_products` § Cache layering](/docs/media-buy/task-reference/get_products#cache-layering) · [`get_signals` § Wholesale enumeration](/docs/signals/tasks/get_signals#wholesale-catalog-enumeration) · PRs [#4761](https://github.com/adcontextprotocol/adcp/pull/4761) (conditional fetch), [#4762](https://github.com/adcontextprotocol/adcp/pull/4762) (wholesale signals), [#4763](https://github.com/adcontextprotocol/adcp/pull/4763) (change feed), [#4767](https://github.com/adcontextprotocol/adcp/pull/4767) (cluster implementation)
