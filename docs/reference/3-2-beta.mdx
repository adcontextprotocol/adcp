...
The 3.2 beta cycle started with a protocol-first checkpoint. Beta.10 is the
current protocol checkpoint. TypeScript SDK `14.0.0-beta.28` and Python SDK
`8.0.0b11` consume the signed beta.10 bundle:
...
| `3.2.0-beta.10` | Current protocol checkpoint for managed reporting delivery, authenticated principals, audio VAST and DOOH support, programmed channel collections, committed collection selection, and expanded conformance coverage | SDK-backed, raw-wire, code-generation, and integration testing |
| SDK wave | `@adcp/sdk@14.0.0-beta.28` and Python `adcp==8.0.0b11` embed `3.2.0-beta.10`; Go remains pending | TypeScript and Python adopters, Go maintainers, and early integration teams |
...
| Surface | beta.0 | beta.1 | beta.2 | beta.3 | beta.4 | beta.5 | beta.6 | beta.7 | beta.8 | beta.9 | beta.10 |
|---|---|---|---|---|---|---|---|---|---|---|---|
| Protocol artifact | `3.2.0-beta.0` | `3.2.0-beta.1` | `3.2.0-beta.2` | `3.2.0-beta.3` | `3.2.0-beta.4` | `3.2.0-beta.5` | `3.2.0-beta.6` | `3.2.0-beta.7` | `3.2.0-beta.8` | `3.2.0-beta.9` | `3.2.0-beta.10` |
| Git tag | `v3.2.0-beta.0` | `v3.2.0-beta.1` | `v3.2.0-beta.2` | `v3.2.0-beta.3` | `v3.2.0-beta.4` | `v3.2.0-beta.5` | `v3.2.0-beta.6` | `v3.2.0-beta.7` | `v3.2.0-beta.8` | `v3.2.0-beta.9` | `v3.2.0-beta.10` |
| `adcp_version` wire pin | `"3.2-beta.0"` | `"3.2-beta.1"` | `"3.2-beta.2"` | `"3.2-beta.3"` | `"3.2-beta.4"` | `"3.2-beta.5"` | `"3.2-beta.6"` | `"3.2-beta.7"` | `"3.2-beta.8"` | `"3.2-beta.9"` | `"3.2-beta.10"` |
| Documentation selector | `3.2-beta` | `3.2-beta` | `3.2-beta` | `3.2-beta` | `3.2-beta` | `3.2-beta` | `3.2-beta` | `3.2-beta` | `3.2-beta` | `3.2-beta` | `3.2-beta` |
...
The TypeScript SDK has exact beta.10 support. The npm
`latest` tag remains on SDK 13, so opt into the preview explicitly:

```bash
npm install @adcp/sdk@14.0.0-beta.28
```

SDK 14 includes typed caller and server support for the compact media-buy
lifecycle, the beta.10 schemas and compliance assets, version-aware request
...
Download the signed beta.10 protocol bundle rather
than copying schemas from `main` or from the moving `/schemas/latest/` path:

```bash
curl -fLO https://adcontextprotocol.org/protocol/3.2.0-beta.10.tgz
curl -fLO https://adcontextprotocol.org/protocol/3.2.0-beta.10.tgz.sha256
shasum -a 256 -c 3.2.0-beta.10.tgz.sha256
tar -xzf 3.2.0-beta.10.tgz
```

The extracted `adcp-3.2.0-beta.10/` directory contains:
...
4. Exercise raw MCP or A2A calls with `adcp_version: "3.2-beta.10"` against a
...
<Note>
**No 3.2 verification badge is currently issued for beta.10.** Treat it as an
...
The TypeScript and Python rows name exact beta.10 support with different
...
## Current beta.10 checkpoint

Protocol beta.1 through beta.10 are published. TypeScript SDK beta.28 and Python
SDK beta.11 embed the exact beta.10 bundle. Before treating a test result as
beta.10 protocol evidence, confirm that:

- the test uses the signed beta.10 artifact directly;
- both peers advertise `"3.2-beta.10"` before calls use that pin;
- the integration scenarios below run against beta.10 and retain the exact
  bundle version;
