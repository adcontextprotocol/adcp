...
| SDK wave | `@adcp/sdk@14.0.0-beta.11` embeds `3.2.0-beta.6`; Python `adcp==8.0.0b7` remains on `3.2.0-beta.5`; Go remains pending | TypeScript and Python adopters, Go maintainers, and early integration teams |
...
```bash
npm install @adcp/sdk@14.0.0-beta.11
```
