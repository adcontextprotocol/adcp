...
| SDK wave | `@adcp/sdk@14.0.0-beta.12` embeds `3.2.0-beta.6`; Python `adcp==8.0.0b7` remains on `3.2.0-beta.5`; Go remains pending | TypeScript and Python adopters, Go maintainers, and early integration teams |

Earlier betas remain useful as pinned implementation checkpoints. For
SDK-backed TypeScript testing, pair SDK beta.12 with protocol beta.6. Python
...
```bash
npm install @adcp/sdk@14.0.0-beta.12
```
...
support yet. TypeScript SDK beta.12 embeds the exact beta.6 bundle, while Python
