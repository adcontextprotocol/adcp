...
**A:** **Audience Expression Exchange (AXE)** - a protocol for buyers to bring their own audience segments to publisher inventory. Mentioned in context of "buyers apply their own targeting through AXE" for standard catalog requests.
