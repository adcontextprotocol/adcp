...
transitions, `expected_at` derivation from `schedule.delivery_sla`, the fixed
RFC 8785/JCS revision-binding digest, the flat pagination union with a pinned
`ledger_snapshot_id` and a gapless `changes_checkpoint`, the five health states
and their issue invariants, and the coverage aggregation rules.
...
[the implementation guide](/docs/media-buy/reporting-core-implementation-guide)
...
See [Implementing reporting.core](/docs/media-buy/reporting-core-implementation-guide)
