...
agent implements this flow. Negotiate `adcp_version: "3.2-beta.12"` or later
on every lab request; the agent's default 3.0 surface does not expose the
experimental reporting contract. The
