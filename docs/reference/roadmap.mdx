...
description: "AdCP protocol roadmap: planned features, upcoming schema changes, and development milestones for the Ad Context Protocol specification."
"og:title": "AdCP — Product Roadmap"
---
...
**Current Status:** rc.3 released | [View Release Notes](./release-notes#version-300-rc3)

Version 3.0 is a major evolution of the protocol. Three beta releases and three release candidates have shipped:
...
- **rc.2** - Brand rights licensing, visual guidelines for generative creative, collections and installments, AI media channel, property governance integration, account model simplification
- **rc.3** - Trusted Match Protocol (TMP), order lifecycle management, governance simplification, seller-assigned IDs, proposal lifecycle, audience bias governance, streaming/audio delivery metrics, availability forecasts, advertiser industry taxonomy

rc.3 focused on real-time execution (TMP), order management maturity, and governance simplification based on implementer feedback.
...
For the versioning model, schema change rules, release cadence, and governance structure, see [Versioning & Governance](/docs/reference/versioning).
