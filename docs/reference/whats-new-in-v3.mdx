---
title: AdCP 3.0
description: "Overview of AdCP 3.0: new capabilities, breaking changes, and migration guides"
---
...
<Warning>
**`adcp-extension.json` is removed.** If your v2 integration reads capability data from the agent card extension file, switch to calling `get_adcp_capabilities` at runtime. The agent card extension is no longer published.
</Warning>
