...
- **[Proposals](/docs/media-buy/product-discovery/media-products#proposals)** — Structured media plans with conversational refinement and direct execution
...
- **[Governance Protocol](/docs/governance)** — Property lists and content standards for enterprise brand safety
