...
<Warning>
**This is the most significant breaking change in v3.** All code that reads or writes channel values must be updated.
</Warning>
...
- [ ] Explore Governance Protocol for brand safety
- [ ] Consider Sponsored Intelligence for conversational experiences

### Testing

- [ ] Validate all requests against v3 schemas
- [ ] Test channel values in product discovery
- [ ] Verify geo targeting with named systems
- [ ] Test creative assignment weighting
