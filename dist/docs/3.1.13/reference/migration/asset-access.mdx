...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.1.13/content-standards/artifact.json",
...
- [Content artifacts](/dist/docs/3.1.13/governance/content-standards/artifacts#secured-asset-access)
- [AdCP versioning and deprecation policy](/dist/docs/3.1.13/reference/versioning#deprecation-policy)
