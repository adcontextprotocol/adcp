...
**Request schema:** [`/schemas/3.0.26/media-buy/accept-proposal-request.json`](https://adcontextprotocol.org/schemas/3.0.26/media-buy/accept-proposal-request.json)
