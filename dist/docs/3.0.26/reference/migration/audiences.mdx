...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.0.26/core/audience-member.json",
...
**Related:** [Brand identity](/dist/docs/3.0.26/reference/migration/brand-identity) | [Optimization goals](/dist/docs/3.0.26/reference/migration/optimization-goals) | [AdCP 3.0 overview](/dist/docs/3.0.26/reference/whats-new-in-v3)
