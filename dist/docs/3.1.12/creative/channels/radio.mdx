...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.1.12/core/product-format-declaration.json",
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.1.12/core/creative-manifest.json",
  "format_kind": "audio_hosted",
  "format_option_ref": {
    "scope": "product",
    "format_option_id": "broadcast_radio_30s"
...
See [Audio](/dist/docs/3.1.12/creative/channels/audio), [Broadcast](/dist/docs/3.1.12/creative/channels/broadcast), and [Creative manifests](/dist/docs/3.1.12/creative/creative-manifests).
