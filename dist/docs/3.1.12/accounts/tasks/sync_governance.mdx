...
**Request Schema**: [`/schemas/3.1.12/account/sync-governance-request.json`](https://adcontextprotocol.org/schemas/3.1.12/account/sync-governance-request.json)
**Response Schema**: [`/schemas/3.1.12/account/sync-governance-response.json`](https://adcontextprotocol.org/schemas/3.1.12/account/sync-governance-response.json)
...
|-------|------|----------|-------------|
| `account` | object | Yes | [Account reference](/dist/docs/3.1.12/building/by-layer/L2/accounts-and-agents#account-references): `{account_id}` for account-id namespaces or `{brand, operator}` for buyer-declared accounts. |
...
```json Request
{
  "$schema": "https://adcontextprotocol.org/schemas/3.1.12/account/sync-governance-request.json",
...
- [list_accounts](/dist/docs/3.1.12/accounts/tasks/list_accounts) — Discover accounts and their current governance agents
- [sync_accounts](/dist/docs/3.1.12/accounts/tasks/sync_accounts) — Provision or link advertiser accounts
- [check_governance](/dist/docs/3.1.12/governance/campaign/tasks/check_governance) — How sellers call governance agents during media buy events
- [Accounts and agents](/dist/docs/3.1.12/building/by-layer/L2/accounts-and-agents) — Account models, billing, and trust
