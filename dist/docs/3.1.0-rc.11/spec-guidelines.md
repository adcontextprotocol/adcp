...
All enums should live in `/schemas/3.1.0-rc.11/enums/` with descriptive names:
...
1. **Create v2 directory**: `/schemas/3.1.0-rc.11/`
...
1. Check existing patterns in `/schemas/3.1.0-rc.11/`
