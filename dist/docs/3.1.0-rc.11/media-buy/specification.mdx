...
**Schema**: [`enums/creative-approval-status.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/enums/creative-approval-status.json)
...
**Schema**: [`media-buy/get-products-request.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/get-products-request.json) / [`media-buy/get-products-response.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/get-products-response.json)

**Reference**: [`get_products` task](/dist/docs/3.1.0-rc.11/media-buy/task-reference/get_products)
...
**Schema**: [`media-buy/list-creative-formats-request.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/list-creative-formats-request.json) / [`media-buy/list-creative-formats-response.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/list-creative-formats-response.json)

**Reference**: [`list_creative_formats` task](/dist/docs/3.1.0-rc.11/creative/task-reference/list_creative_formats)
...
**Schema**: [`media-buy/create-media-buy-request.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/create-media-buy-request.json) / [`media-buy/create-media-buy-response.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/create-media-buy-response.json)

**Reference**: [`create_media_buy` task](/dist/docs/3.1.0-rc.11/media-buy/task-reference/create_media_buy)
...
**Schema**: [`media-buy/update-media-buy-request.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/update-media-buy-request.json) / [`media-buy/update-media-buy-response.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/update-media-buy-response.json)

**Reference**: [`update_media_buy` task](/dist/docs/3.1.0-rc.11/media-buy/task-reference/update_media_buy)
...
**Schema**: [`media-buy/sync-catalogs-request.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/sync-catalogs-request.json) / [`media-buy/sync-catalogs-response.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/sync-catalogs-response.json)

**Reference**: [`sync_catalogs` task](/dist/docs/3.1.0-rc.11/media-buy/task-reference/sync_catalogs)
...
<Note>
`list_creatives` is defined in the [Creative Protocol](/dist/docs/3.1.0-rc.11/creative/specification#list_creatives). Sales agents that host creative libraries MAY implement `list_creatives` as part of the Creative Protocol. See the [`list_creatives` task reference](/dist/docs/3.1.0-rc.11/creative/task-reference/list_creatives).
</Note>

### sync_creatives

<Note>
`sync_creatives` is defined in the [Creative Protocol](/dist/docs/3.1.0-rc.11/creative/specification#sync_creatives). Any agent that advertises `creative.has_creative_library: true` implements `sync_creatives` as part of the Creative Protocol. See the [`sync_creatives` task reference](/dist/docs/3.1.0-rc.11/creative/task-reference/sync_creatives).
</Note>

### get_media_buys

**Schema**: [`media-buy/get-media-buys-request.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/get-media-buys-request.json) / [`media-buy/get-media-buys-response.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/get-media-buys-response.json)

**Reference**: [`get_media_buys` task](/dist/docs/3.1.0-rc.11/media-buy/task-reference/get_media_buys)
...
**Schema**: [`media-buy/get-media-buy-delivery-request.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/get-media-buy-delivery-request.json) / [`media-buy/get-media-buy-delivery-response.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/get-media-buy-delivery-response.json)

**Reference**: [`get_media_buy_delivery` task](/dist/docs/3.1.0-rc.11/media-buy/task-reference/get_media_buy_delivery)
...
**Schema**: [`media-buy/provide-performance-feedback-request.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/provide-performance-feedback-request.json) / [`media-buy/provide-performance-feedback-response.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/provide-performance-feedback-response.json)

**Reference**: [`provide_performance_feedback` task](/dist/docs/3.1.0-rc.11/media-buy/task-reference/provide_performance_feedback)
...
**Schema**: [`media-buy/sync-event-sources-request.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/sync-event-sources-request.json) / [`media-buy/sync-event-sources-response.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/sync-event-sources-response.json)

**Reference**: [`sync_event_sources` task](/dist/docs/3.1.0-rc.11/media-buy/task-reference/sync_event_sources)
...
**Schema**: [`media-buy/log-event-request.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/log-event-request.json) / [`media-buy/log-event-response.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/log-event-response.json)

**Reference**: [`log_event` task](/dist/docs/3.1.0-rc.11/media-buy/task-reference/log_event)
...
**Schema**: [`media-buy/sync-audiences-request.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/sync-audiences-request.json) / [`media-buy/sync-audiences-response.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/sync-audiences-response.json)

**Reference**: [`sync_audiences` task](/dist/docs/3.1.0-rc.11/media-buy/task-reference/sync_audiences)
...
- Sales agents MUST accept SHA-256 hashed identifiers and MUST reject cleartext email/phone in `hashed_email`/`hashed_phone` fields (PII minimization at the transport boundary; see [Privacy Considerations](/dist/docs/3.1.0-rc.11/reference/privacy-considerations#unsalted-hashed-identifiers-are-pseudonymous-not-anonymous) for the retention/consent obligations that hashing does not satisfy)

## Error Handling

Sales agents MUST return errors using the [standard AdCP error schema](/dist/docs/3.1.0-rc.11/building/by-layer/L3/error-handling).
...
See [Required tasks by protocol](/dist/docs/3.1.0-rc.11/protocol/required-tasks) for a consolidated view of required and optional tasks across all AdCP protocols.
...
| Schema | Description |
|--------|-------------|
| [`media-buy/get-products-request.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/get-products-request.json) | get_products request |
| [`media-buy/get-products-response.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/get-products-response.json) | get_products response |
| [`media-buy/create-media-buy-request.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/create-media-buy-request.json) | create_media_buy request |
| [`media-buy/create-media-buy-response.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/create-media-buy-response.json) | create_media_buy response |
| [`media-buy/update-media-buy-request.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/update-media-buy-request.json) | update_media_buy request |
| [`media-buy/update-media-buy-response.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/update-media-buy-response.json) | update_media_buy response |
| [`media-buy/list-creative-formats-request.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/list-creative-formats-request.json) | list_creative_formats request |
| [`media-buy/list-creative-formats-response.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/list-creative-formats-response.json) | list_creative_formats response |
| [`creative/list-creatives-request.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/creative/list-creatives-request.json) | list_creatives request (Creative Protocol) |
| [`creative/list-creatives-response.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/creative/list-creatives-response.json) | list_creatives response (Creative Protocol) |
| [`creative/sync-creatives-request.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/creative/sync-creatives-request.json) | sync_creatives request (Creative Protocol) |
| [`creative/sync-creatives-response.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/creative/sync-creatives-response.json) | sync_creatives response (Creative Protocol) |
| [`media-buy/get-media-buy-delivery-request.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/get-media-buy-delivery-request.json) | get_media_buy_delivery request |
| [`media-buy/get-media-buy-delivery-response.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/get-media-buy-delivery-response.json) | get_media_buy_delivery response |
| [`media-buy/provide-performance-feedback-request.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/provide-performance-feedback-request.json) | provide_performance_feedback request |
| [`media-buy/provide-performance-feedback-response.json`](https://adcontextprotocol.org/schemas/3.1.0-rc.11/media-buy/provide-performance-feedback-response.json) | provide_performance_feedback response |
