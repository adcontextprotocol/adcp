...
For basic usage, see [preview_creative](/dist/docs/3.2.0-beta.10/creative/task-reference/preview_creative).
...
Preview URLs are review resources, not just transport conveniences. A buyer, browser, or MCPUI host may fetch a `preview_url` after the original [`preview_creative`](/dist/docs/3.2.0-beta.10/creative/task-reference/preview_creative) call returns, after a pod restart, or from a different pod than the one that created the render.
...
- [preview_creative](/dist/docs/3.2.0-beta.10/creative/task-reference/preview_creative) - Basic usage and parameters
- [Creative Manifests](/dist/docs/3.2.0-beta.10/creative/creative-manifests) - Manifest structure
- [Universal Macros](/dist/docs/3.2.0-beta.10/creative/universal-macros) - Available macro values
