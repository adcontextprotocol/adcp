...
- [Canonical formats](/dist/docs/3.2.0-beta.10/creative/canonical-formats)
- [Asset types](/dist/docs/3.2.0-beta.10/creative/asset-types)
- [Creative representation sets](/dist/docs/3.2.0-beta.10/creative/representation-sets)
- [`build_creative`](/dist/docs/3.2.0-beta.10/creative/task-reference/build_creative)
- [`sync_creatives`](/dist/docs/3.2.0-beta.10/creative/task-reference/sync_creatives)
