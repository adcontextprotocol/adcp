...
5. Normalize tracker defaults, bind one exact VAST/DAAST execution version, and match every first-class tracker against the destination's [tracker execution contract](/dist/docs/3.2.0-beta.10/creative/tracker-execution-contracts).
...
- [Display ads](/dist/docs/3.2.0-beta.10/creative/channels/display)
- [Video ads](/dist/docs/3.2.0-beta.10/creative/channels/video)
- [Universal macros](/dist/docs/3.2.0-beta.10/creative/universal-macros)
- [Creative manifests](/dist/docs/3.2.0-beta.10/creative/creative-manifests)
