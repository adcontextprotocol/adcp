...
For the feature narrative, start with [What's New in AdCP 3.1](/dist/docs/3.2.0-beta.10/reference/whats-new-in-3-1). For the full release record, see [Release Notes](/dist/docs/3.2.0-beta.10/reference/release-notes#version-3-1-0).
...
|---|---|
| SDK buyer | Upgrade to an SDK that emits `adcp_version`, pins `"3.1"` when the seller supports it, adds idempotency keys consistently, and accepts open error codes. |
...
- [What's New in AdCP 3.1](/dist/docs/3.2.0-beta.10/reference/whats-new-in-3-1)
- [Release Notes](/dist/docs/3.2.0-beta.10/reference/release-notes#version-3-1-0)
- [Versions & Compatibility](/dist/docs/3.2.0-beta.10/reference/versions)
- [Versioning & Governance](/dist/docs/3.2.0-beta.10/reference/versioning)
- [Version Adaptation](/dist/docs/3.2.0-beta.10/building/cross-cutting/version-adaptation)
