...
The `{AXEM}` macro is from the legacy AXE integration. In [TMP](/dist/docs/3.0.14/trusted-match), this is replaced by:
- **Structured creative assets** move to the `creative_manifest` field on the [Offer](/dist/docs/3.0.14/trusted-match/specification#offer).
...
- [Creative Protocol](/dist/docs/3.0.14/creative) - How creatives work in AdCP
- [sync_creatives](/dist/docs/3.0.14/creative/task-reference/sync_creatives) - Creative management API