...
- AAO's founder's other company (Scope3) contributed funding and foundational IP — see the [FAQ entry](/dist/docs/3.0.14/faq#how-is-aao-related-to-scope3) for the full relationship.
