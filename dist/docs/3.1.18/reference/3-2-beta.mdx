...
See [Choose your SDK](/dist/docs/3.1.18/building/by-layer/L4/choose-your-sdk) for the support
matrix and install guidance.

## Use the beta.3 artifact directly

Download the signed beta.3 protocol bundle rather
than copying schemas from `main` or from the moving `/schemas/3.1.18/` path:
...
[Verifying protocol tarballs](/dist/docs/3.1.18/reference/verifying-protocol-tarballs) for
...
The SDK compatibility matrix lives in [Choose your SDK](/dist/docs/3.1.18/building/by-layer/L4/choose-your-sdk).
...
- Experimental surfaces retain their [experimental-status contract](/dist/docs/3.1.18/reference/experimental-status).
...
- [What's New in AdCP 3.2](/dist/docs/3.1.18/reference/whats-new-in-3-2)
- [Migrating from 3.1 to 3.2](/dist/docs/3.1.18/reference/migration/3-1-to-3-2)
- [Release Notes](/dist/docs/3.1.18/reference/release-notes#version-3-2-0)
- [Versions & Compatibility](/dist/docs/3.1.18/reference/versions)
- [Choose your SDK](/dist/docs/3.1.18/building/by-layer/L4/choose-your-sdk)
