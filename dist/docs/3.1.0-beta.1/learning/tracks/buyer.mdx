...
<CardGroup cols={2}>
  ...
  <Card title="Orchestrator design" icon="diagram-project" href="/dist/docs/3.1.0-beta.1/building/implementation/orchestrator-design">
  ...
  <Card title="Error handling" icon="triangle-exclamation" href="/dist/docs/3.1.0-beta.1/building/implementation/error-handling">
...
Create a working buyer agent that discovers products and executes media buys. Use any AI coding assistant (Claude Code, Cursor, Copilot) with the [`@adcp/sdk`](/dist/docs/3.1.0-beta.1/building/schemas-and-sdks) SDK. The skill tested is orchestrating a buying workflow correctly.
...
See [Validate Your Agent](/dist/docs/3.1.0-beta.1/building/validate-your-agent) for CLI setup and the full testing workflow.
...
Review the [Compliance Catalog](/dist/docs/3.1.0-beta.1/building/compliance-catalog) and note which specialisms your target sellers claim — that's your test matrix.
