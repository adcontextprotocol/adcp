...
**Reference**: [Media Buy Specification](/dist/docs/3.1.0-beta.1/media-buy/specification) · [Seller integration guide](/dist/docs/3.1.0-beta.1/building/operating/seller-integration)
