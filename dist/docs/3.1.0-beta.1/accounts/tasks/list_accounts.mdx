...
| `account_scope` | How the seller scoped this account: `operator`, `brand`, `operator_brand`, or `agent`. See [account scope](/dist/docs/3.1.0-beta.1/building/by-layer/L2/accounts-and-agents#account-scope). |
