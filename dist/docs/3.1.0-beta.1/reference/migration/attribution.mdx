...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.1.0-beta.1/core/attribution-window.json",
  "post_click": {
    "interval": 7,
    "unit": "days"
  },
