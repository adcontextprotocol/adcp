...
| `context` | object | No | Opaque correlation data echoed unchanged in the response (see [application context](/dist/docs/3.1.0-beta.1/building/integration/context-sessions#application-context-context)) |
