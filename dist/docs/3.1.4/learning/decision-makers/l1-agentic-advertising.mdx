...
<Note>
Want the hands-on version? Foundations module [A1](/dist/docs/3.1.4/learning/foundations/a1-agentic-advertising) teaches the same paradigm by having you query a live agent and read its response. This track assesses you on reasoning instead — same idea, no building.
</Note>
