...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.0.23/content-standards/artifact.json",
...
- [Content artifacts](/dist/docs/3.0.23/governance/content-standards/artifacts#secured-asset-access)
- [AdCP versioning and deprecation policy](/dist/docs/3.0.23/reference/versioning#deprecation-policy)
