...
- **Verified** — AAO has tested the agent recently against those storyboards and issued a signed attestation ([AAO Verified badge](/dist/docs/3.0.23/building/verification/compliance-catalog)). Gated on active membership and a live heartbeat.
