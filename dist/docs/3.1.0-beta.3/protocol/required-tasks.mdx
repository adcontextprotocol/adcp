...
**Reference**: [Media Buy Specification](/dist/docs/3.1.0-beta.3/media-buy/specification) · [Seller integration guide](/dist/docs/3.1.0-beta.3/building/operating/seller-integration)
