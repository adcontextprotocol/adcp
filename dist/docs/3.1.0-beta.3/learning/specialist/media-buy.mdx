...
See the [Compliance Catalog](/dist/docs/3.1.0-beta.3/building/compliance-catalog) for the full taxonomy and the [`specialism` enum](https://adcontextprotocol.org/schemas/3.1.0-beta.3/enums/specialism.json) for the authoritative list.
