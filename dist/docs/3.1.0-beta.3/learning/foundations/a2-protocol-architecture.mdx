...
<CardGroup cols={2}>
  ...
  <Card title="A2A guide" icon="arrows-left-right" href="/dist/docs/3.1.0-beta.3/building/integration/a2a-guide">
    The Agent-to-Agent protocol — how specialized agents collaborate on complex campaigns.
  </Card>
  <Card title="Task lifecycle" icon="circle-nodes" href="/dist/docs/3.1.0-beta.3/building/implementation/task-lifecycle">
...
| **Specialism** | A narrow capability claim within a domain — e.g. `sales-guaranteed`, `creative-generative`, `signal-marketplace`. Declared via `specialisms`. See the [Compliance Catalog](/dist/docs/3.1.0-beta.3/building/compliance-catalog). |
