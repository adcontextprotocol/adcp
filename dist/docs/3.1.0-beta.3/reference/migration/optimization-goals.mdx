...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.1.0-beta.3/core/optimization-goal.json",
  "kind": "metric",
  "metric": "clicks",
  "target": {
    "kind": "cost_per",
...
**Related:** [Channels](/dist/docs/3.1.0-beta.3/reference/migration/channels) | [Pricing](/dist/docs/3.1.0-beta.3/reference/migration/pricing) | [Signals](/dist/docs/3.1.0-beta.3/reference/migration/signals) | [AdCP 3.0 overview](/dist/docs/3.1.0-beta.3/reference/whats-new-in-v3)
