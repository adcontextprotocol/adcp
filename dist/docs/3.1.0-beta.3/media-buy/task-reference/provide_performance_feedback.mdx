...
description: "provide_performance_feedback task — share normalized performance scores with AdCP publishers so sellers can optimize delivery based on buyer-observed outcomes."
...
**Request Schema**: [`https://adcontextprotocol.org/schemas/3.1.0-beta.3/media-buy/provide-performance-feedback-request.json`](https://adcontextprotocol.org/schemas/3.1.0-beta.3/media-buy/provide-performance-feedback-request.json)
**Response Schema**: [`https://adcontextprotocol.org/schemas/3.1.0-beta.3/media-buy/provide-performance-feedback-response.json`](https://adcontextprotocol.org/schemas/3.1.0-beta.3/media-buy/provide-performance-feedback-response.json)

## Request Parameters

| Parameter | Type | Required | Description |
|-----------|------|----------|-------------|
| `media_buy_id` | string | Yes | Seller's media buy identifier |
...
```json
{
  "$schema": "/schemas/3.1.0-beta.3/3.1.0-beta.3/media-buy/provide-performance-feedback-request.json",
...
```json
{
  "$schema": "/schemas/3.1.0-beta.3/3.1.0-beta.3/media-buy/provide-performance-feedback-response.json",
  "status": "completed",
  "success": true,
...
- [`get_media_buy_delivery`](/dist/docs/3.1.0-beta.3/media-buy/task-reference/get_media_buy_delivery) - Retrieve delivery metrics
- [Optimization & Reporting](/dist/docs/3.1.0-beta.3/media-buy/media-buys/optimization-reporting) - Performance feedback concepts
- [Targeting](/dist/docs/3.1.0-beta.3/media-buy/advanced-topics/targeting) - Understanding targeting for optimization