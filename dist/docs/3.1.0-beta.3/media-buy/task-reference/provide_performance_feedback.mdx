...
```json
{
  "$schema": "/schemas/3.1.0-beta.3/media-buy/provide-performance-feedback-request.json",
...
```json
{
  "$schema": "/schemas/3.1.0-beta.3/media-buy/provide-performance-feedback-response.json",
  "status": "completed",
  "success": true,
