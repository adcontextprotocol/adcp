...
```json
{
  "$schema": "/schemas/3.1.0-beta.3/media-buy/get-products-request.json",
  "buying_mode": "wholesale",
...
```json
{
  "$schema": "/schemas/3.1.0-beta.3/media-buy/get-products-response.json",
  "status": "completed",
...
See [Authentication Guide](/dist/docs/3.1.0-beta.3/building/integration/authentication) for details.
