...
- Signal agents MUST return `REFERENCE_NOT_FOUND` for unauthorized accounts — the
  ...
  [error-handling.mdx](/dist/docs/3.1.0-beta.3/building/by-layer/L3/error-handling) for the full
...
Signal agents MUST return errors using the [standard AdCP error schema](/dist/docs/3.1.0-beta.3/building/by-layer/L3/error-handling).

Signal agents MUST use Signals Protocol error codes as defined in the [Error Handling Reference](/dist/docs/3.1.0-beta.3/building/by-layer/L3/error-handling).
