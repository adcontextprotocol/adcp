...
```json
{
  "$schema": "/schemas/3.1.0-beta.3/content-standards/create-content-standards-request.json",
...
```json
{
  "$schema": "/schemas/3.1.0-beta.3/content-standards/create-content-standards-response.json",
  "status": "completed",
