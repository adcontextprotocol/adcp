...
```json
{
  "$schema": "/schemas/3.1.0-beta.3/3.1.0-beta.3/media-buy/build-creative-request.json",
...
```json
{
  "$schema": "/schemas/3.1.0-beta.3/3.1.0-beta.3/media-buy/build-creative-response.json",
  "status": "completed",
  "creative_manifest": {
    "format_id": {
      "agent_url": "https://creative.example.com",
...
For these cases, configure a webhook via `push_notification_config` to receive the result. See [Async Operations](/dist/docs/3.1.0-beta.3/building/by-layer/L3/async-operations) and [Push Notifications](/dist/docs/3.1.0-beta.3/building/by-layer/L3/webhooks).
