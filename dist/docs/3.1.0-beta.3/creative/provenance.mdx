...
```json
{
  "$schema": "/schemas/3.1.0-beta.3/core/provenance.json",
...
```json
{
  "$schema": "/schemas/3.1.0-beta.3/core/creative-manifest.json",
  "format_id": {
...
```json
{
  "$schema": "/schemas/3.1.0-beta.3/content-standards/artifact.json",
...
```json
{
  "$schema": "/schemas/3.1.0-beta.3/core/creative-policy.json",
