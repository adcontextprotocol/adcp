...
You can run any storyboard in the [Compliance Catalog](/dist/docs/3.1.0-beta.3/building/compliance-catalog) this way — sales, creative, signals, governance, signed requests, etc. Ask Addie what's available if you're not sure: *"What conformance storyboards apply to a sales agent?"*
...
- [Compliance Catalog](/dist/docs/3.1.0-beta.3/building/compliance-catalog) — full list of available storyboards
- [Get Test-Ready](/dist/docs/3.1.0-beta.3/building/get-test-ready) — what your agent needs in place before any storyboard can pass
