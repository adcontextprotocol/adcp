...
| `account_scope` | How the seller scoped this account: `operator`, `brand`, `operator_brand`, or `agent`. See [account scope](/dist/docs/3.1.0-beta.3/building/integration/accounts-and-agents#account-scope). |
