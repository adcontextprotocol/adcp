...
|-------|------|----------|-------------|
| `account` | [AccountRef](/dist/docs/3.1.0-beta.3/building/integration/accounts-and-agents#account-references) | Yes | Account for this record — by `account_id` or `{ brand, operator }`. |
...
- [Accounts and agents](/dist/docs/3.1.0-beta.3/building/integration/accounts-and-agents) — Billing hierarchy and operator model
