...
|--------|---------|-----------|
| `active` | Ready to use | Use [account reference](/dist/docs/3.1.0-beta.3/building/by-layer/L2/accounts-and-agents#account-references) in protocol operations |
...
- [Accounts and agents](/dist/docs/3.1.0-beta.3/building/by-layer/L2/accounts-and-agents) -- Billing models, trust models, and authorized operators
