...
|-------|------|----------|-------------|
| `account` | object | Yes | [Account reference](/dist/docs/3.1.0-beta.3/building/by-layer/L2/accounts-and-agents#account-references): `{account_id}` for explicit accounts or `{brand, operator}` for implicit accounts. |
...
- [Accounts and agents](/dist/docs/3.1.0-beta.3/building/by-layer/L2/accounts-and-agents) — Account models, billing, and trust
