...
See [Canonical formats](/dist/docs/3.2.0-rc.6/creative/canonical-formats), [Creative manifests](/dist/docs/3.2.0-rc.6/creative/creative-manifests), and [Media products](/dist/docs/3.2.0-rc.6/media-buy/product-discovery/media-products).
