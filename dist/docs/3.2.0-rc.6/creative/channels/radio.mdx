...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-rc.6/core/product-format-declaration.json",
...
See [Audio](/dist/docs/3.2.0-rc.6/creative/channels/audio), [Broadcast](/dist/docs/3.2.0-rc.6/creative/channels/broadcast), and [Creative manifests](/dist/docs/3.2.0-rc.6/creative/creative-manifests).
