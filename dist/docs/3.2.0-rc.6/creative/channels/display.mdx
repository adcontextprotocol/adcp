...
See [Creative representation sets](/dist/docs/3.2.0-rc.6/creative/representation-sets), [Canonical formats](/dist/docs/3.2.0-rc.6/creative/canonical-formats), [Creative manifests](/dist/docs/3.2.0-rc.6/creative/creative-manifests), and [Universal macros](/dist/docs/3.2.0-rc.6/creative/universal-macros).
