...
- [`list_transformers`](/dist/docs/3.2.0-rc.6/creative/task-reference/list_transformers)
- [Canonical formats](/dist/docs/3.2.0-rc.6/creative/canonical-formats)
- [Multi-agent orchestration](/dist/docs/3.2.0-rc.6/creative/multi-agent-orchestration)
