...
[billing authority](/dist/docs/3.2.0-rc.6/media-buy/advanced-topics/billing-authority), not
...
seller MUST reject `consumer` with [`UNSUPPORTED_FEATURE`](/dist/docs/3.2.0-rc.6/building/verification/compliance-catalog#error-code-unsupported-feature). Tracked in
