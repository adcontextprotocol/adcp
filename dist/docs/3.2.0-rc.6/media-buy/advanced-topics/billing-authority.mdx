...
[Reliable Reporting](/dist/docs/3.2.0-rc.6/media-buy/reporting-core-implementation-guide)
...
| Field | Meaning |
|---|---|
| `vendor` (required, [BrandRef](/dist/docs/3.2.0-rc.6/brand-protocol/brand-json)) | The party whose count of the billing metric governs invoicing. Same field shape covers seller's ad server, buyer's 3PAS, or a third-party vendor — the BrandRef domain disambiguates. |
...
- [`measurement-terms`](https://adcontextprotocol.org/schemas/3.2.0-rc.6/core/measurement-terms.json) — schema
- [`get_media_buy_delivery`](/dist/docs/3.2.0-rc.6/media-buy/task-reference/get_media_buy_delivery) — seller-side finality flags
- [`report_usage`](/dist/docs/3.2.0-rc.6/accounts/tasks/report_usage) — buyer-side / third-party finality flags
- [Accountability](/dist/docs/3.2.0-rc.6/media-buy/advanced-topics/accountability) — performance standards, makegood remedies, cancellation
- [Reporting capabilities and measurement windows](/dist/docs/3.2.0-rc.6/media-buy/media-buys/optimization-reporting)
- [Reliable Reporting: implementing `reporting.core`](/dist/docs/3.2.0-rc.6/media-buy/reporting-core-implementation-guide) — the operational delivery contract for the seller-produced feed
- [`sync_reporting_status`](/dist/docs/3.2.0-rc.6/media-buy/task-reference/sync_reporting_status) — buyer-to-seller consumption status, and why it is not a dispute channel
