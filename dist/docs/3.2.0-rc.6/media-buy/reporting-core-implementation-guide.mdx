...
4. **[`get_reporting_status`](/dist/docs/3.2.0-rc.6/media-buy/task-reference/get_reporting_status)
...
[future expectations on complete summaries](/dist/docs/3.2.0-rc.6/media-buy/task-reference/get_reporting_status#future-expectation-on-a-complete-summary)
...
3. **Generate obligations.** When an account installs a delivery
   configuration through [`sync_accounts`](/dist/docs/3.2.0-rc.6/accounts/tasks/sync_accounts),
...
- **`managed_delivery: true`** adds offerings with a `method` —
  ...
  principal-layer destinations ([`sync_principal`](/dist/docs/3.2.0-rc.6/protocol/sync_principal)).
...
buy — see [Billing Authority](/dist/docs/3.2.0-rc.6/media-buy/advanced-topics/billing-authority)
