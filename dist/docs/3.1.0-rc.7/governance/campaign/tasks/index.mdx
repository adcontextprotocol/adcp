...
**Setup prerequisite:** [`sync_governance`](/dist/docs/3.1.0-rc.7/accounts/tasks/sync_governance) syncs governance agent endpoints to accounts. This must be done before sellers can call `check_governance`.
