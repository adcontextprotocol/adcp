...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.1.0-rc.7/pricing-options/vcpm-option.json",
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.1.0-rc.7/pricing-options/cpv-option.json",
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.1.0-rc.7/pricing-options/cpp-option.json",
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.1.0-rc.7/pricing-options/cpa-option.json",
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.1.0-rc.7/pricing-options/flat-rate-option.json",
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.1.0-rc.7/pricing-options/time-option.json",
...
- [Creating Media Buys](/dist/docs/3.1.0-rc.7/media-buy/task-reference/create_media_buy) - How to select pricing when buying
- [Delivery Reporting](/dist/docs/3.1.0-rc.7/media-buy/task-reference/get_media_buy_delivery) - Understanding metrics by pricing model
- [Glossary](/dist/docs/3.1.0-rc.7/reference/glossary) - Pricing and metric definitions
