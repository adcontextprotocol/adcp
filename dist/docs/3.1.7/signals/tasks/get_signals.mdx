...
**Request Schema**: [`https://adcontextprotocol.org/schemas/3.1.7/signals/get-signals-request.json`](https://adcontextprotocol.org/schemas/3.1.7/signals/get-signals-request.json)
**Response Schema**: [`https://adcontextprotocol.org/schemas/3.1.7/signals/get-signals-response.json`](https://adcontextprotocol.org/schemas/3.1.7/signals/get-signals-response.json)
...
should first call [`get_adcp_capabilities`](/dist/docs/3.1.7/protocol/get_adcp_capabilities)
...
```json
{
  "$schema": "/schemas/3.1.7/signals/get-signals-response.json",
  "status": "completed",
...
```json
{
  "$schema": "/schemas/3.1.7/signals/get-signals-request.json",
...
Signals agents declare wholesale support in [`get_adcp_capabilities`](/dist/docs/3.1.7/protocol/get_adcp_capabilities):
