...
In addition to [universal macros](/dist/docs/3.1.7/creative/universal-macros), display formats support:
...
- [Asset Types](/dist/docs/3.1.7/creative/asset-types) - Image, HTML, and JavaScript asset specifications
