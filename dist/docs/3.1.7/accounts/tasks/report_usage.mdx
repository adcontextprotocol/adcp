...
**Request Schema**: [`/schemas/3.1.7/account/report-usage-request.json`](https://adcontextprotocol.org/schemas/3.1.7/account/report-usage-request.json)
**Response Schema**: [`/schemas/3.1.7/account/report-usage-response.json`](https://adcontextprotocol.org/schemas/3.1.7/account/report-usage-response.json)
...
|-------|------|----------|-------------|
| `account` | [AccountRef](/dist/docs/3.1.7/building/by-layer/L2/accounts-and-agents#account-references) | Yes | Account for this record — by `account_id` or `{ brand, operator }`. |
...
- [sync_accounts](/dist/docs/3.1.7/accounts/tasks/sync_accounts) — Sync advertiser accounts with a seller before reporting
- [Accounts Protocol](/dist/docs/3.1.7/accounts/overview) — How account establishment and settlement fit together
- [Accounts and agents](/dist/docs/3.1.7/building/by-layer/L2/accounts-and-agents) — Billing hierarchy and operator model
