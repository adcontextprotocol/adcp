...
For the cumulative cross-layer story (what L0+L1+L2 buys you), see the [SDK stack reference](/dist/docs/3.0.19/building/cross-cutting/sdk-stack#l2--auth--registry).

## Pages in this layer

- **[Authentication](/dist/docs/3.0.19/building/by-layer/L2/authentication)** — credentials and permissions.
- **[Account state](/dist/docs/3.0.19/building/by-layer/L2/account-state)** — multi-tenant account resolution.
- **[Accounts and agents](/dist/docs/3.0.19/building/by-layer/L2/accounts-and-agents)** — relationship between account scoping and agent identity.
- **[Context & sessions](/dist/docs/3.0.19/building/by-layer/L2/context-sessions)** — managing principal state across requests.
