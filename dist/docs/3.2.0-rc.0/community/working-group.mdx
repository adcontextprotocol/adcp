...
**[→ Join the AdCP community on Slack](/dist/docs/3.2.0-rc.0/community/joining-slack)** — the guide includes the public invite and the direct-invite recovery path for restricted domains.
...
The WG's operational procedures — quorum, voting thresholds, recusal policy, and escalation path — are published in the [Working group charter](/dist/docs/3.2.0-rc.0/governance/working-group-charter).
