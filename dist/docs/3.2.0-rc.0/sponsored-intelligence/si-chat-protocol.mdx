...
- **Everyone**: Join the [community Slack](/dist/docs/3.2.0-rc.0/community/joining-slack) to discuss

---

*The Sponsored Intelligence Protocol is part of the broader [AdCP ecosystem](/dist/docs/3.2.0-rc.0/intro), enabling the next generation of AI-powered advertising.*
