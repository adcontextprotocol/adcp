...
**Request schema:** [`/schemas/3.2.0-rc.0/media-buy/accept-proposal-request.json`](https://adcontextprotocol.org/schemas/3.2.0-rc.0/media-buy/accept-proposal-request.json)
