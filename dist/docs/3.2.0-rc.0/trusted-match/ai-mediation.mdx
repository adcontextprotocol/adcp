...
<CardGroup cols={2}>
  <Card title="TMP for AI assistants" icon="robot" href="/dist/docs/3.2.0-rc.0/trusted-match/surfaces/ai-assistants">
  ...
  <Card title="TMP overview" icon="shield-halved" href="/dist/docs/3.2.0-rc.0/trusted-match">
