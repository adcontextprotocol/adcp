...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-rc.0/core/creative-assignment.json",
...
<Card title="Creative" icon="arrow-right" href="/dist/docs/3.2.0-rc.0/creative/index">
