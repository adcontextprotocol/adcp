...
- [Canonical formats specification](/dist/docs/3.2.0-rc.0/creative/canonical-formats)
...
- [Deprecated `list_creative_formats`](/dist/docs/3.2.0-rc.0/creative/task-reference/list_creative_formats)
