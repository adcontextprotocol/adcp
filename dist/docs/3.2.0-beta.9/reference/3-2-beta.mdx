...
current protocol checkpoint. No SDK release names exact beta.9 support yet: the
current TypeScript and Python SDK betas consume the signed beta.6 bundle:
...
| `3.2.0-beta.9` | Current protocol checkpoint for the draft account change feed, inventory-list receipts, inventory delivery identity, seller policy and change rights, and broader conformance coverage | Raw-wire adopters, code-generator maintainers, SDK maintainers, and agent teams validating the signed beta.9 artifact |
| SDK wave | `@adcp/sdk@14.0.0-beta.13` and Python `adcp==8.0.0b9` embed `3.2.0-beta.6`; Go remains pending | TypeScript and Python adopters, Go maintainers, and early integration teams |

Earlier betas remain useful as pinned implementation checkpoints. For
SDK-backed TypeScript testing, pair SDK beta.13 with protocol beta.6. Pair
Python beta.9 with protocol beta.6. Test beta.9 from its signed artifact with
raw-wire or code-generation workflows. Do not combine a newer wire pin with an
...
```bash
npm install @adcp/sdk@14.0.0-beta.13
```
...
See [Choose your SDK](/dist/docs/3.2.0-beta.9/building/by-layer/L4/choose-your-sdk) for the support
matrix and install guidance.

Python `adcp==8.0.0b9` carries beta.6 schemas and generated types. Its
...
than copying schemas from `main` or from the moving `/schemas/3.2.0-beta.9/` path:
...
[Verifying protocol tarballs](/dist/docs/3.2.0-beta.9/reference/verifying-protocol-tarballs) for
...
The SDK compatibility matrix lives in [Choose your SDK](/dist/docs/3.2.0-beta.9/building/by-layer/L4/choose-your-sdk).
The TypeScript and Python rows name exact beta.6 support with different
...
Protocol beta.1 through beta.9 are published. No SDK release names exact beta.9
support yet. TypeScript SDK beta.13 and Python SDK beta.9 embed the exact beta.6
bundle. Before treating a test result as beta.9 protocol evidence, confirm that:
...
- Experimental surfaces retain their [experimental-status contract](/dist/docs/3.2.0-beta.9/reference/experimental-status).
...
- [What's New in AdCP 3.2](/dist/docs/3.2.0-beta.9/reference/whats-new-in-3-2)
- [Migrating from 3.1 to 3.2](/dist/docs/3.2.0-beta.9/reference/migration/3-1-to-3-2)
- [Release Notes](/dist/docs/3.2.0-beta.9/reference/release-notes#version-3-2-0)
- [Versions & Compatibility](/dist/docs/3.2.0-beta.9/reference/versions)
- [Choose your SDK](/dist/docs/3.2.0-beta.9/building/by-layer/L4/choose-your-sdk)
