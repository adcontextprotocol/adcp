...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-beta.9/core/attribution-window.json",
  "post_click": {
    "interval": 7,
    "unit": "days"
  },
