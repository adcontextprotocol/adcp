...
`@adcp/sdk@14.0.0-beta.12`. Verify those advertised capabilities before the lab;
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-beta.9/media-buy/request-proposals-request.json",
