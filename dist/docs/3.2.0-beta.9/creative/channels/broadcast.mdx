...
See [Video](/dist/docs/3.2.0-beta.9/creative/channels/video), [Audio](/dist/docs/3.2.0-beta.9/creative/channels/audio), and [Creative manifests](/dist/docs/3.2.0-beta.9/creative/creative-manifests).
