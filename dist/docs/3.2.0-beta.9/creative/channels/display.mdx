...
See [Creative representation sets](/dist/docs/3.2.0-beta.9/creative/representation-sets), [Canonical formats](/dist/docs/3.2.0-beta.9/creative/canonical-formats), [Creative manifests](/dist/docs/3.2.0-beta.9/creative/creative-manifests), and [Universal macros](/dist/docs/3.2.0-beta.9/creative/universal-macros).
