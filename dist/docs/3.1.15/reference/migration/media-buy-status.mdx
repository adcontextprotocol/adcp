...
- [create_media_buy reference](/dist/docs/3.1.15/media-buy/task-reference/create_media_buy) — canonical response examples
- [Media buy lifecycle](/dist/docs/3.1.15/media-buy/media-buys/lifecycle) — the MediaBuyStatus state machine
- [Envelope task-status](/dist/docs/3.1.15/building/by-layer/L3/task-lifecycle) — TaskStatus semantics
