...
- [Creative Formats](/dist/docs/3.1.15/creative/formats) — full format object structure, asset types, and render specs
- [Template Format IDs](/dist/docs/3.1.15/creative/template-format-ids) — parameterized format IDs for dimension-variable templates
