...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.0.9/core/attribution-window.json",
  "post_click": {
    "interval": 7,
    "unit": "days"
  },
