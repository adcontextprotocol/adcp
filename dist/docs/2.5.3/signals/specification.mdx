...
The Signals Activation Protocol operates within the broader [AdCP Ecosystem Layers](/dist/docs/2.5.3/intro#the-adcp-ecosystem-layers), enabling signal agents to directly integrate with and activate signals on decisioning platforms (DSPs, orchestration platforms). 
...
### [get_signals](/dist/docs/2.5.3/signals/tasks/get_signals)
...
### [activate_signal](/dist/docs/2.5.3/signals/tasks/activate_signal)
...
Signal-specific error codes are documented in each task specification and the [Error Codes Reference](/dist/docs/2.5.3/building/implementation/error-handling).
