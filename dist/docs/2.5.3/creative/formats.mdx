...
For an overview of how formats, manifests, and creative agents work together, see the [Creative Protocol Overview](/dist/docs/2.5.3/creative).
...
Standard formats include common IAB ad units (300x250, 728x90), standard video specs (15s, 30s pre-roll), audio formats, DOOH, and more. See the [Creative Channel Guides](/dist/docs/2.5.3/creative/channels/video) for format documentation.

**For sales agents:** Before creating custom format definitions, check the reference creative agent to see if your formats already exist. Most publishers support some standard formats and should reference `https://creative.adcontextprotocol.org`. See [Implementing Standard Format Support](/dist/docs/2.5.3/media-buy/capability-discovery/implementing-standard-formats) for detailed guidance.
...
**For sales agents implementing format support:** See [Implementing Standard Format Support](/dist/docs/2.5.3/media-buy/capability-discovery/implementing-standard-formats).
...
See [Video Channel Guide](/dist/docs/2.5.3/creative/channels/video) for complete specifications.
...
See [Display Channel Guide](/dist/docs/2.5.3/creative/channels/display) for complete specifications.
...
See [Audio Channel Guide](/dist/docs/2.5.3/creative/channels/audio) for complete specifications.
...
See [DOOH Channel Guide](/dist/docs/2.5.3/creative/channels/dooh) for complete specifications.
...
See [Carousel Channel Guide](/dist/docs/2.5.3/creative/channels/carousels) for complete specifications.

## Multi-Asset & Frame-Based Formats

Some formats like carousels, slideshows, and stories use repeatable asset groups where each frame contains a collection of assets. See the [Carousel & Multi-Asset Formats guide](/dist/docs/2.5.3/creative/channels/carousels) for complete documentation on frame-based format patterns.
...
- [Creative Protocol Overview](/dist/docs/2.5.3/creative) - How formats, manifests, and agents work together
- [Creative Manifests](/dist/docs/2.5.3/creative/creative-manifests) - Pairing assets with formats
- [Asset Types](/dist/docs/2.5.3/creative/asset-types) - Understanding asset specifications
- [Channel Guides](/dist/docs/2.5.3/creative/channels/video) - Detailed format documentation by media type
...
- [list_creative_formats Task](/dist/docs/2.5.3/media-buy/task-reference/list_creative_formats) - API reference for format discovery
