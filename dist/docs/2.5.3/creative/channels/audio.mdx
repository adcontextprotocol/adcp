...
In addition to [universal macros](/dist/docs/2.5.3/creative/universal-macros), audio formats support:
...
- [Asset Types](/dist/docs/2.5.3/creative/asset-types) - Audio asset specifications
