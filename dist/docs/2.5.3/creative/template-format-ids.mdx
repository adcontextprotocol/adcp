...
- [Creative Manifests](/dist/docs/2.5.3/creative/creative-manifests) - Complete manifest structure
- [Format Discovery](/dist/docs/2.5.3/creative/formats) - How buyers discover formats
- [Placement Targeting](/dist/docs/2.5.3/media-buy/creatives) - Assigning creatives to placements
