...
Creative manifests are structured specifications that define all the assets and metadata needed to render a creative in a specific format. They pair the requirements defined by [Creative Formats](/dist/docs/2.5.3/creative/formats) with actual asset content.
...
**DOOH-Specific Macros** (see [Universal Macros](/dist/docs/2.5.3/creative/universal-macros) for complete list):
...
Use `build_creative` to have a creative agent generate manifests from natural language briefs. See [Generative Creative](/dist/docs/2.5.3/creative/generative-creative) for details.
...
See [Universal Macros](/dist/docs/2.5.3/creative/universal-macros) for complete documentation on available macros, macro substitution process, and format-specific macro support.
...
For carousel, slideshow, and multi-asset formats, see the [Carousel & Multi-Asset Formats](/dist/docs/2.5.3/creative/channels/carousels) guide for complete documentation on repeatable asset groups.
...
- [Channel Guides](/dist/docs/2.5.3/creative/channels/video) - Format examples across video, display, audio, DOOH, and carousels
- [build_creative Task](/dist/docs/2.5.3/creative/task-reference/build_creative)
- [preview_creative Task](/dist/docs/2.5.3/creative/task-reference/preview_creative)
