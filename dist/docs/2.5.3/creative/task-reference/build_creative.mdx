...
For information about format IDs and how to reference formats, see [Creative Formats - Referencing Formats](/dist/docs/2.5.3/creative/formats.mdx#referencing-formats).
...
2. **Preview**: Use `preview_creative` to see how it renders (see [preview_creative](/dist/docs/2.5.3/creative/task-reference/preview_creative))
...
2. **preview_creative** → Renders the manifest (see [preview_creative](/dist/docs/2.5.3/creative/task-reference/preview_creative))
