...
Learn more in the [Protocols section](/docs/building).
...
- 📚 **Building an integration?** Choose [MCP](/docs/building/integration/mcp-guide) or [A2A](/docs/building/integration/a2a-guide) protocol guide
...
- **Developers**: Review the [Protocol Comparison](/docs/building/understanding/protocol-comparison) and [Task Reference](/docs/media-buy/task-reference/)
