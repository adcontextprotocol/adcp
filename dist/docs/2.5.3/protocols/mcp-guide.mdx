...
Transport-specific guide for integrating AdCP using the Model Context Protocol. For task handling, status management, and workflow patterns, see [Core Concepts](/docs/building/implementation/task-lifecycle).
...
**Task Management**: For comprehensive guidance on tracking async operations, polling patterns, and webhook integration, see [Task Management](/docs/building/implementation/task-lifecycle).
...
See [Task Management](/docs/building/implementation/task-lifecycle) for webhook payload formats and handling examples.
...
**For status handling, async operations, and clarification patterns, see [Core Concepts](/docs/building/implementation/task-lifecycle) - this guide focuses on MCP transport specifics only.**