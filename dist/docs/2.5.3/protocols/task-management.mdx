...
For async operations, you can configure webhooks instead of polling. See [Protocol Comparison - Push Notifications](/docs/building/understanding/protocol-comparison#push-notification-architecture) for protocol differences and [Core Concepts - Webhook Reliability](/docs/building/implementation/task-lifecycle#webhook-reliability) for implementation patterns.
...
- **[Core Concepts](/docs/building/implementation/task-lifecycle)** - Protocol fundamentals and design principles
- **[MCP Guide](/docs/building/integration/mcp-guide)** - MCP-specific implementation patterns
- **[A2A Guide](/docs/building/integration/a2a-guide)** - A2A-specific integration examples
