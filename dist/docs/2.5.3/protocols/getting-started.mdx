...
→ [**Start with the MCP Guide**](/docs/building/integration/mcp-guide)
...
→ [**Start with the A2A Guide**](/docs/building/integration/a2a-guide)
...
- **For MCP questions**: See the [MCP Guide](/docs/building/integration/mcp-guide)
- **For A2A questions**: See the [A2A Guide](/docs/building/integration/a2a-guide)
- **For context & task IDs**: See [Context Management](/docs/building/integration/context-sessions) to understand the difference between `context_id` and `task_id`
- **For task details**: See the [Media Buy](/docs/media-buy) or [Signals](/docs/signals/overview) sections
- **For deep technical details**: Check the [Reference](/docs/building/implementation/error-handling) section (only if needed)