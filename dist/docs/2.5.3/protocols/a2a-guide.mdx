...
Transport-specific guide for integrating AdCP using the Agent-to-Agent Protocol. For task handling, status management, and workflow patterns, see [Core Concepts](/docs/building/implementation/task-lifecycle).
...
**Status Handling**: See [Core Concepts](/docs/building/implementation/task-lifecycle) for complete status handling patterns.
...
For webhook payload formats, protocol comparison, and detailed handling examples, see [Task Management - Push Notification Integration](/docs/building/implementation/task-lifecycle#push-notification-integration).
...
**Task Management**: For comprehensive guidance on tracking async operations across all domains, polling patterns, and webhook integration, see [Task Management](/docs/building/implementation/task-lifecycle).
...
- **Core Concepts**: Read [Core Concepts](/docs/building/implementation/task-lifecycle) for status handling and workflows  
...
**For status handling, async operations, and clarification patterns, see [Core Concepts](/docs/building/implementation/task-lifecycle) - this guide focuses on A2A transport specifics only.**