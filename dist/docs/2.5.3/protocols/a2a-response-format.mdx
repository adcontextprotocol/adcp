...
Extract AdCP data using the same last-DataPart pattern. **For webhook authentication, retry patterns, and security**, see [Core Concepts - Webhook Reliability](/docs/building/implementation/task-lifecycle#webhook-reliability).
...
- [Core Concepts](/docs/building/implementation/task-lifecycle) - Status handling patterns
