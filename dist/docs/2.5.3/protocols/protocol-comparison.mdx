...
See [Core Concepts](/docs/building/implementation/task-lifecycle) for complete status handling guide.
...
- MCP webhooks: See [MCP Guide - Async Operations](/docs/building/integration/mcp-guide#async-operations-mcp-specific)
- A2A webhooks: See [A2A Guide - Push Notifications](/docs/building/integration/a2a-guide#push-notifications-a2a-specific)
...
- **Core Concepts**: Read [Core Concepts](/docs/building/implementation/task-lifecycle) for status handling patterns
- **MCP Guide**: See [MCP Guide](/docs/building/integration/mcp-guide) for tool calls and context management
- **A2A Guide**: See [A2A Guide](/docs/building/integration/a2a-guide) for artifacts and streaming
