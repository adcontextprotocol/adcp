...
For targeting decisions that must happen at impression time, buyers can use the **[Agentic eXecution Engine (AXE)](/dist/docs/2.5.3/media-buy/advanced-topics/agentic-execution-engine)**. AXE is the real-time execution layer between orchestrators and decisioning platforms.

**Key capabilities:**
- **Dynamic audience targeting**: Bring your own DMP/CDP segments to publisher inventory
- **Brand safety enforcement**: Real-time content evaluation and blocking
...
- Real-time brand safety beyond static rules
- High-cardinality targeting (millions of segment members)

See the [AXE documentation](/dist/docs/2.5.3/media-buy/advanced-topics/agentic-execution-engine) for implementation details.
...
- **Details**: See [AXE documentation](/dist/docs/2.5.3/media-buy/advanced-topics/agentic-execution-engine)
...
Real-time signals are provided through the [AdCP Signals Protocol](/dist/docs/2.5.3/signals/overview), which allows orchestrators to supply targeting data at impression time.
...
- **[Agentic eXecution Engine (AXE)](/dist/docs/2.5.3/media-buy/advanced-topics/agentic-execution-engine)** - Real-time execution layer for dynamic targeting
- **[Signals Protocol](/dist/docs/2.5.3/signals/overview)** - Real-time targeting signals for brand safety and contextual targeting
- **[Product Discovery](/dist/docs/2.5.3/media-buy/product-discovery/)** - How briefs lead to targeted product recommendations
- **[Example Briefs](/dist/docs/2.5.3/media-buy/product-discovery/example-briefs)** - Real examples of effective targeting briefs
- **[Policy Compliance](/dist/docs/2.5.3/media-buy/media-buys/policy-compliance)** - Automated compliance checking and enforcement