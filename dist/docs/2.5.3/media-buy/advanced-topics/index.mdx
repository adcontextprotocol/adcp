...
- **[Targeting](/dist/docs/2.5.3/media-buy/advanced-topics/targeting)** - Brief-based targeting with geographic overlays and real-time signals
- **[Agentic eXecution Engine (AXE)](/dist/docs/2.5.3/media-buy/advanced-topics/agentic-execution-engine)** - Real-time execution layer for dynamic audience targeting, brand safety, and frequency management
...
- **[Orchestrator Design](/dist/docs/2.5.3/media-buy/advanced-topics/orchestrator-design)** - Technical architecture for AdCP orchestrators
...
- **[Testing](/dist/docs/2.5.3/media-buy/advanced-topics/testing)** - Time simulation and dry run capabilities for faster development
...
- **Review [Testing](/dist/docs/2.5.3/media-buy/advanced-topics/testing)** for development best practices
- **Explore [Orchestrator Design](/dist/docs/2.5.3/media-buy/advanced-topics/orchestrator-design)** for architecture guidance
