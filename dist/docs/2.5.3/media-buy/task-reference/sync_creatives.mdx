...
Use the creative agent to generate creatives from a brand manifest. See the [Generative Creatives guide](/dist/docs/2.5.3/creative/generative-creative) for complete workflow details.
...
**See:** [Task Management - Async Operations](/dist/docs/2.5.3/building/implementation/task-lifecycle) for webhook configuration.
...
- [list_creative_formats](/dist/docs/2.5.3/media-buy/task-reference/list_creative_formats) - Check supported formats before upload
- [Generative Creatives Guide](/dist/docs/2.5.3/creative/generative-creative) - Generate creatives from brand manifests
- [get_media_buy_delivery](/dist/docs/2.5.3/media-buy/task-reference/get_media_buy_delivery) - Monitor creative performance
- [Creative Asset Types](/dist/docs/2.5.3/creative/asset-types) - Technical requirements for assets
