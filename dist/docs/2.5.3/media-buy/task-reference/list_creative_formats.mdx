...
For complete API documentation with request parameters, response structure, and testable examples, see the [list_creative_formats Task Reference](/dist/docs/2.5.3/creative/task-reference/list_creative_formats).
...
- [list_creative_formats (Creative Agent)](/dist/docs/2.5.3/creative/task-reference/list_creative_formats) - Full API documentation with examples
