...
- [`sync_creatives`](/dist/docs/2.5.3/media-buy/task-reference/sync_creatives) - Upload and manage creative assets
- [`create_media_buy`](/dist/docs/2.5.3/media-buy/task-reference/create_media_buy) - Create campaigns using library creatives
- [`list_creative_formats`](/dist/docs/2.5.3/media-buy/task-reference/list_creative_formats) - Discover supported creative formats
