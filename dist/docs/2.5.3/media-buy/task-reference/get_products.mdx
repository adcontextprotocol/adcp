...
| `brand_manifest` | BrandManifest \| string | No | Brand information (inline object or URL). See [Brand Manifest](/dist/docs/2.5.3/creative/brand-manifest) |
...
See [Authentication Guide](/dist/docs/2.5.3/building/integration/authentication) for details.
...
2. **Create Media Buy**: Use [`create_media_buy`](/dist/docs/2.5.3/media-buy/task-reference/create_media_buy) to execute campaign
3. **Prepare Creatives**: Use [`list_creative_formats`](/dist/docs/2.5.3/media-buy/task-reference/list_creative_formats) to see format requirements
4. **Upload Assets**: Use [`sync_creatives`](/dist/docs/2.5.3/media-buy/task-reference/sync_creatives) to provide creative assets

## Learn More

- [Product Discovery Guide](/dist/docs/2.5.3/media-buy/product-discovery/) - Understanding briefs and products
- [Pricing Models](/dist/docs/2.5.3/media-buy/advanced-topics/pricing-models) - CPM, CPCV, CPP explained
- [Brief Expectations](/dist/docs/2.5.3/media-buy/product-discovery/brief-expectations) - How to write effective briefs
- [Media Products](/dist/docs/2.5.3/media-buy/product-discovery/media-products) - Product structure and fields
