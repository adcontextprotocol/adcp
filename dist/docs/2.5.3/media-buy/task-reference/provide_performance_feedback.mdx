...
- [`get_media_buy_delivery`](/dist/docs/2.5.3/media-buy/task-reference/get_media_buy_delivery) - Retrieve delivery metrics
- [Optimization & Reporting](/dist/docs/2.5.3/media-buy/media-buys/optimization-reporting) - Performance feedback concepts
- [Targeting](/dist/docs/2.5.3/media-buy/advanced-topics/targeting) - Understanding targeting for optimization