...
**Note:** For the complete status list see [Core Concepts - Task Status System](/docs/building/implementation/task-lifecycle#task-status-system).
...
For complete async handling patterns, see [Task Management](/docs/building/implementation/task-lifecycle).
