...
| `brand_manifest` | BrandManifestRef | Yes | Brand identity - minimal (name/URL) acceptable for sales agents. See [Brand Manifest](/dist/docs/2.5.3/creative/brand-manifest) |
...
| `targeting_overlay` | TargetingOverlay | No | Additional targeting criteria (see [Targeting](/dist/docs/2.5.3/media-buy/advanced-topics/targeting)) |
...
Full manifests with colors, fonts, and product catalogs are only needed for creative generation. See [Brand Manifest](/dist/docs/2.5.3/creative/brand-manifest).
...
Packages can use different currencies when sellers support it. See [Pricing Models](/dist/docs/2.5.3/media-buy/advanced-topics/pricing-models).
...
See [Targeting](/dist/docs/2.5.3/media-buy/advanced-topics/targeting) for details.
...
**Note:** For the complete status list see [Core Concepts - Task Status System](/dist/docs/2.5.3/building/implementation/task-lifecycle#task-status-system).
...
For complete async handling patterns, see [Task Management](/dist/docs/2.5.3/building/implementation/task-lifecycle).
...
1. **Upload Creatives**: Use [`sync_creatives`](/dist/docs/2.5.3/media-buy/task-reference/sync_creatives) before deadline
2. **Monitor Status**: Use [`get_media_buy_delivery`](/dist/docs/2.5.3/media-buy/task-reference/get_media_buy_delivery)
3. **Optimize**: Use [`provide_performance_feedback`](/dist/docs/2.5.3/media-buy/task-reference/provide_performance_feedback)
4. **Update**: Use [`update_media_buy`](/dist/docs/2.5.3/media-buy/task-reference/update_media_buy) to modify campaign

## Learn More

- [Media Buy Lifecycle](/dist/docs/2.5.3/media-buy/media-buys/) - Complete campaign workflow
- [get_products](/dist/docs/2.5.3/media-buy/task-reference/get_products) - Discover inventory
- [Targeting](/dist/docs/2.5.3/media-buy/advanced-topics/targeting) - Targeting strategies
- [Pricing Models](/dist/docs/2.5.3/media-buy/advanced-topics/pricing-models) - Currency and pricing
