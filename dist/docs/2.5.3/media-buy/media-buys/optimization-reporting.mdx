...
- See [Webhook Security](/docs/building/implementation/task-lifecycle.mdx#security) for implementation details
...
Webhook delivery status is tracked through **AdCP's global task management system** (see [Task Management](/docs/building/implementation/task-lifecycle)).
...
See [Core Concepts: Webhook Reliability](/docs/building/implementation/task-lifecycle.mdx#webhook-reliability) for detailed implementation guidance.
