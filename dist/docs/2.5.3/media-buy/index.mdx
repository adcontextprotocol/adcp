...
This is AdCP's core advertising automation interface, providing 8 standardized tasks for managing the complete advertising lifecycle—from inventory discovery through campaign optimization.

## Protocol Access

Media Buy tasks are accessible through multiple protocols:

- **[MCP (Model Context Protocol)](/dist/docs/2.5.3/building/integration/mcp-guide)**: Direct integration with AI assistants like Claude
- **[A2A (Agent-to-Agent)](/dist/docs/2.5.3/building/integration/a2a-guide)**: Complex agent workflows and collaboration

All protocols provide identical functionality - choose based on your integration needs. See [Protocol Comparison](/dist/docs/2.5.3/building/understanding/protocol-comparison) for guidance.
...
### Discovery & Planning
- **[`get_products`](/dist/docs/2.5.3/media-buy/task-reference/get_products)**: Discover advertising inventory using natural language briefs
- **[`list_creative_formats`](/dist/docs/2.5.3/media-buy/task-reference/list_creative_formats)**: Understand creative requirements and specifications
- **[`list_authorized_properties`](/dist/docs/2.5.3/media-buy/task-reference/list_authorized_properties)**: Verify publisher authorization and available properties

### Campaign Execution
- **[`create_media_buy`](/dist/docs/2.5.3/media-buy/task-reference/create_media_buy)**: Launch advertising campaigns with complete lifecycle management
- **[`update_media_buy`](/dist/docs/2.5.3/media-buy/task-reference/update_media_buy)**: Modify budgets, targeting, and campaign settings

### Creative Management
- **[`list_creatives`](/dist/docs/2.5.3/media-buy/task-reference/list_creatives)**: Browse and filter creative asset libraries
- **[`sync_creatives`](/dist/docs/2.5.3/media-buy/task-reference/sync_creatives)**: Upload and synchronize creative assets across platforms

### Performance Optimization
- **[`get_media_buy_delivery`](/dist/docs/2.5.3/media-buy/task-reference/get_media_buy_delivery)**: Track performance metrics and campaign delivery
...
### [Task Reference](/dist/docs/2.5.3/media-buy/task-reference/) 🔗
...
### [Capability Discovery](/dist/docs/2.5.3/media-buy/capability-discovery/) 🔍
...
### [Creatives](/dist/docs/2.5.3/media-buy/creatives/) 🎨
Creative asset management including library management, asset lifecycle, and cross-platform synchronization. Works in conjunction with the [Creative Protocol](/dist/docs/2.5.3/creative/) for building and managing creative content.

### [Advanced Topics](/dist/docs/2.5.3/media-buy/advanced-topics/) 🛠️
...
1. **Start with [Protocol Selection](/dist/docs/2.5.3/building/understanding/protocol-comparison)** - Choose MCP or A2A based on your use case
2. **Learn [Capability Discovery](/dist/docs/2.5.3/media-buy/capability-discovery/)** - Understand creative formats and property authorization
3. **Try [Product Discovery](/dist/docs/2.5.3/media-buy/product-discovery/)** - See how natural language briefs work
4. **Reference [Task Reference](/dist/docs/2.5.3/media-buy/task-reference/)** - Implement the 8 core tasks

### **For Campaign Managers**
1. **Understand the [Media Buy Lifecycle](/dist/docs/2.5.3/media-buy/media-buys/)** - Learn the complete workflow
2. **Review [Product Discovery](/dist/docs/2.5.3/media-buy/product-discovery/)** - See how to find inventory with briefs
3. **Study [Policy Compliance](/dist/docs/2.5.3/media-buy/media-buys/policy-compliance)** - Understand approval requirements
4. **Explore [Optimization & Reporting](/dist/docs/2.5.3/media-buy/media-buys/optimization-reporting)** - Learn performance management

### **For Publishers/Sales Agents**
1. **Learn [Authorized Properties](/dist/docs/2.5.3/media-buy/capability-discovery/authorized-properties)** - Understand authorization requirements
2. **Review [Creative Formats](/dist/docs/2.5.3/creative/formats)** - See supported creative specifications
3. **Study [Advanced Topics](/dist/docs/2.5.3/media-buy/advanced-topics/)** - Deep dive into technical implementation

### **For Technical Implementers**
1. **Choose your [Protocol](/dist/docs/2.5.3/protocols/protocol-comparison)** - MCP vs A2A comparison
2. **Study [Task Reference](/dist/docs/2.5.3/media-buy/task-reference/)** - Complete API documentation
3. **Review [Advanced Topics](/dist/docs/2.5.3/media-buy/advanced-topics/)** - Security, testing, and architecture
4. **Explore [Creative Management](/dist/docs/2.5.3/media-buy/creatives/)** - Asset lifecycle and synchronization
