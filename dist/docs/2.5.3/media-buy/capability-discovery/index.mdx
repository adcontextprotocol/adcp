...
### [Implementing Standard Format Support](/dist/docs/2.5.3/media-buy/capability-discovery/implementing-standard-formats) 🎨
...
### [Authorized Properties](/dist/docs/2.5.3/media-buy/capability-discovery/authorized-properties) 🔐
...
<Note>
**Cross-Protocol Foundation**: The `adagents.json` authorization system applies across ALL AdCP protocols (Media Buy, Signals, and future Curation). See the [adagents.json specification](/dist/docs/2.5.3/media-buy/capability-discovery/adagents) for complete implementation details.
</Note>
...
### [`list_creative_formats`](/dist/docs/2.5.3/media-buy/task-reference/list_creative_formats)
...
### [`list_authorized_properties`](/dist/docs/2.5.3/media-buy/task-reference/list_authorized_properties)
...
1. **Understand Formats**: Call [`list_creative_formats`](/dist/docs/2.5.3/media-buy/task-reference/list_creative_formats) to learn supported creative types
2. **Validate Authorization**: Use [`list_authorized_properties`](/dist/docs/2.5.3/media-buy/task-reference/list_authorized_properties) to verify sales agent legitimacy
3. **Discover Products**: Search for advertising inventory with [`get_products`](/dist/docs/2.5.3/media-buy/task-reference/get_products)
...
- **[Product Discovery](/dist/docs/2.5.3/media-buy/product-discovery/)** - Finding advertising inventory
- **[Creatives](/dist/docs/2.5.3/media-buy/creatives/)** - Creative asset management
- **[Creative Protocol](/dist/docs/2.5.3/creative/)** - Creative agents and manifests
- **[Creative Channel Guides](/dist/docs/2.5.3/creative/channels/video)** - Format examples and patterns
- **[Creative Manifests](/dist/docs/2.5.3/creative/creative-manifests)** - Understanding creative specifications
- **[adagents.json Specification](/dist/docs/2.5.3/media-buy/capability-discovery/adagents)** - Publisher authorization system (applies across all AdCP protocols)