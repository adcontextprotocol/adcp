...
- **Documentation**: [Quickstart Guide](/dist/docs/2.5.3/quickstart)
...
Check the [Release Notes](/dist/docs/2.5.3/reference/release-notes) or [GitHub Releases](https://github.com/adcontextprotocol/adcp/releases) for all available versions.
...
- [Release Notes](/dist/docs/2.5.3/reference/release-notes) - Version history and migration guides
