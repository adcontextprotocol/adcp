...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.0.22/core/attribution-window.json",
  "post_click": {
    "interval": 7,
    "unit": "days"
  },
