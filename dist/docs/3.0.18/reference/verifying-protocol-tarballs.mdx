...
- [Schemas, compliance bundles, and SDKs](/dist/docs/3.0.18/building/by-layer/L0/schemas) — where these sidecars are described in the broader bundle-fetching flow
