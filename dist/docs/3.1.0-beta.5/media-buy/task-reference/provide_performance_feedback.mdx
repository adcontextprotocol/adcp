...
**Request Schema**: [`https://adcontextprotocol.org/schemas/3.1.0-beta.5/media-buy/provide-performance-feedback-request.json`](https://adcontextprotocol.org/schemas/3.1.0-beta.5/media-buy/provide-performance-feedback-request.json)
**Response Schema**: [`https://adcontextprotocol.org/schemas/3.1.0-beta.5/media-buy/provide-performance-feedback-response.json`](https://adcontextprotocol.org/schemas/3.1.0-beta.5/media-buy/provide-performance-feedback-response.json)
...
| `metric_type` | string | **Deprecated** | Legacy free-form metric enum (mixes metrics, verification, attribution into one list). New implementations SHOULD use `metric` instead. No longer required at the schema level; retained for one-minor backwards compatibility; removed at the next major. See the [metric-type migration table](https://adcontextprotocol.org/schemas/3.1.0-beta.5/enums/metric-type.json) for the mapping. |
...
```json
{
  "$schema": "/schemas/3.1.0-beta.5/media-buy/provide-performance-feedback-request.json",
...
```json
{
  "$schema": "/schemas/3.1.0-beta.5/media-buy/provide-performance-feedback-response.json",
  "status": "completed",
  "success": true,
...
- [`get_media_buy_delivery`](/dist/docs/3.1.0-beta.5/media-buy/task-reference/get_media_buy_delivery) - Retrieve delivery metrics
- [Optimization & Reporting](/dist/docs/3.1.0-beta.5/media-buy/media-buys/optimization-reporting) - Performance feedback concepts
- [Targeting](/dist/docs/3.1.0-beta.5/media-buy/advanced-topics/targeting) - Understanding targeting for optimization