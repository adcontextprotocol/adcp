...
description: "DOOH ad formats in AdCP define digital billboard, transit screen, and venue display specifications with venue-based impression tracking."
"og:title": "AdCP — DOOH (Digital Out-of-Home)"
---
...
In addition to [universal macros](/dist/docs/3.1.0-beta.5/creative/universal-macros), DOOH formats support:
...
- [Universal Macros](/dist/docs/3.1.0-beta.5/creative/universal-macros) - Complete macro reference including DOOH macros
- [Creative Manifests](/dist/docs/3.1.0-beta.5/creative/creative-manifests) - Manifest structure and examples
- [Asset Types](/dist/docs/3.1.0-beta.5/creative/asset-types) - URL asset specifications
