...
<Info>
**Free module** — No account required. ~20 minutes with Addie. Prerequisite: [A1](/dist/docs/3.1.0-beta.5/learning/foundations/a1-agentic-advertising).
</Info>
...
<CardGroup cols={2}>
  <Card title="Protocol architecture" icon="sitemap" href="/dist/docs/3.1.0-beta.5/protocol/architecture">
  ...
  <Card title="A2A guide" icon="arrows-left-right" href="/dist/docs/3.1.0-beta.5/building/by-layer/L0/a2a-guide">
    The Agent-to-Agent protocol — how specialized agents collaborate on complex campaigns.
  </Card>
  <Card title="Task lifecycle" icon="circle-nodes" href="/dist/docs/3.1.0-beta.5/building/by-layer/L3/task-lifecycle">
...
| **Specialism** | A narrow capability claim within a domain — e.g. `sales-guaranteed`, `creative-generative`, `signal-marketplace`. Declared via `specialisms`. See the [Compliance Catalog](/dist/docs/3.1.0-beta.5/building/verification/compliance-catalog). |
