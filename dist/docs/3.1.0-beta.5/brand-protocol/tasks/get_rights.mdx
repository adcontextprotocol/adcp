...
- **Request**: [`get-rights-request.json`](https://adcontextprotocol.org/schemas/3.1.0-beta.5/brand/get-rights-request.json)
- **Response**: [`get-rights-response.json`](https://adcontextprotocol.org/schemas/3.1.0-beta.5/brand/get-rights-response.json)
...
1. Call [`get_brand_identity`](/dist/docs/3.1.0-beta.5/brand-protocol/tasks/get_brand_identity) for the selected brand's full identity data
2. Call [`acquire_rights`](/dist/docs/3.1.0-beta.5/brand-protocol/tasks/acquire_rights) with the `rights_id` and `pricing_option_id`
