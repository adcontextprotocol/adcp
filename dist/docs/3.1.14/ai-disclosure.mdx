...
- **Resolution:** handled through the [certification complaints process](/dist/docs/3.1.14/learning/policies/complaints), by an AgenticAdvertising.org staff reviewer who did not participate in the original grading or targeting decision.
...
- AgenticAdvertising.org's founder's other company (Scope3) contributed funding and foundational IP — see the [FAQ entry](/dist/docs/3.1.14/faq#how-is-aao-related-to-scope3) for the full relationship.
