...
**Schema**: [validate-content-delivery-request.json](https://adcontextprotocol.org/schemas/3.1.14/content-standards/validate-content-delivery-request.json)
...
**Schema**: [validate-content-delivery-response.json](https://adcontextprotocol.org/schemas/3.1.14/content-standards/validate-content-delivery-response.json)

### Success Response

```json
{
  "$schema": "/schemas/3.1.14/content-standards/validate-content-delivery-response.json",
  "status": "completed",
  "summary": {
    "total_records": 1000,
    "passed_records": 950,
