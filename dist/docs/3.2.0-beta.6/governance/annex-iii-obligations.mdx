...
- [`eu_ai_act_annex_iii`](/dist/docs/3.2.0-beta.6/governance/policy-registry#seeded-policies) — the seeded registry policy
- [Policy registry](/dist/docs/3.2.0-beta.6/governance/policy-registry) — `requires_human_review` on policies and categories
- [Campaign governance specification](/dist/docs/3.2.0-beta.6/governance/campaign/specification) — `human_review_required` plan field
- [Embedded human judgment](/dist/docs/3.2.0-beta.6/governance/embedded-human-judgment) — the architectural principle behind mandatory oversight
