...
|------|------------|-----------|
| `get_adcp_capabilities` | Required | [Capability discovery](/dist/docs/3.1.0-rc.4/protocol/get_adcp_capabilities) |

Caller-scope RBAC introspection is not a standalone task. Sellers that support scope introspection return a per-account `authorization` object on `sync_accounts` and `list_accounts` responses. See [Accounts Protocol — Caller authorization](/dist/docs/3.1.0-rc.4/accounts/overview#caller-authorization).
...
**Reference**: [Media Buy Specification](/dist/docs/3.1.0-rc.4/media-buy/specification) · [Seller integration guide](/dist/docs/3.1.0-rc.4/building/operating/seller-integration)
...
**Reference**: [Media Buy Specification — Orchestrator conformance](/dist/docs/3.1.0-rc.4/media-buy/specification#orchestrator-conformance)
...
**Reference**: [Creative Specification](/dist/docs/3.1.0-rc.4/creative/specification)
...
**Reference**: [Signals Specification](/dist/docs/3.1.0-rc.4/signals/specification)
...
**Reference**: [Brand Protocol](/dist/docs/3.1.0-rc.4/brand-protocol) · [Building a brand agent](/dist/docs/3.1.0-rc.4/brand-protocol/building-a-brand-agent)
...
**Reference**: [Accounts Protocol](/dist/docs/3.1.0-rc.4/accounts/overview)
...
**Reference**: [Campaign Governance Specification](/dist/docs/3.1.0-rc.4/governance/campaign/specification)
...
**Reference**: [Property Governance Specification](/dist/docs/3.1.0-rc.4/governance/property/specification)
...
**Reference**: [Collection Governance](/dist/docs/3.1.0-rc.4/governance/collection)
...
**Reference**: [Content Standards](/dist/docs/3.1.0-rc.4/governance/content-standards)
...
**Reference**: [Creative Governance](/dist/docs/3.1.0-rc.4/governance/creative)
...
**Reference**: [Sponsored Intelligence Specification](/dist/docs/3.1.0-rc.4/sponsored-intelligence/specification)

## Trusted Match Protocol

TMP uses a different communication model (direct HTTP, not MCP/A2A tasks). See the [TMP Specification](/dist/docs/3.1.0-rc.4/trusted-match/specification) for message types and conformance requirements.
