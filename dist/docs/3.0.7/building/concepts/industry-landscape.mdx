...
OpenRTB and AdCP are complementary. OpenRTB handles "should I bid on this impression?"; AdCP handles "create a campaign with this budget and targeting." See [AdCP and OpenRTB](/dist/docs/3.0.7/building/concepts/adcp-vs-openrtb) for details.
...
<CardGroup cols={2}>
  ...
  <Card title="AdCP and OpenRTB" icon="arrows-left-right" href="/dist/docs/3.0.7/building/concepts/adcp-vs-openrtb">
    Detailed comparison of AdCP and OpenRTB — how they complement each other.
  </Card>
  <Card title="Protocol comparison" icon="code-compare" href="/dist/docs/3.0.7/building/concepts/protocol-comparison">
