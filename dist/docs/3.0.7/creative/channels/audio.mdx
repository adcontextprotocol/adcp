...
In addition to [universal macros](/dist/docs/3.0.7/creative/universal-macros), audio formats support:
...
- [Asset Types](/dist/docs/3.0.7/creative/asset-types) - Audio asset specifications
