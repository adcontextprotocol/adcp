...
**Schema**: [update-content-standards-request.json](https://adcontextprotocol.org/schemas/3.0.7/content-standards/update-content-standards-request.json)
...
**Schema**: [update-content-standards-response.json](https://adcontextprotocol.org/schemas/3.0.7/content-standards/update-content-standards-response.json)
