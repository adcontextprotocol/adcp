...
**Schema**: [get-media-buy-artifacts-response.json](https://adcontextprotocol.org/schemas/3.0.7/content-standards/get-media-buy-artifacts-response.json)
