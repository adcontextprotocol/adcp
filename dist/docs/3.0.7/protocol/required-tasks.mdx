...
|------|------------|-----------|
| `get_adcp_capabilities` | Required | [Capability discovery](/dist/docs/3.0.7/protocol/get_adcp_capabilities) |
...
**Reference**: [Media Buy Specification](/dist/docs/3.0.7/media-buy/specification) · [Seller integration guide](/dist/docs/3.0.7/building/implementation/seller-integration)
...
**Reference**: [Media Buy Specification — Orchestrator conformance](/dist/docs/3.0.7/media-buy/specification#orchestrator-conformance)
...
**Reference**: [Creative Specification](/dist/docs/3.0.7/creative/specification)
...
**Reference**: [Signals Specification](/dist/docs/3.0.7/signals/specification)
...
**Reference**: [Brand Protocol](/dist/docs/3.0.7/brand-protocol) · [Building a brand agent](/dist/docs/3.0.7/brand-protocol/building-a-brand-agent)
...
**Reference**: [Accounts Protocol](/dist/docs/3.0.7/accounts/overview)
...
**Reference**: [Campaign Governance Specification](/dist/docs/3.0.7/governance/campaign/specification)
...
**Reference**: [Property Governance Specification](/dist/docs/3.0.7/governance/property/specification)
...
**Reference**: [Collection Governance](/dist/docs/3.0.7/governance/collection)
...
**Reference**: [Content Standards](/dist/docs/3.0.7/governance/content-standards)
...
**Reference**: [Creative Governance](/dist/docs/3.0.7/governance/creative)
...
**Reference**: [Sponsored Intelligence Specification](/dist/docs/3.0.7/sponsored-intelligence/specification)

## Trusted Match Protocol

TMP uses a different communication model (direct HTTP, not MCP/A2A tasks). See the [TMP Specification](/dist/docs/3.0.7/trusted-match/specification) for message types and conformance requirements.
