...
A [product](/dist/docs/3.0.7/media-buy/product-discovery/media-products) describes inventory along three independent axes:
...
| `talent` | array | No | Hosts, recurring cast, creators. Each entry has `role`, `name`, and optional `brand_url` linking to [brand.json](/dist/docs/3.0.7/brand-protocol/brand-json). |
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.0.7/core/collection.json",
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.0.7/core/installment.json",
...
- `talent` — hosts and recurring cast, with optional [brand.json](/dist/docs/3.0.7/brand-protocol/brand-json) references for deeper evaluation
...
- [Media products](/dist/docs/3.0.7/media-buy/product-discovery/media-products) — the full product model
- [Print ads](/dist/docs/3.0.7/creative/channels/print) — print-specific creative formats, physical dimensions, bleed, and DPI
- [brand.json](/dist/docs/3.0.7/brand-protocol/brand-json) — talent identity and brand safety evaluation
- [Product discovery](/dist/docs/3.0.7/media-buy/product-discovery) — how buyers discover inventory via `get_products`
