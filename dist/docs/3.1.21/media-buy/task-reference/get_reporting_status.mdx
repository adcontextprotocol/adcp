...
usable. It does not replace [`get_media_buy_delivery`](/dist/docs/3.1.21/media-buy/task-reference/get_media_buy_delivery)
...
[`sync_accounts`](/dist/docs/3.1.21/accounts/tasks/sync_accounts) `notification_configs[]`. It is
...
[`sync_accounts`](/dist/docs/3.1.21/accounts/tasks/sync_accounts) and
[`list_accounts`](/dist/docs/3.1.21/accounts/tasks/list_accounts) return
