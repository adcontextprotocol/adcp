...
filter in [`get_products`](/dist/docs/3.1.21/media-buy/task-reference/get_products) and related tasks carries canonical language ranges and applies RFC 4647 §3.3.1
