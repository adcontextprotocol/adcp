...
2. **How will the tracker URL's macros be processed?** Match each occurrence against the exact [`macro_resolution_capabilities`](/dist/docs/3.1.21/creative/universal-macros).
