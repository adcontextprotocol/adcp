...
- [Creative Formats](/dist/docs/3.2.0-beta.8/creative/formats) — Format structure and requirements
- [Asset Types](/dist/docs/3.2.0-beta.8/creative/asset-types) — Asset specifications and payload schemas
- [Creative Manifests](/dist/docs/3.2.0-beta.8/creative/creative-manifests) — Pairing assets with formats
- [`get_adcp_capabilities`](/dist/docs/3.2.0-beta.8/protocol/get_adcp_capabilities) — Creative-agent capability discovery
