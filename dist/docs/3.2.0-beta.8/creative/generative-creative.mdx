...
- [`list_transformers`](/dist/docs/3.2.0-beta.8/creative/task-reference/list_transformers)
- [Canonical formats](/dist/docs/3.2.0-beta.8/creative/canonical-formats)
- [Multi-agent orchestration](/dist/docs/3.2.0-beta.8/creative/multi-agent-orchestration)
