...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-beta.8/core/product-format-declaration.json",
...
See [Canonical formats](/dist/docs/3.2.0-beta.8/creative/canonical-formats), [Radio](/dist/docs/3.2.0-beta.8/creative/channels/radio), [Broadcast](/dist/docs/3.2.0-beta.8/creative/channels/broadcast), and [`list_transformers`](/dist/docs/3.2.0-beta.8/creative/task-reference/list_transformers).
