...
See [Creative representation sets](/dist/docs/3.2.0-beta.8/creative/representation-sets), [Canonical formats](/dist/docs/3.2.0-beta.8/creative/canonical-formats), [Creative manifests](/dist/docs/3.2.0-beta.8/creative/creative-manifests), and [Universal macros](/dist/docs/3.2.0-beta.8/creative/universal-macros).
