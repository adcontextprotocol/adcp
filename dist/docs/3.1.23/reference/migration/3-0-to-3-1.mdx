...
For the feature narrative, start with [What's New in AdCP 3.1](/dist/docs/3.1.23/reference/whats-new-in-3-1). For the full release record, see [Release Notes](/dist/docs/3.1.23/reference/release-notes#version-3-1-0).
...
Version 3.1.22 was an emergency security exception to the normal six-week experimental-change notice process. Its published package, tag, and versioned artifacts remain immutable; the missing #7397 changelog coverage is carried forward by an independent v3.1.23 patch changeset. See the [v3.1.22 release note](/dist/docs/3.1.23/reference/release-notes#version-3-1-22) for the release record.
...
- [What's New in AdCP 3.1](/dist/docs/3.1.23/reference/whats-new-in-3-1)
- [Release Notes](/dist/docs/3.1.23/reference/release-notes#version-3-1-0)
- [Versions & Compatibility](/dist/docs/3.1.23/reference/versions)
- [Versioning & Governance](/dist/docs/3.1.23/reference/versioning)
- [Version Adaptation](/dist/docs/3.1.23/building/cross-cutting/version-adaptation)
