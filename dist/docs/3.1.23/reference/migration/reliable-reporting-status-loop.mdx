...
6. Use `content_mismatch` only for contract facts the accepted configuration
   ...
   counts belongs to
   [billing authority](/dist/docs/3.1.23/media-buy/advanced-topics/billing-authority)
...
uses [`sync_reporting_receipts`](/dist/docs/3.1.23/media-buy/task-reference/sync_reporting_receipts)
...
[Billing Authority](/dist/docs/3.1.23/media-buy/advanced-topics/billing-authority). Current
...
[`reporting_core_lifecycle_probe`](/dist/docs/3.1.23/building/by-layer/L3/comply-test-controller#reporting_core_lifecycle_probe)
...
[known limitations](/dist/docs/3.1.23/reference/known-limitations#conformance-and-testing).
