...
usable. It does not replace [`get_media_buy_delivery`](/dist/docs/3.1.23/media-buy/task-reference/get_media_buy_delivery)
...
bundle served from `/schemas/3.1.23/` rather than the rc.2 pin above.
</Note>
...
[`sync_reporting_status`](/dist/docs/3.1.23/media-buy/task-reference/sync_reporting_status).
...
[`sync_accounts`](/dist/docs/3.1.23/accounts/tasks/sync_accounts) `notification_configs[]`. It is
...
[`sync_reporting_receipts`](/dist/docs/3.1.23/media-buy/task-reference/sync_reporting_receipts).
...
[`sync_accounts`](/dist/docs/3.1.23/accounts/tasks/sync_accounts) and
[`list_accounts`](/dist/docs/3.1.23/accounts/tasks/list_accounts) return
