...
See [Canonical formats](/dist/docs/3.2.0-beta.4/creative/canonical-formats), [Accessibility](/dist/docs/3.2.0-beta.4/creative/accessibility), and [Media products](/dist/docs/3.2.0-beta.4/media-buy/product-discovery/media-products).
