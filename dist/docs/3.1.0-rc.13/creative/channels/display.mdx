...
In addition to [universal macros](/dist/docs/3.1.0-rc.13/creative/universal-macros), display formats support:
...
- [Asset Types](/dist/docs/3.1.0-rc.13/creative/asset-types) - Image, HTML, and JavaScript asset specifications
