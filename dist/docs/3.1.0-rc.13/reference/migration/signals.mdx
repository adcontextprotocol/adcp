...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.1.0-rc.13/core/signal-pricing-option.json",
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.1.0-rc.13/account/report-usage-request.json",
...
**Related:** [Pricing](/dist/docs/3.1.0-rc.13/reference/migration/pricing) | [Optimization goals](/dist/docs/3.1.0-rc.13/reference/migration/optimization-goals) | [AdCP 3.0 overview](/dist/docs/3.1.0-rc.13/reference/whats-new-in-v3)
