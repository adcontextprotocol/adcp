...
For the cumulative cross-layer story (what L0+L1 buys you), see the [SDK stack reference](/dist/docs/3.1.0-rc.13/building/cross-cutting/sdk-stack#l1--identity--signing).

## Pages in this layer

- **[Security implementation profile](/dist/docs/3.1.0-rc.13/building/by-layer/L1/security)** — RFC 9421 wire details, KMS integration, replay-window tuning.
- **[Webhook verifier tuning](/dist/docs/3.1.0-rc.13/building/by-layer/L1/webhook-verifier-tuning)** — clock-skew handling, key-rotation transitions, signature failure diagnostics.
