...
**Request schema:** [`/schemas/3.1.19/media-buy/accept-proposal-request.json`](https://adcontextprotocol.org/schemas/3.1.19/media-buy/accept-proposal-request.json)
