...
**Schema**: [get-content-standards-request.json](https://adcontextprotocol.org/schemas/3.1.19/content-standards/get-content-standards-request.json)
...
**Schema**: [get-content-standards-response.json](https://adcontextprotocol.org/schemas/3.1.19/content-standards/get-content-standards-response.json)
