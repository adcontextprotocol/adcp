...
**Reference**: [Media Buy Specification](/dist/docs/3.0.1/media-buy/specification) · [Seller integration guide](/dist/docs/3.0.1/building/operating/seller-integration)
