...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.0.1/core/creative-assignment.json",
...
<Card title="Creative" icon="arrow-right" href="/dist/docs/3.0.1/creative/index">
