...
See [Known spec ambiguities — PRM required for non-OAuth agents](/docs/building/implementation/known-ambiguities#prm-required-for-non-oauth-agents) for background on why the carve-out exists and how the static-credential / `oauth_discovery` phase semantics were designed.
