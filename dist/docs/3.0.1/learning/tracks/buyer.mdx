...
<CardGroup cols={2}>
  ...
  <Card title="Orchestrator design" icon="diagram-project" href="/dist/docs/3.0.1/building/operating/orchestrator-design">
  ...
  <Card title="Error handling" icon="triangle-exclamation" href="/dist/docs/3.0.1/building/by-layer/L3/error-handling">
...
Create a working buyer agent that discovers products and executes media buys. Use any AI coding assistant (Claude Code, Cursor, Copilot) with the [`@adcp/client`](/dist/docs/3.0.1/building/by-layer/L0/schemas) SDK. The skill tested is orchestrating a buying workflow correctly.
...
See [Validate Your Agent](/dist/docs/3.0.1/building/verification/validate-your-agent) for CLI setup and the full testing workflow.
...
Review the [Compliance Catalog](/dist/docs/3.0.1/building/verification/compliance-catalog) and note which specialisms your target sellers claim — that's your test matrix.
