...
```json
{
  "$schema": "/schemas/3.0.1/sponsored-intelligence/si-initiate-session-request.json",
...
```json
{
  "$schema": "/schemas/3.0.1/sponsored-intelligence/si-initiate-session-response.json",
