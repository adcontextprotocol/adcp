...
```json
{
  "$schema": "/schemas/3.0.1/3.0.1/sponsored-intelligence/si-get-offering-request.json",
...
```json
{
  "$schema": "/schemas/3.0.1/3.0.1/sponsored-intelligence/si-get-offering-response.json",
  "available": true,
