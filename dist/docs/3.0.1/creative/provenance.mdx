...
```json
{
  "$schema": "/schemas/3.0.1/core/provenance.json",
...
```json
{
  "$schema": "/schemas/3.0.1/core/creative-manifest.json",
  "format_id": {
...
```json
{
  "$schema": "/schemas/3.0.1/content-standards/artifact.json",
...
```json
{
  "$schema": "/schemas/3.0.1/core/creative-policy.json",
