...
usable. It does not replace [`get_media_buy_delivery`](/dist/docs/3.2.0-beta.11/media-buy/task-reference/get_media_buy_delivery)
...
[`sync_accounts`](/dist/docs/3.2.0-beta.11/accounts/tasks/sync_accounts) `notification_configs[]`. It is
...
[`sync_reporting_receipts`](/dist/docs/3.2.0-beta.11/media-buy/task-reference/sync_reporting_receipts).
...
[`sync_accounts`](/dist/docs/3.2.0-beta.11/accounts/tasks/sync_accounts) and
[`list_accounts`](/dist/docs/3.2.0-beta.11/accounts/tasks/list_accounts) return
