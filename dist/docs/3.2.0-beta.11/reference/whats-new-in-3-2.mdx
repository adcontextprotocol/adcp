...
the [3.2 beta program](/dist/docs/3.2.0-beta.11/reference/3-2-beta) before testing.
</Warning>
...
<CardGroup cols={3}>
  ...
  <Card title="Build it" icon="code" href="/dist/docs/3.2.0-beta.11/building/by-layer/L4/choose-your-sdk">
    Choose an SDK that explicitly embeds the current 3.2 protocol checkpoint.
  </Card>
  <Card title="Adopt it" icon="route" href="/dist/docs/3.2.0-beta.11/reference/migration/3-1-to-3-2">
...
facades. See [Proposal negotiation](/dist/docs/3.2.0-beta.11/media-buy/product-discovery/proposal-negotiation)
...
After authentication, [`sync_principal`](/dist/docs/3.2.0-beta.11/protocol/sync_principal) lets a
...
[`get_principal`](/dist/docs/3.2.0-beta.11/protocol/get_principal) is the side-effect-free repair
...
creates or updates a package. See [Targeting-aware product discovery](/dist/docs/3.2.0-beta.11/reference/migration/targeting-aware-discovery).
...
See [programmed channels and owner-sold carriage](/dist/docs/3.2.0-beta.11/media-buy/product-discovery/collections-and-installments#programmed-channels-and-owner-sold-carriage).
...
asset-scoped bearer tokens. See [Migrating secured asset access](/dist/docs/3.2.0-beta.11/reference/migration/asset-access).
...
ratcheted floors only as regression guards. See [Known Limitations](/dist/docs/3.2.0-beta.11/reference/known-limitations#conformance-and-testing)
...
1. Read the [3.2 beta program](/dist/docs/3.2.0-beta.11/reference/3-2-beta).
2. Follow [Migrating from 3.1 to 3.2](/dist/docs/3.2.0-beta.11/reference/migration/3-1-to-3-2).
3. Choose the exact package and support level in [Choose your SDK](/dist/docs/3.2.0-beta.11/building/by-layer/L4/choose-your-sdk).
4. Use the [Release Notes](/dist/docs/3.2.0-beta.11/reference/release-notes#version-3-2-0) for the cumulative record.
