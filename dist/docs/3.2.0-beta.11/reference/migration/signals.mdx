...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-beta.11/core/signal-pricing-option.json",
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-beta.11/account/report-usage-request.json",
...
<Card title="Signals Protocol" icon="arrow-right" href="/dist/docs/3.2.0-beta.11/signals/overview">
  Full reference for signal discovery, activation, usage reporting, and pricing models.
</Card>

---

**Related:** [Pricing](/dist/docs/3.2.0-beta.11/reference/migration/pricing) | [Optimization goals](/dist/docs/3.2.0-beta.11/reference/migration/optimization-goals) | [AdCP 3.0 overview](/dist/docs/3.2.0-beta.11/reference/whats-new-in-v3)
