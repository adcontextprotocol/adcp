...
<CardGroup cols={2}>
  ...
  <Card title="FAQ: do I need to change my measurement stack?" icon="circle-question" href="/dist/docs/3.2.0-rc.3/faq#buying-ai-media">
    The short answer: no — you keep your IAS / DV / Nielsen contracts and accreditations.
  </Card>
  <Card title="What AdCP does not standardize" icon="list-check" href="/dist/docs/3.2.0-rc.3/reference/known-limitations">
