...
`14.0.0-rc.35`, Python SDK `8.0.0b14`, and Go SDK `adcp/v3@v3.2.1` embed it
exactly:
...
| Current SDK wave | `@adcp/sdk@14.0.0-rc.35`, Python `adcp==8.0.0b14`, and Go `adcp/v3@v3.2.1` embed `3.2.0-rc.1` | Exact RC.1 SDK-backed testing; higher-level Python and Go coverage remains role-dependent |
...
See [Choose your SDK](/dist/docs/3.2.0-rc.3/building/by-layer/L4/choose-your-sdk) for the support
...
than copying schemas from `main` or from the moving `/schemas/3.2.0-rc.3/` path:
...
[Verifying protocol tarballs](/dist/docs/3.2.0-rc.3/reference/verifying-protocol-tarballs) for
...
The SDK compatibility matrix lives in [Choose your SDK](/dist/docs/3.2.0-rc.3/building/by-layer/L4/choose-your-sdk).
All three rows name exact RC.1 support with different higher-layer coverage.
None implies support for another checkpoint. Treat generated 3.2 types and
...
Protocol beta.1 through beta.11, RC.0, and RC.1 are published. TypeScript SDK
RC.32, Python SDK beta.14, and Go SDK v3.2.1 embed RC.1. Before
treating a test result as RC.1 protocol evidence, confirm that:

- the test uses the signed RC.1 artifact directly or an exact RC.1 SDK pairing;
...
- Experimental surfaces retain their [experimental-status contract](/dist/docs/3.2.0-rc.3/reference/experimental-status).
...
- [What's New in AdCP 3.2](/dist/docs/3.2.0-rc.3/reference/whats-new-in-3-2)
- [Migrating from 3.1 to 3.2](/dist/docs/3.2.0-rc.3/reference/migration/3-1-to-3-2)
- [Release Notes](/dist/docs/3.2.0-rc.3/reference/release-notes#version-3-2-0)
- [Versions & Compatibility](/dist/docs/3.2.0-rc.3/reference/versions)
- [Choose your SDK](/dist/docs/3.2.0-rc.3/building/by-layer/L4/choose-your-sdk)
