...
- [`get-products-request.json`](https://adcontextprotocol.org/schemas/3.2.0-rc.3/media-buy/get-products-request.json)
- [`targeting-overlay-support.json`](https://adcontextprotocol.org/schemas/3.2.0-rc.3/core/targeting-overlay-support.json)
- [`targeting-overlay-requirements.json`](https://adcontextprotocol.org/schemas/3.2.0-rc.3/core/targeting-overlay-requirements.json)
- [`product-targeting-resolution.json`](https://adcontextprotocol.org/schemas/3.2.0-rc.3/core/product-targeting-resolution.json)
- [`package-targeting-resolution.json`](https://adcontextprotocol.org/schemas/3.2.0-rc.3/core/package-targeting-resolution.json)
- [`placement-selection.json`](https://adcontextprotocol.org/schemas/3.2.0-rc.3/core/placement-selection.json)
