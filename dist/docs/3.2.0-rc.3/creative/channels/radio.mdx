...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-rc.3/core/product-format-declaration.json",
...
See [Audio](/dist/docs/3.2.0-rc.3/creative/channels/audio), [Broadcast](/dist/docs/3.2.0-rc.3/creative/channels/broadcast), and [Creative manifests](/dist/docs/3.2.0-rc.3/creative/creative-manifests).
