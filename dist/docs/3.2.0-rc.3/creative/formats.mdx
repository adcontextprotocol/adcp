...
- [Canonical formats specification](/dist/docs/3.2.0-rc.3/creative/canonical-formats)
...
- [Deprecated `list_creative_formats`](/dist/docs/3.2.0-rc.3/creative/task-reference/list_creative_formats)
