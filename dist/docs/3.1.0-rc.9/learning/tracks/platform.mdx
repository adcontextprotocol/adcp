...
<CardGroup cols={2}>
  <Card title="Building with AdCP" icon="wrench" href="/dist/docs/3.1.0-rc.9/building/index">
    Overview of what it takes to build an AdCP integration.
  </Card>
  <Card title="MCP integration guide" icon="plug" href="/dist/docs/3.1.0-rc.9/building/by-layer/L0/mcp-guide">
    The definitive guide: tool calls, response format, available tools, context management.
  </Card>
  <Card title="Authentication" icon="lock" href="/dist/docs/3.1.0-rc.9/building/by-layer/L2/authentication">
    OAuth 2.0 for agent authentication, token management, and operator credentials.
  </Card>
  <Card title="Accounts and agents" icon="people-arrows" href="/dist/docs/3.1.0-rc.9/building/by-layer/L2/accounts-and-agents">
    How brands, operators, agents, and accounts relate to each other.
  </Card>
  <Card title="Context sessions" icon="timeline" href="/dist/docs/3.1.0-rc.9/building/by-layer/L2/context-sessions">
    Managing context across multi-turn agent interactions.
  </Card>
  <Card title="Schemas and SDKs" icon="box" href="/dist/docs/3.1.0-rc.9/building/by-layer/L0/schemas">
...
<CardGroup cols={2}>
  <Card title="Property governance" icon="shield-check" href="/dist/docs/3.1.0-rc.9/governance/property/index">
    Identity, authorization, and data enrichment for participants in AdCP.
  </Card>
  <Card title="AdAgents.json" icon="file-code" href="/dist/docs/3.1.0-rc.9/governance/property/adagents">
  ...
  <Card title="Authorized properties" icon="key" href="/dist/docs/3.1.0-rc.9/governance/property/authorized-properties">
    How publishers declare authorized sellers, and how buyers verify them.
  </Card>
  <Card title="Security" icon="shield" href="/dist/docs/3.1.0-rc.9/building/by-layer/L1/security">
    Security implementation patterns for AdCP servers.
  </Card>
  <Card title="Accounts and security" icon="user-shield" href="/dist/docs/3.1.0-rc.9/media-buy/advanced-topics/accounts-and-security">
    Account-level security, agent and account hierarchies, and access control.
  </Card>
  <Card title="Property specification" icon="scroll" href="/dist/docs/3.1.0-rc.9/governance/property/specification">
  ...
  <Card title="Campaign governance specification" icon="file-code" href="/dist/docs/3.1.0-rc.9/governance/campaign/specification">
...
<CardGroup cols={2}>
  ...
  <Card title="AdCP and OpenRTB" icon="arrows-left-right" href="/dist/docs/3.1.0-rc.9/building/concepts/adcp-vs-openrtb">
    The clearest view of how AdCP campaign workflows connect to impression-time execution.
  </Card>
  <Card title="Async operations" icon="hourglass-half" href="/dist/docs/3.1.0-rc.9/building/by-layer/L3/async-operations">
    Handling long-running operations — essential for bridging real-time and agentic systems.
  </Card>
  <Card title="Webhooks" icon="bell" href="/dist/docs/3.1.0-rc.9/building/by-layer/L3/webhooks">
  ...
  <Card title="Sandbox" icon="flask" href="/dist/docs/3.1.0-rc.9/media-buy/advanced-topics/sandbox">
    Testing your implementation against sandbox agents before going live.
  </Card>
  <Card title="Implementor FAQ" icon="circle-question" href="/dist/docs/3.1.0-rc.9/reference/implementor-faq">
    Common questions and answers from teams building AdCP integrations.
  </Card>
  <Card title="Router architecture" icon="diagram-project" href="/dist/docs/3.1.0-rc.9/trusted-match/router-architecture">
    Deployment, fan-out, and provider configuration for the TMP Router.
  </Card>
  <Card title="AI mediation" icon="microchip-ai" href="/dist/docs/3.1.0-rc.9/trusted-match/ai-mediation">
...
Build working AdCP infrastructure using any AI coding assistant (Claude Code, Cursor, Copilot) with the [`@adcp/sdk`](/dist/docs/3.1.0-rc.9/building/by-layer/L0/schemas) SDK. Point your coding assistant at a [skill file](/dist/docs/3.1.0-rc.9/building/by-layer/L4/build-an-agent) — choose `build-seller-agent` or `build-signals-agent` depending on what you want to build. This is the most ambitious build project.
...
The storyboard validates protocol compliance across the complete workflow. See [Validate Your Agent](/dist/docs/3.1.0-rc.9/building/verification/validate-your-agent) for setup, debugging, and the full CLI reference.
...
See the [Compliance Catalog](/dist/docs/3.1.0-rc.9/building/verification/compliance-catalog) for every specialism and the storyboards that verify each claim.
