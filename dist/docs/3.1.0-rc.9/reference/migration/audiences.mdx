...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.1.0-rc.9/core/audience-member.json",
...
**Related:** [Brand identity](/dist/docs/3.1.0-rc.9/reference/migration/brand-identity) | [Optimization goals](/dist/docs/3.1.0-rc.9/reference/migration/optimization-goals) | [AdCP 3.0 overview](/dist/docs/3.1.0-rc.9/reference/whats-new-in-v3)
