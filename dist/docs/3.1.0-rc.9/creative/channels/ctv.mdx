...
- [Video ads](/dist/docs/3.1.0-rc.9/creative/channels/video) -- Video format specs, codecs, and encoding details
- [Display ads](/dist/docs/3.1.0-rc.9/creative/channels/display) -- Companion banner format patterns
- [Multi-agent creative orchestration](/dist/docs/3.1.0-rc.9/creative/multi-agent-orchestration) -- Distributing CTV creatives across multiple sellers
- [Universal macros](/dist/docs/3.1.0-rc.9/creative/universal-macros) -- Complete macro reference including CTV-specific macros
- [Creative manifests](/dist/docs/3.1.0-rc.9/creative/creative-manifests) -- Manifest structure and asset specifications
