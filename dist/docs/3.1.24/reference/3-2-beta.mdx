...
See [Choose your SDK](/dist/docs/3.1.24/building/by-layer/L4/choose-your-sdk) for the support
...
schemas from `main` or from the moving `/schemas/3.1.24/` path:
...
[Verifying protocol tarballs](/dist/docs/3.1.24/reference/verifying-protocol-tarballs) for
...
The SDK compatibility matrix lives in [Choose your SDK](/dist/docs/3.1.24/building/by-layer/L4/choose-your-sdk).
...
- Experimental surfaces retain their [experimental-status contract](/dist/docs/3.1.24/reference/experimental-status).
...
- [Migrating from 3.1 to 3.2](/dist/docs/3.1.24/reference/migration/3-1-to-3-2)
...
- [Choose your SDK](/dist/docs/3.1.24/building/by-layer/L4/choose-your-sdk)
