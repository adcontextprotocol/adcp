...
All measurement and verification vendors are identified by domain using the standard [brand reference](/dist/docs/3.1.24/brand-protocol/brand-json) — the same system used for brands, operators, and accounts. Examples:
