...
|---|---|---|
| Request signing | `@target-uri` canonical output signed and verified | [Signed Requests (Transport Layer)](/dist/docs/3.0.2/building/implementation/security#signed-requests-transport-layer) |
...
The [request-signing profile](/dist/docs/3.0.2/building/implementation/security#signed-requests-transport-layer) layers transport-specific rules on top of this algorithm:
