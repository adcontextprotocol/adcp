...
**Reference**: [Media Buy Specification](/dist/docs/3.0.2/media-buy/specification) · [Seller integration guide](/dist/docs/3.0.2/building/operating/seller-integration)
