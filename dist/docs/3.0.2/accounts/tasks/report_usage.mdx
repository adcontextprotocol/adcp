...
|-------|------|----------|-------------|
| `account` | [AccountRef](/dist/docs/3.0.2/building/by-layer/L2/accounts-and-agents#account-references) | Yes | Account for this record — by `account_id` or `{ brand, operator }`. |
...
- [Accounts and agents](/dist/docs/3.0.2/building/by-layer/L2/accounts-and-agents) — Billing hierarchy and operator model
