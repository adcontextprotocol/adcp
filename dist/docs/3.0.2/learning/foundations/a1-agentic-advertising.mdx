...
<CardGroup cols={2}>
  ...
  <Card title="Why AdCP" icon="lightbulb" href="/dist/docs/3.0.2/building/concepts">
    The strategic vision: allocation vs day trading, the fragmentation problem, and why agents need a shared protocol.
  </Card>
  <Card title="Protocol comparison" icon="code-compare" href="/dist/docs/3.0.2/building/concepts/protocol-comparison">
