...
Modules B4, C4, and D4 use a five-phase approach built on the same tools developers use in practice — [skill files](/dist/docs/3.0.2/building/build-an-agent) to generate agents and [storyboards](/dist/docs/3.0.2/building/validate-your-agent) to validate them:
