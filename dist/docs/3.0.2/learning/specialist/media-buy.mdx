...
See the [Compliance Catalog](/dist/docs/3.0.2/building/compliance-catalog) for the full taxonomy and the [`specialism` enum](https://adcontextprotocol.org/schemas/3.0.2/enums/specialism.json) for the authoritative list.
