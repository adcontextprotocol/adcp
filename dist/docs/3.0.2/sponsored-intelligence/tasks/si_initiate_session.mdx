...
| `context` | object | No | Opaque correlation data echoed unchanged in the response (see [application context](/dist/docs/3.0.2/building/integration/context-sessions#application-context-context)) |
