...
```json
{
  "$schema": "/schemas/3.0.2/sponsored-intelligence/si-initiate-session-request.json",
...
```json
{
  "$schema": "/schemas/3.0.2/sponsored-intelligence/si-initiate-session-response.json",
