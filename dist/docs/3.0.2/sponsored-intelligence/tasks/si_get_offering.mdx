...
```json
{
  "$schema": "/schemas/3.0.2/3.0.2/sponsored-intelligence/si-get-offering-request.json",
...
```json
{
  "$schema": "/schemas/3.0.2/3.0.2/sponsored-intelligence/si-get-offering-response.json",
  "available": true,
