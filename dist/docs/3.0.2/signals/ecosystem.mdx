...
- [Seller integration guide](/dist/docs/3.0.2/building/operating/seller-integration) — building your sales agent
...
- [Industry landscape](/dist/docs/3.0.2/building/concepts/industry-landscape) — how AdCP fits alongside other standards
