...
```json
{
  "$schema": "/schemas/3.0.2/content-standards/create-content-standards-request.json",
...
```json
{
  "$schema": "/schemas/3.0.2/content-standards/create-content-standards-response.json",
