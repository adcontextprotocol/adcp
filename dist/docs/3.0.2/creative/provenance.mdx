...
```json
{
  "$schema": "/schemas/3.0.2/core/provenance.json",
...
```json
{
  "$schema": "/schemas/3.0.2/core/creative-manifest.json",
  "format_id": {
...
```json
{
  "$schema": "/schemas/3.0.2/content-standards/artifact.json",
...
```json
{
  "$schema": "/schemas/3.0.2/core/creative-policy.json",
