...
```json
{
  "$schema": "/schemas/3.1.0-beta.4/sponsored-intelligence/si-get-offering-request.json",
...
```json
{
  "$schema": "/schemas/3.1.0-beta.4/sponsored-intelligence/si-get-offering-response.json",
  "status": "completed",
  "available": true,
