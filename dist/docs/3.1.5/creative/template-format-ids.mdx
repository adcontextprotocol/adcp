...
- [Creative Manifests](/dist/docs/3.1.5/creative/creative-manifests) - Complete manifest structure
- [Format Discovery](/dist/docs/3.1.5/creative/formats) - How buyers discover formats
- [Placement Targeting](/dist/docs/3.1.5/media-buy/creatives) - Assigning creatives to placements
- [Format References](/dist/docs/3.1.5/protocol/format-references) - Normative contrast between `format_id` (pointer) and `format` (definition), including named validation errors
