...
See [Canonical formats](/dist/docs/3.2.0-beta.5/creative/canonical-formats), [Publisher catalogs](/dist/docs/3.2.0-beta.5/governance/property/adagents), and [Preview creative](/dist/docs/3.2.0-beta.5/creative/task-reference/preview_creative).
