...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-beta.5/core/product-format-declaration.json",
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-beta.5/core/creative-manifest.json",
  "format_kind": "audio_hosted",
  "assets": {
    "audio_main": {
      "asset_type": "audio",
...
See [Canonical formats](/dist/docs/3.2.0-beta.5/creative/canonical-formats), [Radio](/dist/docs/3.2.0-beta.5/creative/channels/radio), [Broadcast](/dist/docs/3.2.0-beta.5/creative/channels/broadcast), and [`list_transformers`](/dist/docs/3.2.0-beta.5/creative/task-reference/list_transformers).
