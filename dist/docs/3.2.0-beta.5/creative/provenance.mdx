...
**Schema**: [provenance.json](https://adcontextprotocol.org/schemas/3.2.0-beta.5/core/provenance.json)
...
```json
{
  "$schema": "/schemas/3.2.0-beta.5/core/provenance.json",
...
**Schema**: [digital-source-type.json](https://adcontextprotocol.org/schemas/3.2.0-beta.5/enums/digital-source-type.json)
...
```json
{
  "$schema": "/schemas/3.2.0-beta.5/core/creative-manifest.json",
  "format_kind": "image",
  "provenance": {
...
```json
{
  "$schema": "/schemas/3.2.0-beta.5/content-standards/artifact.json",
...
These results are **supplementary**. A seller that requires provenance verification runs its own detection through [`get_creative_features`](/dist/docs/3.2.0-beta.5/governance/creative/get_creative_features) rather than trusting the buyer's attached results.
...
| Field | Required | Description |
|---|---|---|
| `method` | Yes | `manifest_wrapper` or `provenance_markers` (see [`embedded-provenance-method`](https://adcontextprotocol.org/schemas/3.2.0-beta.5/enums/embedded-provenance-method.json)) |
...
| Field | Required | Description |
|---|---|---|
| `media_type` | Yes | `audio`, `image`, `video`, or `text` (see [`watermark-media-type`](https://adcontextprotocol.org/schemas/3.2.0-beta.5/enums/watermark-media-type.json)) |
...
| `c2pa_action` | No | C2PA action classification: `c2pa.watermarked.bound` or `c2pa.watermarked.unbound` (see [`c2pa-watermark-action`](https://adcontextprotocol.org/schemas/3.2.0-beta.5/enums/c2pa-watermark-action.json)) |
...
```json
{
  "$schema": "/schemas/3.2.0-beta.5/core/creative-policy.json",
...
| Schema | Location |
|--------|----------|
| Provenance object | [`/schemas/core/provenance.json`](https://adcontextprotocol.org/schemas/3.2.0-beta.5/core/provenance.json) |
| Creative policy | [`/schemas/core/creative-policy.json`](https://adcontextprotocol.org/schemas/3.2.0-beta.5/core/creative-policy.json) |
| Digital source type enum | [`/schemas/enums/digital-source-type.json`](https://adcontextprotocol.org/schemas/3.2.0-beta.5/enums/digital-source-type.json) |
| Embedded provenance method enum | [`/schemas/enums/embedded-provenance-method.json`](https://adcontextprotocol.org/schemas/3.2.0-beta.5/enums/embedded-provenance-method.json) |
| Watermark media type enum | [`/schemas/enums/watermark-media-type.json`](https://adcontextprotocol.org/schemas/3.2.0-beta.5/enums/watermark-media-type.json) |
| C2PA watermark action enum | [`/schemas/enums/c2pa-watermark-action.json`](https://adcontextprotocol.org/schemas/3.2.0-beta.5/enums/c2pa-watermark-action.json) |
| Error code enum (provenance codes) | [`/schemas/enums/error-code.json`](https://adcontextprotocol.org/schemas/3.2.0-beta.5/enums/error-code.json) |
| Creative asset (with provenance) | [`/schemas/core/creative-asset.json`](https://adcontextprotocol.org/schemas/3.2.0-beta.5/core/creative-asset.json) |
| Creative manifest (with provenance) | [`/schemas/core/creative-manifest.json`](https://adcontextprotocol.org/schemas/3.2.0-beta.5/core/creative-manifest.json) |
| Creative policy (provenance_required) | [`/schemas/core/creative-policy.json`](https://adcontextprotocol.org/schemas/3.2.0-beta.5/core/creative-policy.json) |
| Artifact (with provenance) | [`/schemas/content-standards/artifact.json`](https://adcontextprotocol.org/schemas/3.2.0-beta.5/content-standards/artifact.json) |

## Related

- [Provenance verification](/dist/docs/3.2.0-beta.5/governance/creative/provenance-verification) -- How the governance infrastructure verifies AI provenance claims
- [Creative Governance](/dist/docs/3.2.0-beta.5/governance/creative/index) -- Feature-based creative evaluation via `get_creative_features`
- [Content Standards](/dist/docs/3.2.0-beta.5/governance/content-standards/index) -- Privacy-preserving brand suitability for publisher content
- [Generative Creative](/dist/docs/3.2.0-beta.5/creative/generative-creative) -- AI-powered creative generation with `build_creative`
