...
- [Canonical formats specification](/dist/docs/3.2.0-beta.5/creative/canonical-formats)
- [Creative manifests](/dist/docs/3.2.0-beta.5/creative/creative-manifests)
- [`get_adcp_capabilities`](/dist/docs/3.2.0-beta.5/protocol/get_adcp_capabilities)
- [`build_creative`](/dist/docs/3.2.0-beta.5/creative/task-reference/build_creative)
- [Deprecated `list_creative_formats`](/dist/docs/3.2.0-beta.5/creative/task-reference/list_creative_formats)
