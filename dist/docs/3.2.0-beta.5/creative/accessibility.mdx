...
- [Creative Formats](/dist/docs/3.2.0-beta.5/creative/formats) — Format structure and requirements
- [Asset Types](/dist/docs/3.2.0-beta.5/creative/asset-types) — Asset specifications and payload schemas
- [Creative Manifests](/dist/docs/3.2.0-beta.5/creative/creative-manifests) — Pairing assets with formats
- [`get_adcp_capabilities`](/dist/docs/3.2.0-beta.5/protocol/get_adcp_capabilities) — Creative-agent capability discovery
