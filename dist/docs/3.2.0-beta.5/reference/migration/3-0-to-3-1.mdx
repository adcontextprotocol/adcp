...
For the feature narrative, start with [What's New in AdCP 3.1](/dist/docs/3.2.0-beta.5/reference/whats-new-in-3-1). For the full release record, see [Release Notes](/dist/docs/3.2.0-beta.5/reference/release-notes#version-3-1-0).
...
- [What's New in AdCP 3.1](/dist/docs/3.2.0-beta.5/reference/whats-new-in-3-1)
- [Release Notes](/dist/docs/3.2.0-beta.5/reference/release-notes#version-3-1-0)
- [Versions & Compatibility](/dist/docs/3.2.0-beta.5/reference/versions)
- [Versioning & Governance](/dist/docs/3.2.0-beta.5/reference/versioning)
- [Version Adaptation](/dist/docs/3.2.0-beta.5/building/cross-cutting/version-adaptation)
