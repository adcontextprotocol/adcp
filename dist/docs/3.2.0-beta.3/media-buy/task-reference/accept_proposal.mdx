...
**Request schema:** [`/schemas/3.2.0-beta.3/media-buy/accept-proposal-request.json`](https://adcontextprotocol.org/schemas/3.2.0-beta.3/media-buy/accept-proposal-request.json)
