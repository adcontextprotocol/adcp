...
See [Canonical formats](/dist/docs/3.2.0-beta.3/creative/canonical-formats), [Publisher catalogs](/dist/docs/3.2.0-beta.3/governance/property/adagents), and [Preview creative](/dist/docs/3.2.0-beta.3/creative/task-reference/preview_creative).
