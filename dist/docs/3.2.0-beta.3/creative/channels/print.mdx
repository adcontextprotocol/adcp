...
See [Canonical formats](/dist/docs/3.2.0-beta.3/creative/canonical-formats), [Creative manifests](/dist/docs/3.2.0-beta.3/creative/creative-manifests), and [Media products](/dist/docs/3.2.0-beta.3/media-buy/product-discovery/media-products).
