...
See the [Compliance Catalog](/dist/docs/3.2.0-beta.3/building/verification/compliance-catalog) for the full taxonomy and the [`specialism` enum](https://adcontextprotocol.org/schemas/3.2.0-beta.3/enums/specialism.json) for the authoritative list.
...
<CardGroup cols={2}>
  <Card
    ...
    href="/dist/docs/3.2.0-beta.3/media-buy/task-reference/get_products"
  >
  ...
  <Card
    ...
    icon="receipt"
    href="/dist/docs/3.2.0-beta.3/media-buy/task-reference/create_media_buy"
  >
  ...
  <Card
    ...
    icon="pen-to-square"
    href="/dist/docs/3.2.0-beta.3/media-buy/task-reference/update_media_buy"
  >
  ...
  <Card
    ...
    icon="list-check"
    href="/dist/docs/3.2.0-beta.3/media-buy/task-reference/get_media_buys"
  >
  ...
  <Card
    ...
    icon="chart-line"
    href="/dist/docs/3.2.0-beta.3/media-buy/task-reference/get_media_buy_delivery"
  >
...
<CardGroup cols={2}>
  <Card
    ...
    icon="scroll"
    href="/dist/docs/3.2.0-beta.3/media-buy/specification"
  >
  ...
  <Card
    ...
    icon="tag"
    href="/dist/docs/3.2.0-beta.3/media-buy/advanced-topics/pricing-models"
  >
  ...
  <Card
    ...
    icon="handshake"
    href="/dist/docs/3.2.0-beta.3/media-buy/advanced-topics/accountability"
  >
  ...
  <Card
    ...
    icon="handshake"
    href="/dist/docs/3.2.0-beta.3/media-buy/product-discovery/proposal-negotiation"
  >
  ...
  <Card
    ...
    icon="layer-group"
    href="/dist/docs/3.2.0-beta.3/media-buy/media-buys/index"
  >
  ...
  <Card
    title="Indicators"
    icon="lightbulb"
    href="/dist/docs/3.2.0-beta.3/media-buy/media-buys/indicators"
  >
  ...
  <Card
    ...
    icon="microchip"
    href="/dist/docs/3.2.0-beta.3/trusted-match"
  >
  ...
  <Card
    ...
    href="/dist/docs/3.2.0-beta.3/building/concepts/adcp-vs-openrtb"
  >
  ...
  <Card
    ...
    href="/dist/docs/3.2.0-beta.3/building/operating/orchestrator-design"
  >
  ...
  <Card
    ...
    icon="bullseye"
    href="/dist/docs/3.2.0-beta.3/media-buy/conversion-tracking/index"
  >
  ...
  <Card
    ...
    icon="comment-dots"
    href="/dist/docs/3.2.0-beta.3/media-buy/task-reference/provide_performance_feedback"
  >
  ...
  <Card
    ...
    href="/dist/docs/3.2.0-beta.3/trusted-match/context-and-identity"
  >
  ...
  <Card
    ...
    icon="diagram-project"
    href="/dist/docs/3.2.0-beta.3/trusted-match/router-architecture"
  >
...
The learner describes the required signature-verification step, dedupes each fire, coalesces them into one unfiltered reread, and reconciles only from the returned snapshot. Cryptographic execution is out of scope for this module; implementers follow the [webhook callback verifier checklist](/dist/docs/3.2.0-beta.3/building/by-layer/L1/security#webhook-callbacks). A timestamp-only reevaluation must not fire. Assignment removal retires prior keys even when the two invalidations arrive in either order.
