...
**Request Schema**: [`https://adcontextprotocol.org/schemas/3.0.6/signals/get-signals-request.json`](https://adcontextprotocol.org/schemas/3.0.6/signals/get-signals-request.json)
**Response Schema**: [`https://adcontextprotocol.org/schemas/3.0.6/signals/get-signals-response.json`](https://adcontextprotocol.org/schemas/3.0.6/signals/get-signals-response.json)
...
| `account` | [AccountRef](/dist/docs/3.0.6/building/integration/accounts-and-agents#account-references) | No | Account for this request. When provided, the signals agent returns per-account pricing options if configured. |
...
```json
{
  "$schema": "/schemas/3.0.6/signals/get-signals-response.json",
...
```json
{
  "$schema": "/schemas/3.0.6/signals/get-signals-request.json",
