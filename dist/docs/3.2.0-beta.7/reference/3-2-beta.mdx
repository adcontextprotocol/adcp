...
The 3.2 beta cycle started with a protocol-first checkpoint. Beta.7 is the
current protocol checkpoint. No SDK release names exact beta.7 support yet: the
...
| `3.2.0-beta.7` | Current protocol checkpoint for audience activation and external sources, creative delivery and tracker execution, measured-channel reporting, and expanded conformance coverage | Raw-wire adopters, code-generator maintainers, SDK maintainers, and agent teams validating the signed beta.7 artifact |
...
another checkpoint. Test beta.7 from its signed artifact with raw-wire or
...
| Surface | beta.0 | beta.1 | beta.2 | beta.3 | beta.4 | beta.5 | beta.6 | beta.7 |
|---|---|---|---|---|---|---|---|---|
| Protocol artifact | `3.2.0-beta.0` | `3.2.0-beta.1` | `3.2.0-beta.2` | `3.2.0-beta.3` | `3.2.0-beta.4` | `3.2.0-beta.5` | `3.2.0-beta.6` | `3.2.0-beta.7` |
| Git tag | `v3.2.0-beta.0` | `v3.2.0-beta.1` | `v3.2.0-beta.2` | `v3.2.0-beta.3` | `v3.2.0-beta.4` | `v3.2.0-beta.5` | `v3.2.0-beta.6` | `v3.2.0-beta.7` |
| `adcp_version` wire pin | `"3.2-beta.0"` | `"3.2-beta.1"` | `"3.2-beta.2"` | `"3.2-beta.3"` | `"3.2-beta.4"` | `"3.2-beta.5"` | `"3.2-beta.6"` | `"3.2-beta.7"` |
| Documentation selector | `3.2-beta` | `3.2-beta` | `3.2-beta` | `3.2-beta` | `3.2-beta` | `3.2-beta` | `3.2-beta` | `3.2-beta` |
...
buyer pinned to `"3.2-beta.7"` must not silently negotiate to another beta, and
...
See [Choose your SDK](/dist/docs/3.2.0-beta.7/building/by-layer/L4/choose-your-sdk) for the support
...
## Use the beta.7 artifact directly

Download the signed beta.7 protocol bundle rather
than copying schemas from `main` or from the moving `/schemas/3.2.0-beta.7/` path:

```bash
curl -fLO https://adcontextprotocol.org/protocol/3.2.0-beta.7.tgz
curl -fLO https://adcontextprotocol.org/protocol/3.2.0-beta.7.tgz.sha256
shasum -a 256 -c 3.2.0-beta.7.tgz.sha256
tar -xzf 3.2.0-beta.7.tgz
```

The extracted `adcp-3.2.0-beta.7/` directory contains:
...
[Verifying protocol tarballs](/dist/docs/3.2.0-beta.7/reference/verifying-protocol-tarballs) for
...
4. Exercise raw MCP or A2A calls with `adcp_version: "3.2-beta.7"` against a
...
<Note>
**No 3.2 verification badge is currently issued for beta.7.** Treat it as an
...
The SDK compatibility matrix lives in [Choose your SDK](/dist/docs/3.2.0-beta.7/building/by-layer/L4/choose-your-sdk).
...
## Current beta.7 checkpoint

Protocol beta.1 through beta.7 are published. No SDK release names exact beta.7
...
beta.7 protocol evidence, confirm that:

- the test uses the signed beta.7 artifact directly;
- both peers advertise `"3.2-beta.7"` before calls use that pin;
- the integration scenarios below run against beta.7 and retain the exact
  bundle version;
...
- Experimental surfaces retain their [experimental-status contract](/dist/docs/3.2.0-beta.7/reference/experimental-status).
...
- whether the problem blocks beta.7 interoperability.
...
- [What's New in AdCP 3.2](/dist/docs/3.2.0-beta.7/reference/whats-new-in-3-2)
- [Migrating from 3.1 to 3.2](/dist/docs/3.2.0-beta.7/reference/migration/3-1-to-3-2)
- [Release Notes](/dist/docs/3.2.0-beta.7/reference/release-notes#version-3-2-0)
- [Versions & Compatibility](/dist/docs/3.2.0-beta.7/reference/versions)
- [Choose your SDK](/dist/docs/3.2.0-beta.7/building/by-layer/L4/choose-your-sdk)
