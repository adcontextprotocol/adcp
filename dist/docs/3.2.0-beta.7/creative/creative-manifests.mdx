...
- [Canonical formats](/dist/docs/3.2.0-beta.7/creative/canonical-formats)
- [Asset types](/dist/docs/3.2.0-beta.7/creative/asset-types)
- [Creative representation sets](/dist/docs/3.2.0-beta.7/creative/representation-sets)
- [`build_creative`](/dist/docs/3.2.0-beta.7/creative/task-reference/build_creative)
- [`sync_creatives`](/dist/docs/3.2.0-beta.7/creative/task-reference/sync_creatives)
