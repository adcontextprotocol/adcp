...
See [Canonical formats](/dist/docs/3.2.0-beta.7/creative/canonical-formats) and [`list_transformers`](/dist/docs/3.2.0-beta.7/creative/task-reference/list_transformers).
