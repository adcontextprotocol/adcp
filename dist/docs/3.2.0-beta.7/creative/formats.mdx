...
- [Canonical formats specification](/dist/docs/3.2.0-beta.7/creative/canonical-formats)
...
- [Deprecated `list_creative_formats`](/dist/docs/3.2.0-beta.7/creative/task-reference/list_creative_formats)
