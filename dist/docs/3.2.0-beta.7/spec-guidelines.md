...
All enums should live in `/schemas/3.2.0-beta.7/enums/` with descriptive names:
...
1. **Create v2 directory**: `/schemas/3.2.0-beta.7/`
...
1. Check existing patterns in `/schemas/3.2.0-beta.7/`
