...
**Schema**: [get-content-standards-request.json](https://adcontextprotocol.org/schemas/3.1.0-rc.14/content-standards/get-content-standards-request.json)
...
**Schema**: [get-content-standards-response.json](https://adcontextprotocol.org/schemas/3.1.0-rc.14/content-standards/get-content-standards-response.json)
