...
- [`list_transformers`](/dist/docs/3.1.0-rc.14/creative/task-reference/list_transformers) — discover transformers, their params, option values, and pricing
- [`build_creative`](/dist/docs/3.1.0-rc.14/creative/task-reference/build_creative) — select a transformer, configure, multiply, refine
- [What's new in 3.1](/dist/docs/3.1.0-rc.14/reference/whats-new-in-3-1)
