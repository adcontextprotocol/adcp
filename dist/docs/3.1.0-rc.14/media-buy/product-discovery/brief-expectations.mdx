...
4. Buyer applies their own audiences, e.g. through [TMP](/dist/docs/3.1.0-rc.14/trusted-match)
...
```
**Use Case**: Buyer has sophisticated audience segments in their DMP/CDP and will apply targeting through [TMP](/dist/docs/3.1.0-rc.14/trusted-match). They need raw inventory without publisher curation.
