...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-rc.2/core/attribution-window.json",
  "post_click": {
    "interval": 7,
    "unit": "days"
  },
