...
<CardGroup cols={2}>
  ...
  <Card title="Brand identity" icon="palette" href="/dist/docs/3.2.0-rc.2/brand-protocol/brand-json">
...
<CardGroup cols={2}>
  ...
  <Card title="Client SDKs" icon="rocket" href="/dist/docs/3.2.0-rc.2/building/by-layer/L4/choose-your-sdk">
