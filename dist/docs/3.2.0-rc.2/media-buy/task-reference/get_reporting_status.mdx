...
usable. It does not replace [`get_media_buy_delivery`](/dist/docs/3.2.0-rc.2/media-buy/task-reference/get_media_buy_delivery)
...
[`sync_accounts`](/dist/docs/3.2.0-rc.2/accounts/tasks/sync_accounts) `notification_configs[]`. It is
...
[`sync_accounts`](/dist/docs/3.2.0-rc.2/accounts/tasks/sync_accounts) and
[`list_accounts`](/dist/docs/3.2.0-rc.2/accounts/tasks/list_accounts) return
