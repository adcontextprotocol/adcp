...
|-------|------|----------|-------------|
| `session_id` | string | Yes | Session ID from [`si_initiate_session`](/dist/docs/3.2.0-rc.2/sponsored-intelligence/tasks/si_initiate_session) |
...
The host should call [`si_terminate_session`](/dist/docs/3.2.0-rc.2/sponsored-intelligence/tasks/si_terminate_session) after handling the handoff to properly close the session.
