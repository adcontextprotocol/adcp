...
See [Creative representation sets](/dist/docs/3.2.0-rc.2/creative/representation-sets), [Canonical formats](/dist/docs/3.2.0-rc.2/creative/canonical-formats), [Creative manifests](/dist/docs/3.2.0-rc.2/creative/creative-manifests), and [Universal macros](/dist/docs/3.2.0-rc.2/creative/universal-macros).
