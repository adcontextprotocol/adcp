...
5. Normalize tracker defaults, bind one exact VAST/DAAST execution version, and match every first-class tracker against the destination's [tracker execution contract](/dist/docs/3.2.0-rc.2/creative/tracker-execution-contracts).
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-rc.2/core/creative-manifest.json",
  "format_kind": "display_tag",
  "format_option_ref": {
    "scope": "product",
    "format_option_id": "acme_internal_redirect_300x250"
...
- [Display ads](/dist/docs/3.2.0-rc.2/creative/channels/display)
- [Video ads](/dist/docs/3.2.0-rc.2/creative/channels/video)
- [Universal macros](/dist/docs/3.2.0-rc.2/creative/universal-macros)
- [Creative manifests](/dist/docs/3.2.0-rc.2/creative/creative-manifests)
