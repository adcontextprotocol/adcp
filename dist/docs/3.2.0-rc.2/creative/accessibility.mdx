...
- [Creative Formats](/dist/docs/3.2.0-rc.2/creative/formats) — Format structure and requirements
- [Asset Types](/dist/docs/3.2.0-rc.2/creative/asset-types) — Asset specifications and payload schemas
- [Creative Manifests](/dist/docs/3.2.0-rc.2/creative/creative-manifests) — Pairing assets with formats
- [`get_adcp_capabilities`](/dist/docs/3.2.0-rc.2/protocol/get_adcp_capabilities) — Creative-agent capability discovery
