...
See [Canonical formats](/dist/docs/3.2.0-rc.2/creative/canonical-formats) and [`list_transformers`](/dist/docs/3.2.0-rc.2/creative/task-reference/list_transformers).
