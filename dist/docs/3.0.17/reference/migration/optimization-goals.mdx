...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.0.17/core/optimization-goal.json",
  "kind": "metric",
  "metric": "clicks",
  "target": {
    "kind": "cost_per",
...
<Card title="Conversion tracking & optimization goals" icon="arrow-right" href="/dist/docs/3.0.17/media-buy/conversion-tracking/index">
  Configure event sources, send conversion events, and optimize delivery goals.
</Card>

---

**Related:** [Channels](/dist/docs/3.0.17/reference/migration/channels) | [Pricing](/dist/docs/3.0.17/reference/migration/pricing) | [Signals](/dist/docs/3.0.17/reference/migration/signals) | [AdCP 3.0 overview](/dist/docs/3.0.17/reference/whats-new-in-v3)
