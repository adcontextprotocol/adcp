...
**Request Schema**: [`/schemas/3.0.17/creative/preview-creative-request.json`](https://adcontextprotocol.org/schemas/3.0.17/creative/preview-creative-request.json)
**Response Schema**: [`/schemas/3.0.17/creative/preview-creative-response.json`](https://adcontextprotocol.org/schemas/3.0.17/creative/preview-creative-response.json)
...
```json
{
  "$schema": "/schemas/3.0.17/creative/preview-creative-request.json",
  "request_type": "single",
  "quality": "draft",
  "creative_manifest": {
    "format_id": {
...
- [Advanced Preview Patterns](/dist/docs/3.0.17/creative/task-reference/preview_creative-advanced) - Caching, workflows, implementation notes
- [Creative Manifests](/dist/docs/3.0.17/creative/creative-manifests) - Manifest structure
- [Creative Formats](/dist/docs/3.0.17/creative/formats) - Format specifications
