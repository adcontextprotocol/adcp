...
<Card title="Catalogs documentation" icon="arrow-right" href="/dist/docs/3.2.0/creative/catalogs">
...
<Card title="Conversion events" icon="arrow-right" href="/dist/docs/3.2.0/creative/catalogs#conversion-events">
