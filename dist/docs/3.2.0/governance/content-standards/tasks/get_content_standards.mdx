...
**Schema**: [get-content-standards-request.json](https://adcontextprotocol.org/schemas/3.2.0/content-standards/get-content-standards-request.json)
...
**Schema**: [get-content-standards-response.json](https://adcontextprotocol.org/schemas/3.2.0/content-standards/get-content-standards-response.json)
