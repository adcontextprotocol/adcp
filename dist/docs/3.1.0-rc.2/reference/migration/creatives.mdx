...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.1.0-rc.2/core/creative-assignment.json",
...
<Card title="Creative" icon="arrow-right" href="/dist/docs/3.1.0-rc.2/creative/index">
