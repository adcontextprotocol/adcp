...
<CardGroup cols={2}>
  ...
  <Card title="For publishers / sellers" icon="store" href="/dist/docs/3.1.0-rc.2/brand-protocol/seller-setup">
    How to publish seller identity, property relationships, and signing keys.
  </Card>
  <Card title="Rights licensing" icon="film" href="/dist/docs/3.1.0-rc.2/brand-protocol/walkthrough-rights-licensing">
