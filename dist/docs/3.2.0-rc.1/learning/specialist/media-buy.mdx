...
See the [Compliance Catalog](/dist/docs/3.2.0-rc.1/building/verification/compliance-catalog) for the full taxonomy and the [`specialism` enum](https://adcontextprotocol.org/schemas/3.2.0-rc.1/enums/specialism.json) for the authoritative list.
...
<CardGroup cols={2}>
  <Card
    ...
    href="/dist/docs/3.2.0-rc.1/media-buy/task-reference/get_products"
  >
  ...
  <Card
    ...
    icon="receipt"
    href="/dist/docs/3.2.0-rc.1/media-buy/task-reference/create_media_buy"
  >
  ...
  <Card
    ...
    icon="pen-to-square"
    href="/dist/docs/3.2.0-rc.1/media-buy/task-reference/update_media_buy"
  >
  ...
  <Card
    ...
    icon="list-check"
    href="/dist/docs/3.2.0-rc.1/media-buy/task-reference/get_media_buys"
  >
  ...
  <Card
    ...
    icon="chart-line"
    href="/dist/docs/3.2.0-rc.1/media-buy/task-reference/get_media_buy_delivery"
  >
  ...
  <Card
    ...
    href="/dist/docs/3.2.0-rc.1/media-buy/reporting-core-implementation-guide"
  >
  ...
  <Card
    ...
    icon="list-check"
    href="/dist/docs/3.2.0-rc.1/media-buy/task-reference/get_reporting_status"
  >
...
<CardGroup cols={2}>
  <Card
    ...
    icon="scroll"
    href="/dist/docs/3.2.0-rc.1/media-buy/specification"
  >
  ...
  <Card
    ...
    icon="tag"
    href="/dist/docs/3.2.0-rc.1/media-buy/advanced-topics/pricing-models"
  >
  ...
  <Card
    ...
    icon="handshake"
    href="/dist/docs/3.2.0-rc.1/media-buy/advanced-topics/accountability"
  >
  ...
  <Card
    ...
    icon="handshake"
    href="/dist/docs/3.2.0-rc.1/media-buy/product-discovery/proposal-negotiation"
  >
  ...
  <Card
    ...
    icon="layer-group"
    href="/dist/docs/3.2.0-rc.1/media-buy/media-buys/index"
  >
  ...
  <Card
    title="Indicators"
    icon="lightbulb"
    href="/dist/docs/3.2.0-rc.1/media-buy/media-buys/indicators"
  >
  ...
  <Card
    ...
    icon="microchip"
    href="/dist/docs/3.2.0-rc.1/trusted-match"
  >
  ...
  <Card
    ...
    href="/dist/docs/3.2.0-rc.1/building/concepts/adcp-vs-openrtb"
  >
  ...
  <Card
    ...
    href="/dist/docs/3.2.0-rc.1/building/operating/orchestrator-design"
  >
  ...
  <Card
    ...
    icon="bullseye"
    href="/dist/docs/3.2.0-rc.1/media-buy/conversion-tracking/index"
  >
  ...
  <Card
    ...
    icon="comment-dots"
    href="/dist/docs/3.2.0-rc.1/media-buy/task-reference/provide_performance_feedback"
  >
  ...
  <Card
    ...
    href="/dist/docs/3.2.0-rc.1/trusted-match/context-and-identity"
  >
  ...
  <Card
    ...
    icon="diagram-project"
    href="/dist/docs/3.2.0-rc.1/trusted-match/router-architecture"
  >
...
11. **Shared-account convergence (3.2 draft)** — Connect to an existing sandbox account that is also managed by a connected platform. Acquire a latest account-change cursor before snapshotting, observe an externally initiated creative or media-buy transition, drain `list_account_changes`, and repair through the named authoritative read. Complete the [shared-account change feed lab](/dist/docs/3.2.0-rc.1/learning/shared-account-change-feed).
...
The learner describes the required signature-verification step, dedupes each fire, coalesces them into one unfiltered reread, and reconciles only from the returned snapshot. Cryptographic execution is out of scope for this module; implementers follow the [webhook callback verifier checklist](/dist/docs/3.2.0-rc.1/building/by-layer/L1/security#webhook-callbacks). A timestamp-only reevaluation must not fire. Assignment removal retires prior keys even when the two invalidations arrive in either order.
