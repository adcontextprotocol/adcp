...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-rc.1/core/product-format-declaration.json",
...
See [Audio](/dist/docs/3.2.0-rc.1/creative/channels/audio), [Broadcast](/dist/docs/3.2.0-rc.1/creative/channels/broadcast), and [Creative manifests](/dist/docs/3.2.0-rc.1/creative/creative-manifests).
