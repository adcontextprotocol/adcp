...
See [Creative representation sets](/dist/docs/3.2.0-rc.1/creative/representation-sets), [Canonical formats](/dist/docs/3.2.0-rc.1/creative/canonical-formats), [Creative manifests](/dist/docs/3.2.0-rc.1/creative/creative-manifests), and [Universal macros](/dist/docs/3.2.0-rc.1/creative/universal-macros).
