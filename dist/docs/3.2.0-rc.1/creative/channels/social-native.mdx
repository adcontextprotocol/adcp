...
See [Canonical formats](/dist/docs/3.2.0-rc.1/creative/canonical-formats), [Publisher catalogs](/dist/docs/3.2.0-rc.1/governance/property/adagents), and [Preview creative](/dist/docs/3.2.0-rc.1/creative/task-reference/preview_creative).
