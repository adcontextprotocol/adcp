...
|---|---|---|---|
| **Release candidate** | 3.2 (current prerelease: `rc.0`) | `"3.2-rc.0"` | Development and staging only. RC.0 is the current protocol checkpoint; TypeScript SDK beta.31 and Python SDK beta.13 embed it exactly. Follow the [3.2 prerelease program](/dist/docs/3.2.0-rc.1/reference/3-2-beta). |
| **Active** | 3.1 (current stable: 3.1.20) | `"3.1"` | Current production minor release. See [What's New in AdCP 3.1](/dist/docs/3.2.0-rc.1/reference/whats-new-in-3-1) for the feature set. |
...
| **End of life** | 2.0.0, 2.1.0, 2.5.0–2.5.3 | — | No patches. Migrate to 3.0. See [v2 sunset](/dist/docs/3.2.0-rc.1/reference/v2-sunset). |
| **Planned** | 4.0 | — | Target in [planned releases](/dist/docs/3.2.0-rc.1/reference/versioning#planned-releases). |
...
| 3.0.0-rc.3 | 2026-04-01 | Superseded by GA. See [prerelease upgrade notes](/dist/docs/3.2.0-rc.1/reference/migration/prerelease-upgrades) if you adopted rc.3. |
...
The entire 2.x line has been fully deprecated since August 1, 2026 (UTC). The 2.x schema URLs continue to resolve so existing integrations don't break silently, but those schemas receive no further updates. See [v2 Sunset](/dist/docs/3.2.0-rc.1/reference/v2-sunset) for migration paths.
...
Yes — v2 agents can be registered in the AgenticAdvertising.org registry but cannot be verified. Certification and verified-default discovery require v3.x. See [v2 Sunset → If you use the AgenticAdvertising.org registry](/dist/docs/3.2.0-rc.1/reference/v2-sunset#if-you-use-the-agenticadvertisingorg-registry).

### How long will 3.0 be supported?
At least 12 months after 4.0 GA. See [Versioning → Support window for previous major](/dist/docs/3.2.0-rc.1/reference/versioning#support-window-for-previous-major).

### Where is 4.0?
Targeted for early 2027. 3.x is mid-cycle — see the [planned releases table](/dist/docs/3.2.0-rc.1/reference/versioning#planned-releases).
...
| Implementing or testing 3.2 without an SDK | Use the signed **3.2 RC.0** artifacts with raw-wire or code-generation workflows. Follow the [prerelease program](/dist/docs/3.2.0-rc.1/reference/3-2-beta). |
...
| Running a 2.5.x integration | Upgrade now — out of support. Start with the [migration guide](/dist/docs/3.2.0-rc.1/reference/migration). |
| Running a 2.0 or 2.1 integration | Upgrade now — out of support. |
| Trying a post-3.1 feature | Use the [3.2 prerelease program](/dist/docs/3.2.0-rc.1/reference/3-2-beta), [Release Notes](/dist/docs/3.2.0-rc.1/reference/release-notes), and [experimental status](/dist/docs/3.2.0-rc.1/reference/experimental-status). |

## Related

- **[Versioning & Governance](/dist/docs/3.2.0-rc.1/reference/versioning)** — release tiers, schema-change scope, cadence policy
- **[v2 Sunset](/dist/docs/3.2.0-rc.1/reference/v2-sunset)** — full v2 end-of-life timeline and migration paths
- **[What's new in v3](/dist/docs/3.2.0-rc.1/reference/whats-new-in-v3)** — feature-by-feature summary of what 3.0 adds
- **[What's New in AdCP 3.1](/dist/docs/3.2.0-rc.1/reference/whats-new-in-3-1)** — final 3.1 feature set and adopter actions
- **[What's new in AdCP 3.2](/dist/docs/3.2.0-rc.1/reference/whats-new-in-3-2)** — prerelease feature set and adopter actions
- **[3.2 prerelease program](/dist/docs/3.2.0-rc.1/reference/3-2-beta)** — current artifacts, exact SDK pairing, and prerelease testing gates
- **[Release Notes](/dist/docs/3.2.0-rc.1/reference/release-notes)** — curated narrative for each version
- **[Changelog](/dist/docs/3.2.0-rc.1/reference/changelog)** — full technical change history
