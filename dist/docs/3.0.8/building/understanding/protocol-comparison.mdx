...
See [Task Lifecycle](/dist/docs/3.0.8/building/implementation/task-lifecycle) for complete status handling guide.
...
- **MCP Guide**: See [MCP Guide](/dist/docs/3.0.8/building/integration/mcp-guide) for tool calls and context management
- **A2A Guide**: See [A2A Guide](/dist/docs/3.0.8/building/integration/a2a-guide) for artifacts and streaming
