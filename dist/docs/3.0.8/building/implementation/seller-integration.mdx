...
See [Accounts and Agents](/dist/docs/3.0.8/building/integration/accounts-and-agents) for full workflows.
...
<CardGroup cols={2}>
  ...
  <Card title="Operating an agent" icon="gears" href="/dist/docs/3.0.8/building/operating-an-agent">
