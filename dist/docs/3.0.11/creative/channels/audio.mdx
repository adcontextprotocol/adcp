...
In addition to [universal macros](/dist/docs/3.0.11/creative/universal-macros), audio formats support:
...
- [Asset Types](/dist/docs/3.0.11/creative/asset-types) - Audio asset specifications
