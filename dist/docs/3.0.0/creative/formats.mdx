...
For an overview of how formats, manifests, and creative agents work together, see the [Creative Protocol Overview](/dist/docs/3.0.0/creative).
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.0.0/creative/list-creative-formats-response.json",
  "formats": [
    {
      "format_id": {
...
**For sales agents implementing format support:** See [Implementing Standard Format Support](/dist/docs/3.0.0/media-buy/capability-discovery/implementing-standard-formats).
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.0.0/core/format.json",
  "format_id": {
    "agent_url": "https://creative.adcontextprotocol.org",
    "id": "video_30s_hosted"
  },
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.0.0/core/format-id.json",
  "agent_url": "https://creative.adcontextprotocol.org",
  "id": "display_300x250"
}
```
...
- **accessibility**: Optional WCAG conformance declaration — see [Accessibility](/dist/docs/3.0.0/creative/accessibility)
...
See [Display Ads - HTML Display Formats](/dist/docs/3.0.0/creative/channels/display#html-display-formats-with-execution-context) for complete examples.
...
See [Video Channel Guide](/dist/docs/3.0.0/creative/channels/video) for complete specifications.
...
See [Display Channel Guide](/dist/docs/3.0.0/creative/channels/display) for complete specifications.
...
See [Audio Channel Guide](/dist/docs/3.0.0/creative/channels/audio) for complete specifications.
...
See [DOOH Channel Guide](/dist/docs/3.0.0/creative/channels/dooh) for complete specifications.
...
See [Carousel Channel Guide](/dist/docs/3.0.0/creative/channels/carousels) for complete specifications.

## Multi-Asset & Frame-Based Formats

Some formats like carousels, slideshows, and stories use repeatable asset groups where each frame contains a collection of assets. See the [Carousel & Multi-Asset Formats guide](/dist/docs/3.0.0/creative/channels/carousels) for complete documentation on frame-based format patterns.
...
- [Creative Protocol Overview](/dist/docs/3.0.0/creative) - How formats, manifests, and agents work together
- [Creative Manifests](/dist/docs/3.0.0/creative/creative-manifests) - Pairing assets with formats
- [Asset Types](/dist/docs/3.0.0/creative/asset-types) - Understanding asset specifications
- [Channel Guides](/dist/docs/3.0.0/creative/channels/video) - Detailed format documentation by media type
- [Implementing Standard Format Support](/dist/docs/3.0.0/media-buy/capability-discovery/implementing-standard-formats) - For sales agents
- [list_creative_formats Task](/dist/docs/3.0.0/creative/task-reference/list_creative_formats) - API reference for format discovery
