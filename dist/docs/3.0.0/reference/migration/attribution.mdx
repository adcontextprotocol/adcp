...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.0.0/core/attribution-window.json",
  "post_click": {
    "interval": 7,
    "unit": "days"
  },
...
<Card title="Conversion tracking & optimization goals" icon="arrow-right" href="/dist/docs/3.0.0/media-buy/conversion-tracking/index">
