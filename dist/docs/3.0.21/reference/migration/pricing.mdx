...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.0.21/pricing-options/price-guidance.json",
  "p25": 8.50,
  "p50": 15.00,
  "p75": 18.00,
  "p90": 22.00
...
<Steps>
  ...
  <Step title="Validate against schemas">
    Each pricing model has its own schema in `/schemas/3.0.21/pricing-options/`.
  </Step>
</Steps>

<Card title="Media products" icon="arrow-right" href="/dist/docs/3.0.21/media-buy/product-discovery/media-products">
  How products declare pricing options, channels, and capabilities.
</Card>

---

**Related:** [Channels](/dist/docs/3.0.21/reference/migration/channels) | [Geo targeting](/dist/docs/3.0.21/reference/migration/geo-targeting) | [Creatives](/dist/docs/3.0.21/reference/migration/creatives) | [Catalogs](/dist/docs/3.0.21/reference/migration/catalogs) | [Attribution](/dist/docs/3.0.21/reference/migration/attribution) | [AdCP 3.0 overview](/dist/docs/3.0.21/reference/whats-new-in-v3)
