...
|---|---|---|
| One-off verification (single page, single creative, single subsidiary check) | [`verify_brand_claim`](/dist/docs/3.1.0-beta.2/brand-protocol/tasks/verify_brand_claim) | No batching benefit; simpler error model. |
...
- **Request**: [`verify-brand-claims-request.json`](https://adcontextprotocol.org/schemas/3.1.0-beta.2/brand/verify-brand-claims-request.json)
- **Response**: [`verify-brand-claims-response.json`](https://adcontextprotocol.org/schemas/3.1.0-beta.2/brand/verify-brand-claims-response.json)
...
Full error-code semantics are documented on the [single-target task page § Error handling](/dist/docs/3.1.0-beta.2/brand-protocol/tasks/verify_brand_claim#error-handling).
...
See [`brand.json` § Agent-augmented verification](/dist/docs/3.1.0-beta.2/brand-protocol/brand-json#agent-augmented-verification) for the full trust table.
