...
<CardGroup cols={2}>
  ...
  <Card title="Media buy protocol" icon="robot" href="/dist/docs/3.1.0-beta.2/media-buy/index">
    The buyer-side perspective: how agents automate media buying across platforms.
  </Card>
  <Card title="Seller integration" icon="store" href="/dist/docs/3.1.0-beta.2/building/operating/seller-integration">
