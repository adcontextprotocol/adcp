...
<CardGroup cols={2}>
  ...
  <Card title="Brand identity" icon="palette" href="/dist/docs/3.1.0-beta.2/brand-protocol/brand-json">
...
<CardGroup cols={2}>
  ...
  <Card title="Security Model" icon="shield-halved" href="/dist/docs/3.1.0-beta.2/building/concepts/security-model">
    Why agentic advertising raises the stakes, what AdCP defends against, and a checklist for brand IT and CISOs.
  </Card>
  <Card title="Client SDKs" icon="rocket" href="/dist/docs/3.1.0-beta.2/building/by-layer/L4/choose-your-sdk">
