...
<CardGroup cols={2}>
  <Card title="Sponsored Intelligence Protocol" icon="message-bot" href="/docs/sponsored-intelligence/overview">
    Conversational brand experiences in AI assistants.
  </Card>
  <Card title="Brand Manifests" icon="palette" href="/docs/creative/brand-manifest">
...
| **Governance** | Brand safety, compliance | Property lists, content standards |
