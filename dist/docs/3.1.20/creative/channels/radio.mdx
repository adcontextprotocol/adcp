...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.1.20/core/product-format-declaration.json",
...
See [Audio](/dist/docs/3.1.20/creative/channels/audio), [Broadcast](/dist/docs/3.1.20/creative/channels/broadcast), and [Creative manifests](/dist/docs/3.1.20/creative/creative-manifests).
