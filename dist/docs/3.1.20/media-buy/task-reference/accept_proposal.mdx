...
**Request schema:** [`/schemas/3.1.20/media-buy/accept-proposal-request.json`](https://adcontextprotocol.org/schemas/3.1.20/media-buy/accept-proposal-request.json)
