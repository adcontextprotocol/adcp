...
6. Delta completion is recorded in the learner record and retained under the [learner records policy](/dist/docs/3.1.0-rc.10/learning/policies/learner-records).
...
>
> If you believe you were targeted in error, email certification@agenticadvertising.org. We acknowledge assessment and targeting review requests within 2 business days and resolve them through the [complaints process](/dist/docs/3.1.0-rc.10/learning/policies/complaints).
