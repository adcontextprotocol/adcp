...
**Schema**: [list-content-standards-request.json](https://adcontextprotocol.org/schemas/3.2.0-beta.2/content-standards/list-content-standards-request.json)
...
**Schema**: [list-content-standards-response.json](https://adcontextprotocol.org/schemas/3.2.0-beta.2/content-standards/list-content-standards-response.json)
...
```json
{
  "$schema": "/schemas/3.2.0-beta.2/content-standards/list-content-standards-response.json",
  "status": "completed",
  "standards": [
    {
