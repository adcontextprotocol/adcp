...
- [Schemas, compliance bundles, and SDKs](/dist/docs/3.2.0-beta.2/building/schemas-and-sdks) — where these sidecars are described in the broader bundle-fetching flow
