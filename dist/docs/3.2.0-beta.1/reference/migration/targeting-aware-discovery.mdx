...
- [`get-products-request.json`](https://adcontextprotocol.org/schemas/3.2.0-beta.1/media-buy/get-products-request.json)
- [`targeting-overlay-support.json`](https://adcontextprotocol.org/schemas/3.2.0-beta.1/core/targeting-overlay-support.json)
- [`targeting-overlay-requirements.json`](https://adcontextprotocol.org/schemas/3.2.0-beta.1/core/targeting-overlay-requirements.json)
- [`product-targeting-resolution.json`](https://adcontextprotocol.org/schemas/3.2.0-beta.1/core/product-targeting-resolution.json)
- [`package-targeting-resolution.json`](https://adcontextprotocol.org/schemas/3.2.0-beta.1/core/package-targeting-resolution.json)
- [`placement-selection.json`](https://adcontextprotocol.org/schemas/3.2.0-beta.1/core/placement-selection.json)
