...
See [Choose your SDK](/dist/docs/3.2.0-beta.1/building/by-layer/L4/choose-your-sdk) for the support
...
than copying schemas from `main` or from the moving `/schemas/3.2.0-beta.1/` path:
...
[Verifying protocol tarballs](/dist/docs/3.2.0-beta.1/reference/verifying-protocol-tarballs) for
...
The SDK compatibility matrix lives in [Choose your SDK](/dist/docs/3.2.0-beta.1/building/by-layer/L4/choose-your-sdk).
...
- Experimental surfaces retain their [experimental-status contract](/dist/docs/3.2.0-beta.1/reference/experimental-status).
...
- [What's New in AdCP 3.2](/dist/docs/3.2.0-beta.1/reference/whats-new-in-3-2)
- [Migrating from 3.1 to 3.2](/dist/docs/3.2.0-beta.1/reference/migration/3-1-to-3-2)
- [Release Notes](/dist/docs/3.2.0-beta.1/reference/release-notes#version-3-2-0)
- [Versions & Compatibility](/dist/docs/3.2.0-beta.1/reference/versions)
- [Choose your SDK](/dist/docs/3.2.0-beta.1/building/by-layer/L4/choose-your-sdk)
