...
See [Video](/dist/docs/3.2.0-beta.1/creative/channels/video), [Audio](/dist/docs/3.2.0-beta.1/creative/channels/audio), and [Creative manifests](/dist/docs/3.2.0-beta.1/creative/creative-manifests).
