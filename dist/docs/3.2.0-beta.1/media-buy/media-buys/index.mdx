...
Use [Product discovery and planning](/dist/docs/3.2.0-beta.1/media-buy/product-discovery/) to
choose a path, and [Proposal negotiation](/dist/docs/3.2.0-beta.1/media-buy/product-discovery/proposal-negotiation)
...
the current seller snapshot through [`get_media_buys`](/dist/docs/3.2.0-beta.1/media-buy/task-reference/get_media_buys).
...
when that task completes. See [Task lifecycle](/dist/docs/3.2.0-beta.1/building/by-layer/L3/task-lifecycle).

## Supply and assign creatives

Compact purchase calls do not carry creative bodies. Use
[`sync_creatives`](/dist/docs/3.2.0-beta.1/creative/task-reference/sync_creatives) to create or
...
Use [`control_media_buy`](/dist/docs/3.2.0-beta.1/media-buy/task-reference/control_media_buy) for
...
[Snapshot and log contract](/dist/docs/3.2.0-beta.1/protocol/snapshot-and-log).
...
See [Migrating from 3.1 to 3.2](/dist/docs/3.2.0-beta.1/reference/migration/3-1-to-3-2) for the
mapping and [Media buy lifecycle flow](/dist/docs/3.2.0-beta.1/media-buy/media-buys/lifecycle) for
...
- [Indicators and warnings](/dist/docs/3.2.0-beta.1/media-buy/media-buys/indicators)
- [Accountability](/dist/docs/3.2.0-beta.1/media-buy/advanced-topics/accountability)
- [Policy compliance](/dist/docs/3.2.0-beta.1/media-buy/media-buys/policy-compliance)
