...
<Steps>
  ...
  <Step title="WG review">
    The issue is queued for the next working group session. At least two [working group members](/dist/docs/3.2.0-beta.1/community/working-group) must complete the reviewer checklist before the WG votes. The review period is a minimum of seven calendar days after the issue is filed.
  </Step>
  <Step title="Decision">
...
- [Governance overview](/dist/docs/3.2.0-beta.1/governance/overview) — the three-party model and campaign governance domains
- [Embedded human judgment](/dist/docs/3.2.0-beta.1/governance/embedded-human-judgment) — the principle behind the governance system that most RFCs serve
