...
| Task | Purpose |
|------|---------|
| [`get_signals`](/dist/docs/3.0.13/signals/tasks/get_signals) | Discover signals matching campaign criteria |
| [`activate_signal`](/dist/docs/3.0.13/signals/tasks/activate_signal) | Activate a signal for use in campaigns |
...
- [Data provider guide](/dist/docs/3.0.13/signals/data-providers) — how to publish a signal catalog
- [Signals ecosystem](/dist/docs/3.0.13/signals/ecosystem) — how each type of company participates
- [Protocol specification](/dist/docs/3.0.13/signals/specification) — formal conformance requirements
- [get_signals task reference](/dist/docs/3.0.13/signals/tasks/get_signals) — discovery API details
- [activate_signal task reference](/dist/docs/3.0.13/signals/tasks/activate_signal) — activation API details
