...
**Note**: `affiliate` describes the BUYING MODEL (performance-based, CPA/CPC/revenue share) rather than where content appears. Percentage-of-sale terms use the [`revenue_share` pricing model](/dist/docs/3.2.0-beta.0/media-buy/advanced-topics/pricing-models#revenue-share).
