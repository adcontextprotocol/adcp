...
[`sync_governance`](/dist/docs/3.2.0-beta.0/accounts/tasks/sync_governance) registers governance agents on the account. Once configured, sellers with governance support will call [`check_governance`](/dist/docs/3.2.0-beta.0/governance/campaign/tasks/check_governance) before confirming media buys.
...
- **[Accounts and agents](/dist/docs/3.2.0-beta.0/building/by-layer/L2/accounts-and-agents)** — Account identity, billing models, and `sync_accounts` details
- **[Async operations](/dist/docs/3.2.0-beta.0/building/by-layer/L3/async-operations)** — How async approval workflows work
- **[Webhooks](/dist/docs/3.2.0-beta.0/building/by-layer/L3/webhooks)** — Receiving notifications when async operations complete
- **[Catalogs](/dist/docs/3.2.0-beta.0/creative/catalogs)** — Typed data feeds that provide the items publishers render in ads
