...
- **[Display Formats](/dist/docs/3.1.10/creative/channels/display)** - IAB standard banner sizes (300x250, 728x90, 320x50, etc.)
- **[Video Formats](/dist/docs/3.1.10/creative/channels/video)** - Standard video ad specifications (15s, 30s, vertical, CTV)
- **[Audio Formats](/dist/docs/3.1.10/creative/channels/audio)** - Streaming audio and podcast insertion formats
- **[DOOH Formats](/dist/docs/3.1.10/creative/channels/dooh)** - Digital out-of-home billboard and transit specs
- **[Carousel Formats](/dist/docs/3.1.10/creative/channels/carousels)** - Multi-product and slideshow formats
...
```json
{
  "$schema": "/schemas/3.1.10/media-buy/list-creative-formats-response.json",
  "status": "completed",
  "formats": [
    {
      "format_id": {
...
```json
{
  "$schema": "/schemas/3.1.10/core/format.json",
  "format_id": {
    "agent_url": "https://creative.adcontextprotocol.org",
    "id": "display_300x250"
  },
