...
This is what TMP provides: two lightweight operations — [Context Match and Identity Match](/dist/docs/3.1.10/trusted-match/context-and-identity) — that activate pre-negotiated packages across any surface, with structural privacy guarantees and sub-50ms latency.
