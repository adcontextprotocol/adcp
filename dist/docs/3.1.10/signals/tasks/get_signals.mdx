...
**Request Schema**: [`https://adcontextprotocol.org/schemas/3.1.10/signals/get-signals-request.json`](https://adcontextprotocol.org/schemas/3.1.10/signals/get-signals-request.json)
**Response Schema**: [`https://adcontextprotocol.org/schemas/3.1.10/signals/get-signals-response.json`](https://adcontextprotocol.org/schemas/3.1.10/signals/get-signals-response.json)
...
| `account` | [AccountRef](/dist/docs/3.1.10/building/by-layer/L2/accounts-and-agents#account-references) | No | Account for this request. When provided, the signals agent returns per-account pricing options if configured. In wholesale mode, this is the rate-card scope; when omitted the agent returns default rate-card pricing or omits `pricing_options` entirely. |
...
should first call [`get_adcp_capabilities`](/dist/docs/3.1.10/protocol/get_adcp_capabilities)
...
```json
{
  "$schema": "/schemas/3.1.10/signals/get-signals-response.json",
  "status": "completed",
...
```json
{
  "$schema": "/schemas/3.1.10/signals/get-signals-request.json",
...
Signals agents declare wholesale support in [`get_adcp_capabilities`](/dist/docs/3.1.10/protocol/get_adcp_capabilities):
