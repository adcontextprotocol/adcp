...
- [verify_brand_claim](/dist/docs/3.1.10/brand-protocol/tasks/verify_brand_claim) — The task this guidance applies to
- [Building a brand agent](/dist/docs/3.1.10/brand-protocol/building-a-brand-agent) — Agent-side implementation, including the public/authorized split and signing setup
- [brand.json § Agent-augmented verification](/dist/docs/3.1.10/brand-protocol/brand-json#agent-augmented-verification) — The asymmetric trust model that makes rejections authoritative
