...
<Info>
**Free module** — No account required. ~15 minutes with Addie. Prerequisite: [A2](/dist/docs/3.0.5/learning/foundations/a2-protocol-architecture).
</Info>
...
<CardGroup cols={2}>
  ...
  <Card title="Embedded Human Judgment" icon="user-check" href="/dist/docs/3.0.5/governance/embedded-human-judgment">
    The five principles behind AdCP governance — how humans stay in control when agents act autonomously.
  </Card>
  <Card title="Creative protocol" icon="palette" href="/dist/docs/3.0.5/creative/index">
  ...
  <Card title="Accounts protocol" icon="building" href="/dist/docs/3.0.5/accounts/overview">
    The commercial layer: advertisers, operators, authentication, billing, and account lifecycle.
  </Card>
  <Card title="Security Model" icon="shield-halved" href="/dist/docs/3.0.5/building/understanding/security-model">
...
- **Sponsored Intelligence** — conversational brand experiences, cost-per-conversation instead of CPM ([experimental](/dist/docs/3.0.5/reference/experimental-status) in 3.0)
...
**Next:** Choose your role track — [Publisher](/dist/docs/3.0.5/learning/tracks/publisher), [Buyer](/dist/docs/3.0.5/learning/tracks/buyer), or [Platform](/dist/docs/3.0.5/learning/tracks/platform)
