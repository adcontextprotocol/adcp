...
[`sync_governance`](/dist/docs/3.0.5/accounts/tasks/sync_governance) registers governance agents on the account. Once configured, sellers with governance support will call [`check_governance`](/dist/docs/3.0.5/governance/campaign/tasks/check_governance) before confirming media buys.
...
- **[Accounts and agents](/dist/docs/3.0.5/building/integration/accounts-and-agents)** — Account identity, billing models, and `sync_accounts` details
- **[Async operations](/dist/docs/3.0.5/building/implementation/async-operations)** — How async approval workflows work
- **[Webhooks](/dist/docs/3.0.5/building/implementation/webhooks)** — Receiving notifications when async operations complete
- **[Catalogs](/dist/docs/3.0.5/creative/catalogs)** — Typed data feeds that provide the items publishers render in ads
