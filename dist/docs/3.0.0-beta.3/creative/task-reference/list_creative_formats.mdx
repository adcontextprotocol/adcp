...
See [list_creative_formats (Sales Agent)](/dist/docs/3.0.0-beta.3/media-buy/task-reference/list_creative_formats) for sales agent-specific behavior.
...
| `wcag_level` | string | No | Filter to formats meeting at least this WCAG level: `A`, `AA`, `AAA`. See [Accessibility](/dist/docs/3.0.0-beta.3/creative/accessibility). |
...
1. **Build Creatives**: Use [`build_creative`](/dist/docs/3.0.0-beta.3/creative/task-reference/build_creative) to assemble assets into format
2. **Preview**: Use [`preview_creative`](/dist/docs/3.0.0-beta.3/creative/task-reference/preview_creative) to see visual output
3. **Validate**: Use [`sync_creatives`](/dist/docs/3.0.0-beta.3/media-buy/task-reference/sync_creatives) with `dry_run: true`
4. **Upload**: Use [`sync_creatives`](/dist/docs/3.0.0-beta.3/media-buy/task-reference/sync_creatives) to upload to media buy

## Learn More

- [Format Schema](https://adcontextprotocol.org/schemas/v2/core/format.json) - Complete format structure
- [Asset Types](/dist/docs/3.0.0-beta.3/creative/asset-types) - Asset specification details
- [Standard Formats](/dist/docs/3.0.0-beta.3/media-buy/capability-discovery/implementing-standard-formats) - IAB-compatible reference formats
