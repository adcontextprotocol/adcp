...
```json
{
  "$schema": "/schemas/3.0.0-beta.3/creative/preview-creative-request.json",
  "request_type": "single",
  "creative_manifest": {
...
- [Advanced Preview Patterns](/dist/docs/3.0.0-beta.3/creative/task-reference/preview_creative-advanced) - Caching, workflows, implementation notes
- [Creative Manifests](/dist/docs/3.0.0-beta.3/creative/creative-manifests) - Manifest structure
- [Creative Formats](/dist/docs/3.0.0-beta.3/creative/formats) - Format specifications
