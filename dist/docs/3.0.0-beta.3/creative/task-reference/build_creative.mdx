...
For information about format IDs and how to reference formats, see [Creative Formats - Referencing Formats](/dist/docs/3.0.0-beta.3/creative/formats.mdx#referencing-formats).
...
```json
{
  "$schema": "/schemas/3.0.0-beta.3/media-buy/build-creative-request.json",
...
```json
{
  "$schema": "/schemas/3.0.0-beta.3/media-buy/build-creative-response.json",
  "creative_manifest": {
    "format_id": {
      "agent_url": "https://creative.adcontextprotocol.org",
      "id": "display_300x250"
...
2. **Preview**: Use `preview_creative` to see how it renders (see [preview_creative](/dist/docs/3.0.0-beta.3/creative/task-reference/preview_creative))
...
2. **preview_creative** → Renders the manifest (see [preview_creative](/dist/docs/3.0.0-beta.3/creative/task-reference/preview_creative))
