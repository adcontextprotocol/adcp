...
> **Technical Reference**: This guide shows how to use the [`build_creative` task](/dist/docs/3.0.0-beta.3/creative/task-reference/build_creative). For complete API specifications, see the task reference documentation.
...
Assets are provided via [Brand Manifest](/dist/docs/3.0.0-beta.3/creative/brand-manifest) - no separate asset library management needed.
...
See [Brand Manifest Reference](/dist/docs/3.0.0-beta.3/creative/brand-manifest) for comprehensive examples.
...
- **Browse Examples**: See [Task Reference](/dist/docs/3.0.0-beta.3/creative/task-reference/build_creative) for detailed examples
...
### Asset Management
Assets are provided via [Brand Manifest](/dist/docs/3.0.0-beta.3/creative/brand-manifest):
