...
- **[Media Channel Taxonomy](/dist/docs/3.0.0-beta.3/reference/media-channel-taxonomy)** — 19 planning-oriented channels that reflect how buyers allocate budgets
- **[Proposals](/dist/docs/3.0.0-beta.3/media-buy/product-discovery/media-products#proposals)** — Structured media plans with conversational refinement and direct execution
- **[Capability Discovery](/dist/docs/3.0.0-beta.3/protocol/get_adcp_capabilities)** — Verify seller targeting support (geo systems, etc.) before purchasing
- **[Governance Protocol](/dist/docs/3.0.0-beta.3/governance)** — Property lists and content standards for enterprise brand suitability
- **[Sponsored Intelligence](/dist/docs/3.0.0-beta.3/sponsored-intelligence/overview)** — Conversational brand experiences in AI assistants
...
- See [Data Provider Guide](/dist/docs/3.0.0-beta.3/signals/data-providers) for implementation details
...
- See [Governance Protocol](/dist/docs/3.0.0-beta.3/governance) for implementation details
...
- See [Sponsored Intelligence](/dist/docs/3.0.0-beta.3/sponsored-intelligence/overview) for implementation details
...
See [Media Channel Taxonomy](/dist/docs/3.0.0-beta.3/reference/media-channel-taxonomy) for complete definitions.
...
See the [Data Provider Guide](/dist/docs/3.0.0-beta.3/signals/data-providers) for complete implementation details.
...
- [ ] Update channel enum values to [new taxonomy](/dist/docs/3.0.0-beta.3/reference/media-channel-taxonomy)
