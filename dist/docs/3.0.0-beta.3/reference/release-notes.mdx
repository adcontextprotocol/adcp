...
**Status:** Beta | [Migration Guide](/dist/docs/3.0.0-beta.3/reference/migrating-to-v3)
...
4. **Commerce Media** - `product_selectors` on `get_products` for commerce product discovery. `manifest_gtins` on promoted products for cross-retailer GTIN matching. Commerce attribution metrics (`roas`, `new_to_brand_rate`) in delivery response aggregated totals and daily breakdown. See the [Commerce Media Guide](/dist/docs/3.0.0-beta.3/guides/commerce-media).
...
**Status:** Beta | [Full Changelog](https://github.com/adcontextprotocol/adcp/blob/main/CHANGELOG.md#300-beta2) | [Migration Guide](/dist/docs/3.0.0-beta.3/reference/migrating-to-v3)
...
**Status:** Beta | [Full Changelog](https://github.com/adcontextprotocol/adcp/blob/main/CHANGELOG.md#300-beta1) | [Migration Guide](/dist/docs/3.0.0-beta.3/reference/migrating-to-v3)
...
Version 3.0.0 is a **major release** that expands AdCP beyond media buying into governance, brand suitability, and conversational commerce. See the [Migration Guide](/dist/docs/3.0.0-beta.3/reference/migrating-to-v3) for detailed upgrade instructions.

**🎯 Key Themes:**

1. **Media Channel Taxonomy** - Complete overhaul from 5 format-oriented channels to 19 planning-oriented channels that reflect how buyers allocate budgets. See [Media Channel Taxonomy](/dist/docs/3.0.0-beta.3/reference/media-channel-taxonomy).
...
3. **Sponsored Intelligence Protocol** - Conversational brand experiences in AI assistants. Defines how hosts invoke brand agent endpoints for rich engagement without breaking conversational flow. See [Sponsored Intelligence](/dist/docs/3.0.0-beta.3/sponsored-intelligence/overview).
...
See [Migration Guide](/dist/docs/3.0.0-beta.3/reference/migrating-to-v3) for detailed before/after examples and migration steps.
...
See [Sponsored Intelligence Overview](/dist/docs/3.0.0-beta.3/sponsored-intelligence/overview) for complete documentation.
...
- [ ] Update channel enum values ([taxonomy guide](/dist/docs/3.0.0-beta.3/reference/media-channel-taxonomy))
...
**[View Complete Migration Guide →](/dist/docs/3.0.0-beta.3/reference/migrating-to-v3)**
