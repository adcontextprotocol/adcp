...
```json
{
  "$schema": "/schemas/3.0.0-beta.3/sponsored-intelligence/si-initiate-session-request.json",
...
```json
{
  "$schema": "/schemas/3.0.0-beta.3/sponsored-intelligence/si-initiate-session-response.json",
