...
| Brand's product catalog | `brand_manifest.product_catalog` | [Brand Manifest](/docs/creative/brand-manifest) |
| GTIN / SKU selection for promotion | `product_selectors` (`manifest_gtins`, `manifest_skus`) | [Promoted Offerings](/docs/creative/promoted-offerings) |
...
- [Promoted Offerings](/docs/creative/promoted-offerings) — SKU selection and catalog-rendered creatives
- [Brand Manifest](/docs/creative/brand-manifest) — Product catalog and brand identity
