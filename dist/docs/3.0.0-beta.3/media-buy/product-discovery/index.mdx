...
### 2. Discover Products  
Use [`get_products`](/dist/docs/3.0.0-beta.3/media-buy/task-reference/get_products) to find matching inventory based on your brief and promoted offering.
...
Publishers may return **proposals** alongside products—structured media plans with budget allocations. Refine proposals conversationally ("focus more on mobile") and execute them directly. See [Proposals](/dist/docs/3.0.0-beta.3/media-buy/product-discovery/media-products#proposals).
...
Learn more in [Brief Expectations](/dist/docs/3.0.0-beta.3/media-buy/product-discovery/brief-expectations).
...
Understand the complete product structure in [Media Products](/dist/docs/3.0.0-beta.3/media-buy/product-discovery/media-products).
...
2. **Use [`list_creative_formats`](/dist/docs/3.0.0-beta.3/media-buy/task-reference/list_creative_formats)** to get detailed format requirements
...
Explore comprehensive examples in [Example Briefs](/dist/docs/3.0.0-beta.3/media-buy/product-discovery/example-briefs).
...
- **[`get_products`](/dist/docs/3.0.0-beta.3/media-buy/task-reference/get_products)**: ~60 seconds (AI processing)
- **[`list_creative_formats`](/dist/docs/3.0.0-beta.3/media-buy/task-reference/list_creative_formats)**: ~1 second (database lookup)

## Next Steps

After discovering products:
1. **[Create Media Buy](/dist/docs/3.0.0-beta.3/media-buy/media-buys/)** - Build campaigns from selected products
2. **[Creative Planning](/dist/docs/3.0.0-beta.3/media-buy/creatives/)** - Prepare assets matching format requirements
3. **[Task Reference](/dist/docs/3.0.0-beta.3/media-buy/task-reference/)** - Detailed API documentation for implementation

## Related Documentation

- **[Brief Expectations](/dist/docs/3.0.0-beta.3/media-buy/product-discovery/brief-expectations)** - Comprehensive guide to brief structure
- **[Example Briefs](/dist/docs/3.0.0-beta.3/media-buy/product-discovery/example-briefs)** - Real-world campaign brief patterns
- **[Media Products](/dist/docs/3.0.0-beta.3/media-buy/product-discovery/media-products)** - Understanding product model and attributes
- **[Proposals](/dist/docs/3.0.0-beta.3/media-buy/product-discovery/media-products#proposals)** - Structured media plans with conversational refinement
- **[`get_products` Task](/dist/docs/3.0.0-beta.3/media-buy/task-reference/get_products)** - Complete API reference