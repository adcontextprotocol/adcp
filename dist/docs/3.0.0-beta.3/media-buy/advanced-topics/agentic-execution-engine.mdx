...
See [Universal Macros](/dist/docs/3.0.0-beta.3/creative/universal-macros) for details.
...
- **[Targeting](/dist/docs/3.0.0-beta.3/media-buy/advanced-topics/targeting)** - Brief-based targeting and geographic overlays
- **[Signals Protocol](/dist/docs/3.0.0-beta.3/signals/overview)** - Signal discovery and activation
- **[Universal Macros](/dist/docs/3.0.0-beta.3/creative/universal-macros)** - Creative-level AXE integration
- **[Orchestrator Design](/dist/docs/3.0.0-beta.3/media-buy/advanced-topics/orchestrator-design)** - Building orchestration platforms
