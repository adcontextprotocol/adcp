...
- [sync_event_sources](/dist/docs/3.0.0-beta.3/media-buy/task-reference/sync_event_sources) - Configure event sources before logging events
- [create_media_buy](/dist/docs/3.0.0-beta.3/media-buy/task-reference/create_media_buy) - Set optimization goals on packages
