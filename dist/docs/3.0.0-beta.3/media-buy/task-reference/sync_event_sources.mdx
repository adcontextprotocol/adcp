...
- [log_event](/dist/docs/3.0.0-beta.3/media-buy/task-reference/log_event) - Send marketing events to configured event sources
- [get_media_buy_delivery](/dist/docs/3.0.0-beta.3/media-buy/task-reference/get_media_buy_delivery) - Monitor conversion metrics in delivery reports
- [create_media_buy](/dist/docs/3.0.0-beta.3/media-buy/task-reference/create_media_buy) - Set optimization goals on packages referencing event sources
