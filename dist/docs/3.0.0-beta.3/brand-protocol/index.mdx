...
<CardGroup cols={2}>
  <Card title="brand.json Spec" icon="code" href="/dist/docs/3.0.0-beta.3/brand-protocol/brand-json">
    Complete technical specification for the brand.json file format.
  </Card>
  <Card title="Brand Manifest" icon="palette" href="/dist/docs/3.0.0-beta.3/creative/brand-manifest">
