...
**Schema**: [get-media-buy-artifacts-request.json](https://adcontextprotocol.org/schemas/v2/content-standards/get-media-buy-artifacts-request.json)
...
```json
{
  "$schema": "/schemas/3.0.0-beta.3/content-standards/get-media-buy-artifacts-response.json",
