...
```json
{
  "$schema": "/schemas/3.0.0-beta.3/content-standards/update-content-standards-request.json",
...
```json
{
  "$schema": "/schemas/3.0.0-beta.3/content-standards/update-content-standards-response.json",
  "standards_id": "nike_emea_safety"
}
```
