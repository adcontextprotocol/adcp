...
| Task | Purpose |
|------|---------|
| [`get_signals`](/dist/docs/3.0.0-beta.3/signals/tasks/get_signals) | Discover signals matching campaign criteria |
| [`activate_signal`](/dist/docs/3.0.0-beta.3/signals/tasks/activate_signal) | Activate a signal for use in campaigns |

## Agent Integration

The Signals Protocol operates within the broader [AdCP Ecosystem](/dist/docs/3.0.0-beta.3/intro#the-adcp-ecosystem-layers), enabling signal agents to integrate directly with decisioning platforms (DSPs, orchestration platforms).
...
See the [Protocol Specification](/dist/docs/3.0.0-beta.3/signals/specification) for complete technical details.
