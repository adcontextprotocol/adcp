...
```json
{
  "$schema": "/schemas/3.0.0-beta.3/signals/activate-signal-response.json",
...
See **[Webhooks](/dist/docs/3.0.0-beta.3/building/implementation/webhooks)** for complete details on webhook configuration and reliability.
