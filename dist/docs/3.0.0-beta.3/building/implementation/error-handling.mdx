...
- **Webhooks**: See [Webhooks](/dist/docs/3.0.0-beta.3/building/implementation/webhooks) for webhook error handling
- **Security**: See [Security](/dist/docs/3.0.0-beta.3/building/implementation/security) for authentication errors
