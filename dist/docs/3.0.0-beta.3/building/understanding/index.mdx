...
<CardGroup cols={2}>
  <Card title="Sponsored Intelligence Protocol" icon="message-bot" href="/dist/docs/3.0.0-beta.3/sponsored-intelligence/overview">
    Conversational brand experiences in AI assistants.
  </Card>
  <Card title="Brand Manifests" icon="palette" href="/dist/docs/3.0.0-beta.3/creative/brand-manifest">
...
<CardGroup cols={2}>
  <Card title="Protocol Comparison" icon="code-compare" href="/dist/docs/3.0.0-beta.3/building/understanding/protocol-comparison">
    MCP vs A2A—when to use which, and what's the same.
  </Card>
  <Card title="Quickstart" icon="rocket" href="/dist/docs/3.0.0-beta.3/quickstart">
