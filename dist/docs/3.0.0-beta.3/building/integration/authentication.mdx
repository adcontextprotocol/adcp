...
An agent may have access to multiple accounts (e.g., an agency managing several clients). See [Accounts and Agents](/dist/docs/3.0.0-beta.3/building/integration/accounts-and-agents) for details on account selection and billing attribution.
...
See [Testing & Development Guide](/dist/docs/3.0.0-beta.3/media-buy/advanced-topics/testing) for complete testing capabilities including dry run mode and time simulation.