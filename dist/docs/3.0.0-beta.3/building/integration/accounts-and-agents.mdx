...
|--------|----------|----------------|
| **Brand** | Whose products are advertised? | House domain + brand_id ([brand.json](/dist/docs/3.0.0-beta.3/brand-protocol/brand-json)) |
...
Every billable operation requires a [brand manifest](/dist/docs/3.0.0-beta.3/creative/brand-manifest) that identifies the brand and provides context for ad serving.
...
See [Authentication](/dist/docs/3.0.0-beta.3/building/integration/authentication) for details.
