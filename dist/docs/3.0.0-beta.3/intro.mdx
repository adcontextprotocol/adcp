...
You're viewing the v3 beta documentation. The API is stable for testing, but breaking changes may occur before final release. See [what's new in 3.0](/dist/docs/3.0.0-beta.3/reference/release-notes#version-300-beta3) and the [v3 migration guide](/dist/docs/3.0.0-beta.3/reference/migrating-to-v3). For production use, switch to version 2.5 using the version selector above.
</Warning>
...
See [AXE documentation](/dist/docs/3.0.0-beta.3/media-buy/advanced-topics/agentic-execution-engine) for details.
...
See [Governance Protocol](/dist/docs/3.0.0-beta.3/governance/) for details.
...
<CardGroup cols={2}>
  ...
  <Card title="Quickstart Guide" icon="rocket" href="/dist/docs/3.0.0-beta.3/quickstart">
    Get started in 5 minutes
  </Card>
  <Card title="Building with AdCP" icon="code" href="/dist/docs/3.0.0-beta.3/building">
...
If you operate a data platform, DSP, or ad tech solution, AdCP lets AI agents discover and purchase your inventory. [Review the Protocol Specifications](/dist/docs/3.0.0-beta.3/signals/specification) to get started.
