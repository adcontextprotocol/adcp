...
- [Seller integration guide](/dist/docs/3.1.0-beta.0/building/operating/seller-integration) — building your sales agent
...
- [Industry landscape](/dist/docs/3.1.0-beta.0/building/concepts/industry-landscape) — how AdCP fits alongside other standards
