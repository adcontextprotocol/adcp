...
- [Schemas, compliance bundles, and SDKs](/dist/docs/3.1.0-beta.0/building/schemas-and-sdks) — where these sidecars are described in the broader bundle-fetching flow
