...
```json
{
  "$schema": "/schemas/3.1.0-beta.0/sponsored-intelligence/si-get-offering-request.json",
...
```json
{
  "$schema": "/schemas/3.1.0-beta.0/sponsored-intelligence/si-get-offering-response.json",
  "available": true,
