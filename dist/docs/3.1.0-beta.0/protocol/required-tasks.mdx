...
**Reference**: [Media Buy Specification](/dist/docs/3.1.0-beta.0/media-buy/specification) · [Seller integration guide](/dist/docs/3.1.0-beta.0/building/operating/seller-integration)
