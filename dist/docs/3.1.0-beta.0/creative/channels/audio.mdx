...
In addition to [universal macros](/dist/docs/3.1.0-beta.0/creative/universal-macros), audio formats support:
...
- [Asset Types](/dist/docs/3.1.0-beta.0/creative/asset-types) - Audio asset specifications
