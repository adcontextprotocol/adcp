---
title: Display Ads
description: "Display ad formats in AdCP specify static banners, HTML5 creatives, third-party tags, and responsive IAB standard sizes for programmatic ads."
...
In addition to [universal macros](/dist/docs/3.1.0-beta.0/creative/universal-macros), display formats support:
...
- [Universal Macros](/dist/docs/3.1.0-beta.0/creative/universal-macros) - Complete macro reference
- [Creative Manifests](/dist/docs/3.1.0-beta.0/creative/creative-manifests) - Manifest structure and validation
- [Asset Types](/dist/docs/3.1.0-beta.0/creative/asset-types) - Image, HTML, and JavaScript asset specifications
