...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.1.0-rc.8/core/attribution-window.json",
  "post_click": {
    "interval": 7,
    "unit": "days"
  },
