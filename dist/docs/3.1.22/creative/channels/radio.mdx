...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.1.22/core/product-format-declaration.json",
...
See [Audio](/dist/docs/3.1.22/creative/channels/audio), [Broadcast](/dist/docs/3.1.22/creative/channels/broadcast), and [Creative manifests](/dist/docs/3.1.22/creative/creative-manifests).
