...
- [Canonical formats](/dist/docs/3.1.22/creative/canonical-formats) — the full canonical-format model, `validate_input` contract, and `ProductFormatDeclaration` shape
- [Connected TV](/dist/docs/3.1.22/creative/channels/ctv) — SSAI/CSAI delivery models and companion-ad guidance
- [Sponsored Placement adapter contracts](/dist/docs/3.1.22/creative/sponsored-placement-adapter-contracts) — per-adopter catalog-driven runtime contracts for the `menu`, `squeezeback`, and `in_scene` rows that route to `sponsored_placement`
- [`validate_input`](/dist/docs/3.1.22/creative/canonical-formats#validation-flow--validate_input) — manifest preflight against canonicals and products
