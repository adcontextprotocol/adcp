...
**Request schema:** [`/schemas/3.0.24/media-buy/accept-proposal-request.json`](https://adcontextprotocol.org/schemas/3.0.24/media-buy/accept-proposal-request.json)
