...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.0.24/content-standards/artifact.json",
...
- [Content artifacts](/dist/docs/3.0.24/governance/content-standards/artifacts#secured-asset-access)
- [AdCP versioning and deprecation policy](/dist/docs/3.0.24/reference/versioning#deprecation-policy)
