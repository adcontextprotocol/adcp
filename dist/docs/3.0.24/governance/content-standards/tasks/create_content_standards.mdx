...
**Schema**: [create-content-standards-request.json](https://adcontextprotocol.org/schemas/3.0.24/content-standards/create-content-standards-request.json)
...
```json
{
  "$schema": "/schemas/3.0.24/content-standards/create-content-standards-request.json",
...
**Schema**: [create-content-standards-response.json](https://adcontextprotocol.org/schemas/3.0.24/content-standards/create-content-standards-response.json)

### Success Response

```json
{
  "$schema": "/schemas/3.0.24/content-standards/create-content-standards-response.json",
