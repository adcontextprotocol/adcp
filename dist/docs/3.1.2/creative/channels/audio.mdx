...
In addition to [universal macros](/dist/docs/3.1.2/creative/universal-macros), audio formats support:
...
- [Universal Macros](/dist/docs/3.1.2/creative/universal-macros) - Complete macro reference
- [Creative Manifests](/dist/docs/3.1.2/creative/creative-manifests) - Manifest structure and validation
- [Asset Types](/dist/docs/3.1.2/creative/asset-types) - Audio asset specifications
- [Product Discovery](/dist/docs/3.1.2/media-buy/product-discovery/media-products#broadcast-audio-spot-plan) - Broadcast audio spot-plan forecasts
