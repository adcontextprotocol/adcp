...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.0.12/core/brand-ref.json",
...
<Card title="Brand identity" icon="arrow-right" href="/dist/docs/3.0.12/brand-protocol/brand-json">
  Full reference for brand.json variants, the brand registry, and BrandRef resolution.
</Card>

---

**Related:** [Channels](/dist/docs/3.0.12/reference/migration/channels) | [Catalogs](/dist/docs/3.0.12/reference/migration/catalogs) | [Brand Protocol](/dist/docs/3.0.12/brand-protocol) | [AdCP 3.0 overview](/dist/docs/3.0.12/reference/whats-new-in-v3)
