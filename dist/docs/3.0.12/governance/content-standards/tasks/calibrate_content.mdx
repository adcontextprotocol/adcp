...
**Schema**: [calibrate-content-request.json](https://adcontextprotocol.org/schemas/3.0.12/content-standards/calibrate-content-request.json)
...
**Schema**: [artifact.json](https://adcontextprotocol.org/schemas/3.0.12/content-standards/artifact.json)
...
**Schema**: [calibrate-content-response.json](https://adcontextprotocol.org/schemas/3.0.12/content-standards/calibrate-content-response.json)

### Passing Response

```json
{
  "$schema": "/schemas/3.0.12/content-standards/calibrate-content-response.json",
  "verdict": "pass",
