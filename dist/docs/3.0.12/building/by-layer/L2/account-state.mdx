...
- **[Accounts and agents](/dist/docs/3.0.12/building/by-layer/L2/accounts-and-agents)** — Account identity, billing models, and `sync_accounts` details
- **[Async operations](/dist/docs/3.0.12/building/by-layer/L3/async-operations)** — How async approval workflows work
- **[Webhooks](/dist/docs/3.0.12/building/by-layer/L3/webhooks)** — Receiving notifications when async operations complete
