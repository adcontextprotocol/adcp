...
If the link doesn't work (Gmail and some domains are restricted), see [Joining the Community Slack](/dist/docs/3.1.17/community/joining-slack) for how to get a direct invite.
...
The WG's operational procedures — quorum, voting thresholds, recusal policy, and escalation path — are published in the [Working group charter](/dist/docs/3.1.17/governance/working-group-charter).
