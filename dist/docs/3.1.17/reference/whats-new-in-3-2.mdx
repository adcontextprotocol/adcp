...
[3.2 beta program](/dist/docs/3.1.17/reference/3-2-beta) before testing.
</Warning>
...
facades. See [Proposal negotiation](/dist/docs/3.1.17/media-buy/product-discovery/proposal-negotiation)
...
exact package readback. See [Targeting-aware product discovery](/dist/docs/3.1.17/reference/migration/targeting-aware-discovery).
...
asset-scoped bearer tokens. See [Migrating secured asset access](/dist/docs/3.1.17/reference/migration/asset-access).
...
1. Read the [3.2 beta program](/dist/docs/3.1.17/reference/3-2-beta).
2. Follow [Migrating from 3.1 to 3.2](/dist/docs/3.1.17/reference/migration/3-1-to-3-2).
3. Choose the exact package and support level in [Choose your SDK](/dist/docs/3.1.17/building/by-layer/L4/choose-your-sdk).
4. Use the [Release Notes](/dist/docs/3.1.17/reference/release-notes#version-3-2-0) for the cumulative record.
