...
- [brand.json reference](/dist/docs/3.1.17/brand-protocol/brand-json) — field-level details for `agents[]`, `properties[]`, and property relationships
- [adagents.json reference](/dist/docs/3.1.17/governance/property/adagents) — publisher-side authorization and `delegation_type`
- [Seller verification](/dist/docs/3.1.17/verification/overview) — buyer-side walkthrough of the full verification chain
- [Seller integration guide](/dist/docs/3.1.17/building/operating/seller-integration) — full AdCP sales-agent implementation path
