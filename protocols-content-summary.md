...
## File 1: docs/protocols/overview.md
...
## File 2: docs/protocols/mcp.md

[Create with MCP-specific integration details]

## File 3: docs/protocols/a2a.md

[Create with A2A-specific integration details]
```

### 2. Update Existing Files

#### docs/intro.md
Change the "What is Ad Context Protocol?" section to mention multi-protocol support and add a "Protocol Flexibility" section.

#### docs/signals/specification.md
- Change "## Protocol Specification" to "## Tasks"
- Add "The Signals Activation Protocol defines the following tasks that agents can perform:"
- Update each operation to be described as a "**Task**:"
- Remove the `check_signal_status` section entirely
- Update the activate_signal response to show task lifecycle

#### docs/media-buy/api-reference.md
- Change "## API Tools Reference" to "## Tasks"
- Add "The Media Buy Protocol defines the following tasks that agents can perform:"
- Update each operation header to include "**Task**:" description

#### sidebars.ts
Add the Protocols section after 'intro' and before 'Signals':
```typescript
{
  type: 'category',
  label: 'Protocols',
...
### 3. Delete Architecture Files
Remove the entire `docs/architecture/` directory and `examples/` directories.
```