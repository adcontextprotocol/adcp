...
- `requires_proposal` is removed from media-buy action modes for 3.1; sellers use `REQUOTE_REQUIRED` when an update exceeds the current quoted envelope. 3.1 does not define an amendment-quote artifact for `update_media_buy`.
