...
- `trusted_match` — the full Trusted Match Protocol. Privacy architecture will evolve with regulator engagement; TMPX, country-partitioned identity, and Offer macros are expected to change.
