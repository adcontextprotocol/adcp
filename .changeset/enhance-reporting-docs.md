...
- Added offline file delivery examples for JSON Lines (JSONL) and Parquet formats.
...
- Added comprehensive JSONL and Parquet format examples with schema documentation.
