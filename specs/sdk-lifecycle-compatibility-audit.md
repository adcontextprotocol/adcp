...
| --- | --- | --- | --- | --- |
| TypeScript | `@adcp/sdk@14.0.0-rc.35`; boundary/routing probes also run against the protocol repository's `14.0.0-rc.35` dependency | [RC.35 source](https://github.com/adcontextprotocol/adcp-client/tree/2b27442fbaf972f7a4236af227800feec268aeb0) | [`3.2.0-rc.1`](https://github.com/adcontextprotocol/adcp-client/blob/2b27442fbaf972f7a4236af227800feec268aeb0/src/lib/version.ts#L12) | Published npm packages; release-tag tests run against the published RC.35 build and bundled caches. |
